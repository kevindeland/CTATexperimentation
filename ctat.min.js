...
e.length;g++){var h=e[g];if(c!==c&&h.key!==h.key||c===h.key)return{id:d,list:e,index:g,entry:h}}return{id:d,list:e,index:-1,entry:void 0}},d=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},c=function(){var a={};return a.previous=a.next=a.head=a},f=0;return e},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
...
"UTC"===a)))return a},d=function l(a,c,b){"undefined"===typeof c&&(c=864E5,b=36E5);var f=(new Date(a.getTime()-c)).getTime();a=a.getTime()+c;for(var d=(new Date(f)).getTimezoneOffset(),n=null;f<a-b;){var e=new Date(f);if(e.getTimezoneOffset()!==d){n=e;break}f+=b}return 864E5===c?l(n,36E5,6E4):36E5===c?l(n,6E4,1E3):n},c=function(a,c,b,f){if("N/A"!==b)return b;if("Asia/Beirut"===c){if("Africa/Cairo"===f.name&&13983768E5===a[6].s&&14116788E5===a[6].e||"Asia/Jerusalem"===f.name&&13959648E5===a[6].s&&
...
g=e.length,h=a[f],n=0;n<g;n++){var l=e[n],q;q=e[n];for(var A=0,y=0;y<b.length;y++)if(q.rules[y]&&b[y]){if(b[y].s>=q.rules[y].s&&b[y].e<=q.rules[y].e)A=0,A+=Math.abs(b[y].s-q.rules[y].s),A+=Math.abs(q.rules[y].e-b[y].e);else{A="N/A";break}if(864E6<A){A="N/A";break}}q=A=c(b,f,A,q);"N/A"!==q&&(d[l.name]=q)}for(var F in d)if(d.hasOwnProperty(F))for(e=0;e<h.length;e++)if(h[e]===F)return F;return f},h=function(a){var c=function(){for(var a=[],c=0;c<jstz.olson.dst_rules.years.length;c++){var b;b=jstz.olson.dst_rules.years[c];
...
a[f]&&(a[f]=b[f])}return a}function f(a,c){return"string"==typeof a?a:a[c%a.length]}function h(a){this.opts=c(a||{},h.defaults,r)}function m(){function c(c,b){return a("<"+c+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',b)}w.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,e){function n(){return d(c("group",{coordsize:l+" "+l,coordorigin:-h+" "+-h}),{width:l,height:l})}function g(a,g,l){b(m,b(d(n(),{rotation:360/e.lines*a+"deg",left:~~g}),b(d(c("roundrect",
{arcsize:e.corners}),{width:h,height:e.scale*e.width,left:e.scale*e.radius,top:-e.scale*e.width>>1,filter:l}),c("fill",{color:f(e.color,a),opacity:e.opacity}),c("stroke",{opacity:0}))))}var h=e.scale*(e.length+e.width),l=2*e.scale*h,u=-(e.width+e.length)*e.scale*2+"px",m=d(n(),{position:"absolute",top:u,left:u});if(e.shadow)for(u=1;u<=e.lines;u++)g(u,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(u=1;u<=e.lines;u++)g(u);return b(a,m)};h.prototype.opacity=
function(a,c,b,f){a=a.firstChild;f=f.shadow&&f.lines||0;a&&c+f<a.childNodes.length&&(a=(a=(a=a.childNodes[c+f])&&a.firstChild)&&a.firstChild)&&(a.opacity=b)}}var l=["webkit","Moz","ms","O"],q={},p,w,r={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",opacity:.25,rotate:0,direction:1,speed:1,trail:100,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",shadow:!1,hwaccel:!1,position:"absolute"};h.defaults={};c(h.prototype,{spin:function(c){this.stop();var b=this,f=b.opts,e=
b.el=a(null,{className:f.className});d(e,{position:f.position,width:0,zIndex:f.zIndex,left:f.left,top:f.top});c&&c.insertBefore(e,c.firstChild||null);e.setAttribute("role","progressbar");b.lines(e,b.opts);if(!p){var n=0,g=(f.lines-1)*(1-f.direction)/2,h,l=f.fps,u=l/f.speed,m=(1-f.opacity)/(u*f.trail/100),r=u/f.lines;(function z(){n++;for(var a=0;a<f.lines;a++)h=Math.max(1-(n+(f.lines-a)*r)%u*m,f.opacity),b.opacity(e,a*f.direction+g,h,f);b.timeout=b.el&&setTimeout(z,~~(1E3/l))})()}return b},stop:function(){var a=
this.el;a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0);return this},lines:function(c,g){function n(c,b){return d(a(),{position:"absolute",width:g.scale*(g.length+g.width)+"px",height:g.scale*g.width+"px",background:c,boxShadow:b,transformOrigin:"left",transform:"rotate("+~~(360/g.lines*h+g.rotate)+"deg) translate("+g.scale*g.radius+"px,0)",borderRadius:(g.corners*g.scale*g.width>>1)+"px"})}for(var h=0,l=(g.lines-1)*(1-g.direction)/2,u;h<g.lines;h++)u=d(a(),
{position:"absolute",top:1+~(g.scale*g.width/2)+"px",transform:g.hwaccel?"translate3d(0,0,0)":"",opacity:g.opacity,animation:p&&e(g.opacity,g.trail,l+h*g.direction,g.lines)+" "+1/g.speed+"s linear infinite"}),g.shadow&&b(u,d(n("#000","0 0 4px #000"),{top:"2px"})),b(c,b(u,n(f(g.color,h),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,c,b){c<a.childNodes.length&&(a.childNodes[c].style.opacity=b)}});if("undefined"!==typeof document){w=function(){var c=a("style",{type:"text/css"});b(document.getElementsByTagName("head")[0],
c);return c.sheet||c.styleSheet}();var u=d(a("group"),{behavior:"url(#default#VML)"});!g(u,"transform")&&u.adj?m():p=g(u,"animation")}return h});var CTATConfig={Options:{},addProperty:function(a,b,e,g){e=e||b[0];Object.defineProperty(CTATConfig,a,{enumerable:!0,configurable:!1,writable:!g,value:e.toLowerCase()});var d={};b.forEach(function(c){d[c]=c.toLowerCase();Object.defineProperty(CTATConfig,a+"_is_"+c,{enumerable:!1,writable:!1,value:function(){return CTATConfig[this.prop].toLowerCase()==this.val}.bind({prop:a,val:d[c]})})});CTATConfig.Options[a]=d}};CTATConfig.addProperty("platform",["CTAT","Google","Undefined"],"CTAT",!0);
...
g+"<br><br></div></div></div>"),!0===f&&(waitScrim=!1,r=e(a,"close"),$(r).appendTo("#scrimpanel")),!0===d&&(waitScrim=!1,p=e(h,"yes"),$(p).appendTo("#scrimpanel"),d=!1),!0===c&&(waitScrim=!1,w=e(m,"no"),$(w).appendTo("#scrimpanel"),c=!1),!0===waitScrim)){n.ctatdebug("Adding spinner ...");$("#scrimpanel").append("<br>");b=$('<div id="scrim_spin">');b.css("width","100%");b.css("position","relative");$("#scrimpanel").append(b);try{var u=(new Spinner({className:"scrim_spinner"})).spin();$("#scrim_spin").append(u.el)}catch(A){(A instanceof
ReferenceError||A instanceof TypeError)&&n.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.',A,typeof A)}}};this.waitScrimUp=function(){n.ctatdebug("waitScrimUp () CTATConfig.platform "+CTATConfig.platform+", scrimIsUp "+scrimIsUp);"google"!=CTATConfig.platform&&(!0===scrimIsUp&&n.scrimDownForced(),waitScrim=!0,n.scrimUp(CTATGlobals.languageManager.getString("LOADING")),n.ctatdebug("return from waitScrimUp(): scrimIsUp "+
scrimIsUp))};this.nextProblemScrimUp=function(){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&n.scrimDownForced(),n.ctatdebug("nextProblemScrimUp ()"),n.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")))};this.OKScrimUp=function(a,b){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&n.scrimDownForced(),n.ctatdebug("OKScrimUp ("+a+","+b+")"),waitScrim=c=d=f=warnScrim=errorScrim=!1,n.scrimUp(a),u=e(b,"OK"),$(u).appendTo("#scrimpanel"))};this.confirmScrimUp=function(a,b,f){"google"!=CTATConfig.platform&&
(!0===scrimIsUp&&n.scrimDownForced(),n.ctatdebug("confirmScrimUp ("+a+","+b+","+f+")"),c=d=!0,m=f,h=b,n.scrimUp(a))};this.errorScrimUp=function(a){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&n.scrimDownForced(),!1===authorTimeSet?(n.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),q.push("ERROR: "+a),errorScrim=!0):!1===inAuthorTime?n.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(errorScrim=!0,b("ERROR: "+
...
scrimIsUp);$("#scrim").remove();l.removeComponent();n.removeHTMLElements();waitScrim=scrimIsUp=!1;g="";n.ctatdebug("exit scrimDownForced() scrimIsUp "+scrimIsUp)};this.defaultClickHandler=function(){n.ctatdebug("defaultClickHandler ()");n.scrimDown()};this.setInAuthorTime=function(a){n.ctatdebug("setting inAuthorTime = "+a);authorTimeSet=!0;inAuthorTime=a;if(!a)warnScrim=errorScrim=!1,f&&null.removeChild(r);else if(errorScrim||warnScrim)for(var c in q)b(c)};this.getInAuthorTime=function(){return inAuthorTime}};
...
function(){}};CTATLMS.is.Assistments=function(){return CTATTarget&&"ASSISTMENTS"==CTATTarget};var bundleFormatter="",inBundle=!1,useBundling=!1,useOLIEncoding=!1,CTATCommLibrary=function(a,b){CTATBase.call(this,"CTATCommLibrary",a);var e=authenticityToken="",g=0,d=[],c=a?a:null,f=null==b?!0:b,h=!0,m=null,l=this,q="http",p="ERROR_CONN_TS",w="";this.setUseCommSettings=function(a){h=a};this.getUseCommSettings=function(){return h};this.setConnectionRefusedMessage=function(a){p=a};this.setSocketType=function(a){q=a};this.hasSecureSocket=function(){return/https/i.test(q)||/wss/i.test(q)};this.hasJavaScriptConnection=
function(){return/javascript/i.test(q)};this.hasWebSocket=function(){return/websocket/i.test(q)};this.assignHandler=function(a){c=a};this.assignMessageListener=function(a){m=a};this.encodeVariables=function(a){l.ctatdebug("encodeVariables ()");for(var c="",b=0;b<a.length;b++){var d=a[b];0<b&&(c+="&");c+=d.name;c+="=";c+=encodeURIComponent(d.value)}return c};this.encodeVariablesOLI=function(a){l.ctatdebug("encodeVariablesOLI ()");for(var c="",b=0;b<a.length;b++){var d=a[b];0<b&&(c+="&");c+=d.name;
c+="=";c+=encodeURIComponent(d.value)}return c};this.createConnection=function(a,c){l.ctatdebug("createConnection ()");if(!c)return new CTATConnection(a);flashVars.getRawFlashVars();var b;if(l.hasWebSocket())return b=this.findWSConnection(c),b||(b=new CTATWSConnection(a),b.setID(g),b.setURL(c),b.assignReceiveFunction(this.processWSReply),b.assignCloseFunction(this.processWSClose),d.push(b),g++),b;b=new CTATConnection(a);b.setID(g);b.setURL(c);b.assignReceiveFunction(this.processReply);d.push(b);g++;
return b};this.findWSConnection=function(a){ctatdebug("findWSConnection( "+a+" )");a=l.editSocketURLForHTTPS(a);for(var c=0;c<d.length;c++){var b=d[c];ctatdebug("checking: socketType = "+b.getSocketType()+" URL = "+b.getURL());if("ws"==b.getSocketType()&&b.getURL()==a)return b}return null};this.startBundle=function(){l.ctatdebug("startBundle ()");!1===useBundling?this.ctatdebug("Not using bundling, bump"):(bundleFormatter='<?xml version="1.0" encoding="UTF-8"?><message><verb/><properties><MessageType>MessageBundle</MessageType><messages>',
inBundle=!0)};this.endBundle=function(){l.ctatdebug("endBundle ()");!1===useBundling?l.ctatdebug("Not using bundling, bump"):(inBundle=!1,bundleFormatter+="</messages></properties></message>",l.sendXML(bundleFormatter))};this.setFixedURL=function(a){e=a};this.getURL=function(){l.ctatdebug("getURL ()");if(""!==e)return l.ctatdebug("Returning fixedURL: "+e),e;var a=flashVars.getRawFlashVars(),c="http://";l.hasSecureSocket()&&(c="https://");c=c+a.remoteSocketURL+":"+a.remoteSocketPort;-1!=a.remoteSocketURL.indexOf("http")&&
(c=a.remoteSocketURL+":"+a.remoteSocketPort);return c};this.sendXML=function(a){l.ctatdebug("Sending: "+a);l.ctatdebug("sendXML ("+a+")");if(!0===useBundling&&!0===inBundle)l.ctatdebug("Bundling ..."),bundleFormatter+=a;else{bundleFormatter=a;flashVars.getRawFlashVars();a=this.getURL();var c=bundleFormatter;-1==bundleFormatter.indexOf("<?xml")&&(c='<?xml version="1.0" encoding="UTF-8"?>'+bundleFormatter);this.getUseCommSettings()&&l.hasJavaScriptConnection()?(l.hasWebSocket()&&this.send_post(a,c),
CTAT.ToolTutor.sendToTutor(c)):this.send_post(a,c)}};this.sendXMLNoBundle=function(a){l.ctatdebug("sendXMLNoBundle ("+a+")");bundleFormatter=a;var c=this.getURL(),b=a;-1==a.indexOf("<?xml")&&(b='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();this.getUseCommSettings()&&l.hasJavaScriptConnection()?(l.hasWebSocket()&&this.send_post(aURL,b),CTAT.ToolTutor.sendToTutor(b)):this.send_post(c,b)};this.sendXMLURL=function(a,c,b){ctatdebug("sendXMLURL ("+c+")");var d=a;-1==a.indexOf("<?xml")&&
(d='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();l.ctatdebug("Sending: "+d);if(this.getUseCommSettings()&&l.hasJavaScriptConnection()){if(l.hasWebSocket()&&(this.send_post(c,d),b))return;CTAT.ToolTutor.sendToTutor(d)}else this.send_post(c,d)};this.sendURLVariables=function(a,c){this.ctatdebug("sendURLVariables ("+a+")");this.send_post_variables(a,c)};this.send=function(a){l.ctatdebug("send ("+a+")");if(!0===CTATGlobals.CommDisabled)l.ctatdebug("Communications globally disabled, please check your settings");
else{var c=new CTATConnection(null);c.setID(g);g++;if(null===c.getHTTPObject())return alert("Cannot create XMLHTTP instance"),!1;d.push(c);c.setURL(a);c.assignReceiveFunction(this.processReply);try{c.getHTTPObject().open("GET",a,!0)}catch(n){this.ctatdebug("Error in newConnection.httpObject.open: "+n.message);return}try{c.init()}catch(n){this.ctatdebug("Error in newConnection.init: "+n.message);return}try{c.getHTTPObject().send(null)}catch(n){this.ctatdebug("Error in newConnection.httpObject.send: "+
n.message)}}};this.send_post_variables=function(a,c){l.ctatdebug("send_post_variables ("+a+")");flashVars.getRawFlashVars();var b;b=!1===useOLIEncoding?this.encodeVariables(c):this.encodeVariablesOLI(c);this.ctatdebug("Sending: "+b);if(!0===CTATGlobals.CommDisabled)l.ctatdebug("Communications globally disabled, please check your settings");else{var f=l.createConnection(CTATConfiguration.getRawFlashVars(),a);f.setContentType("application/x-www-form-urlencoded");g++;d.push(f);l.ctatdebug(b);null!==
m&&m.processOutgoing(b);f.setURL(a);f.setData(b);f.assignReceiveFunction(this.processReply);f.send()}};this.send_post=function(a,c){var b;ctatdebug("send_post ("+a+")");if(!0===CTATGlobals.CommDisabled)l.ctatdebug("Communications globally disabled, please check your settings");else{ctatdebug("Outoing on wire: "+c);b=flashVars.getRawFlashVars();var d=a;l.hasWebSocket()?(ctatdebug("opening websocket connection: url "+a),d=a.replace("http:","ws:"),d=l.editSocketURLForHTTPS(d),ctatdebug("opening websocket connection to "+
d),b=l.createConnection(b,d),b.setData(c),l.ctatdebug(c)):(b=l.createConnection(b,d),b.setData(c));null!==m&&m.processOutgoing(c);b.send()}};this.processReply=function(a){l.ctatdebug("processReply ("+d.length+","+a+")");var b=0,e;a=[];var g;for(g=0;g<d.length;g++){var h=d[g],r=h.getHTTPObject();l.ctatdebug("Testing connection entry "+g+", readyState: "+r.readyState+", consumed: "+h.getConsumed()+", status: "+r.status);4==r.readyState&&!1===h.getConsumed()?(l.ctatdebug("Investigating request response: "+
b+" -> "+r.status+", for: "+h.getURL()),e=!1,0===r.status&&(e=!0,l.ctatdebug("Received message (status 0): ("+r.responseText+"), status: "+r.status),f&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(p))),408==r.status&&(e=!0,l.ctatdebug("Received message (status 408): "+r.responseText),f&&CTATScrim.scrim.scrimDown()),502==r.status&&(e=!0,l.ctatdebug("Received message (status 502): "+r.responseText),f&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))),
200==r.status?(e=!0,l.ctatdebug("Processing 200 response ..."),null!==c?(a.push(r.responseText),null!==m&&m.processIncoming(r.responseText)):l.ctatdebug("Error: httphandler is null, can't process response!")):c&&c.processError&&(e=!0,l.ctatdebug("Processing non-200 response, status "+r.status),c.processError(r.status,r.responseText)),!1===e&&l.ctatdebug("Error: status not handled for: "+r.status),l.ctatdebug("Marking connection as consumed ..."),h.setConsumed(!0)):(0===r.readyState&&l.ctatdebug("Received message (status 0, request not initialized)"),
1===r.readyState&&l.ctatdebug("Received message (status 1, server connection established)"),2===r.readyState&&l.ctatdebug("Received message (status 2, request received)"),3===r.readyState&&l.ctatdebug("Received message (status 3, processing request)"));b++}l.cleanup();for(b=0;b<a.length;b++)l.ctatdebug("Processing incoming message: "+b),e=a[b],-1!=e.indexOf("status=success")?l.ctatdebug("Info: logging success message received, not propagating to message handler"):(l.ctatdebug("Processing incoming message: "+
e),c.processMessage(e))};this.processWSReply=function(a){l.ctatdebug("processWSReply() length "+(null===a?null:a.toString().length));"string"==typeof a&&(null!==m&&m.processIncoming(a),-1!=a.indexOf("status=success")?l.ctatdebug("processWSReply() logging success message received, not propagating to message handler: "+a):(l.ctatdebug("Processing incoming message: "+a),c.processMessage(a)))};this.processWSClose=function(a){l.ctatdebug("processWSClose("+a+")");a instanceof CloseEvent&&l.ctatdebug("CloseEvent: code "+
a.code+", reason "+a.reason+", wasClean "+a.wasClean);CTATLMS.is.Authoring()?CTATScrim.scrim.scrimUp(CTATGlobals.languageManager.filterString("AUTHORPLEASECLOSE")):CTATScrim.scrim.handleTSDisconnect()};this.cleanup=function(){l.ctatdebug("cleanup ()");for(var a=0,c,b=!1;!1===b;)c=this.checkEntries(),!1===c?b=!0:a++;l.ctatdebug("Removed "+a+" entries")};this.checkEntries=function(){l.ctatdebug("checkEntries ("+d.length+")");var a=0,c;for(c=0;c<d.length;c++){var b=d[c];if(!0===b.getConsumed())return l.ctatdebug("Removing : "+
b.getID()),d.splice(a,1),!0;var f=b.getHTTPObject();l.ctatdebug("Check, readyState: "+f.readyState+", consumed: "+b.getConsumed());a++}return!1};this.retrieveXMLFile=function(a,c,b){l.ctatdebug("retrieveXMLFile ("+a+")");if(location.href){if(l.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){a=(new CTATTutorMessageBuilder).createErrorMessage("","You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");
l.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0);return}}else l.ctatdebug("We can't check location.href in the current configuration");if(-1!=a.toLowerCase().indexOf("file://"))a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+a+" - You are trying to use the file:// protocol, which is not allowed in this browser."),l.ctatdebug("onerror GET for xmlFile "+a),CTAT.ToolTutor.sendToInterface(a,!0);else{w=a;var d=(new CTATConnection).getHTTPObject();
d.onreadystatechange=function(){l.ctatdebug("onready... GET for xmlFile xmlhttp.readyState "+d.readyState+", .status "+d.status+", parser "+c);if(4==d.readyState){if(200==d.status){var a;d.responseXML?(l.ctatdebug("parsing brd xml using something else"),a=d.responseXML.documentElement):(l.ctatdebug("parsing brd xml using node"),a=(c=new CTATXML).parseXML(d.responseText));if(null===a){a=(new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile "+w);l.ctatdebug("Error parsing xmlFile "+
w+": "+a);CTAT.ToolTutor.sendToInterface(a,!0);return}b.processXML(a)}404==d.status&&(a=(new CTATTutorMessageBuilder).createErrorMessage("Unable to download file","("+w+") not found"),l.ctatdebug("Error loading xmlFile "+w+": "+a),CTAT.ToolTutor.sendToInterface(a,!0))}};d.onerror=function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+w+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");
l.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0);b.processXML(null)};d.open("GET",a,!0);d.setRequestHeader("Content-type","text/plain");d.send()}};this.retrieveJSONFile=function(a,c){l.ctatdebug("retrieveJSONFile ("+a+")");if(location.href){if(l.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){var b=(new CTATTutorMessageBuilder).createErrorMessage("","You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");
l.ctatdebug("onerror GET for xmlFile "+b);CTAT.ToolTutor.sendToInterface(b,!0);return}}else l.ctatdebug("We can't check location.href in the current configuration");if(-1!=a.toLowerCase().indexOf("file://"))b=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+a+" - You are trying to use the file:// protocol, which is not allowed in this browser."),l.ctatdebug("onerror GET for xmlFile "+b),CTAT.ToolTutor.sendToInterface(b,!0);else{w=a;var d=(new CTATConnection).getHTTPObject();
d.onreadystatechange=function(){4==d.readyState&&200==d.status&&(l.ctatdebug("Successfully retrieved file: "+a),c(JSON.parse(d.responseText)))};d.onerror=function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+w+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");l.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,
!0)};d.open("GET",a,!0);d.setRequestHeader("Content-type","text/plain");d.send()}};this.retrieveFile=function(a,c){l.ctatdebug("retrieveFile ("+a+")");if(location.href){if(l.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){var b=(new CTATTutorMessageBuilder).createErrorMessage("","You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");l.ctatdebug("onerror GET for xmlFile "+
...
"text/plain");d.send()}}};CTATCommLibrary.setAuthenticityToken=function(a){Array.isArray(a)&&(a=0<a.length?a[0]:"");a&&(CTATCommLibrary.authenticityToken=decodeURIComponent(a))};CTATCommLibrary.getAuthenticityToken=function(a){return CTATCommLibrary.authenticityToken};
...
m=m+(g+"</event_descriptor>")+this.createCustomFields(b,e);m+="</tool_message>";a.ctatdebug("messageString = "+m);return m};this.createTutorMessage=function(g,d,c,f,h,m,l,q){a.ctatdebug("createTutorMessage()");var p=new Date;flashVars.getRawFlashVars();var w='<tutor_message context_message_id="'+this.getContextName()+'">';q||(w+=this.makeMetaElement(p));d='<semantic_event transaction_id="'+d+'" name="'+c+'"';""!==m&&(d+=' subtype="'+m+'"');w+=d+"/>";g="<event_descriptor>"+g.toXMLString(!0);w+=g+"</event_descriptor>";
...
function(){return b};this.getCustomFieldValues=function(){return e}};CTATLogMessageBuilder.prototype=Object.create(CTATBase.prototype);CTATLogMessageBuilder.prototype.constructor=CTATLogMessageBuilder;CTATLogMessageBuilder.contextGUID="";CTATLogMessageBuilder.commLogMessageBuilder=null;var CTATCustomLogElementObject=function(){this.reset=function(){};this.addCustomLogElement=function(a,b){customElementsNames.push(a);customElementsTypes.push(a)};this.getCustomElementNames=function(){return customElementsNames};this.getCustomElementTypes=function(){return customElementsTypes}};var loggingDisabled=!1,CTATLoggingLibrary=function(a){CTATBase.call(this,"CTATLoggingLibrary","logginglibrary");var b=this,e=!0,g=!1,d=!1,c=[],f="undefined",h="undefined",m="undefined",l="undefined",q="undefined",p="undefined",w="undefined",r="undefined",u="UnassignedDataset",n="UnassignedLevelName",B="UnassignedLevelType",v=null,A=null,r=CTATGuid.guid();void 0!=a&&null!=a?(g=a,0==g&&(CTATLogMessageBuilder.commLogMessageBuilder=new CTATLogMessageBuilder)):CTATLogMessageBuilder.commLogMessageBuilder=
new CTATLogMessageBuilder;var y=new CTATCommLibrary;y.setName("commLoggingLibrary");y.setUseCommSettings(!1);y.setConnectionRefusedMessage("ERROR_CONN_LS");y.assignHandler(this);y.setFixedURL(CTATConfiguration.get("log_service_url"));this.getLastSAI=function(){return A};this.assignLogListener=function(a){v=a};this.generateSession=function(){c.session_id="ctat_session_"+CTATGuid.guid();return c.session_id};this.setLogClassName=function(a){f=a};this.setDatasetName=function(a){u=a};this.setDatasetLevelName=
function(a){n=a};this.setDatasetLevelType=function(a){B=a};this.setSchool=function(a){h=a};this.setPeriod=function(a){m=a};this.setDescription=function(a){l=a};this.setInstructor=function(a){q=a};this.setProblemName=function(a){p=a};this.setProblemContext=function(a){w=a};this.setUserID=function(a){r=a};this.getLoggingCommLibrary=function(){return y};this.setUseSessionLog=function(a){e=a};this.setLoggingURL=function(a){b.getLoggingCommLibrary().setFixedURL(a)};this.getSessionIdentifierBundle=function(){var a=
[];a.class_name=f;a.school_name=h;a.period_name=m;a.class_description=l;a.instructor_name=q;a.dataset_name=u;a.problem_name=p;a.problem_context=w;a.auth_token="";a.user_guid=r;a.session_id=c.session_id;a.source_id="tutor";a.dataset_level_name1=n;a.dataset_level_type1=B;return a};this.setupExternalLibraryUsage=function(){b.ctatdebug("setupExternalLibraryUsage ()");c.class_name=f;c.school_name=h;c.period_name=m;c.class_description=l;c.instructor_name=q;c.dataset_name=u;c.problem_name=p;c.problem_context=
w;c.auth_token="";c.user_guid=r;c.session_id="ctat_session_"+CTATGuid.guid();c.source_id="tutor";c.dataset_level_name1=n;c.dataset_level_type1=B;flashVars=CTATConfiguration.generateDefaultConfigurationObject();flashVars.assignRawFlashVars(c)};this.initCheck=function(){b.ctatdebug("initCheck ()");0==g&&0==d&&(b.setupExternalLibraryUsage(),d=!0)};this.sendMessage=function(a){b.ctatdebug("sendMessage ()");b.ctatdebug("Raw log message to send: "+a);this.sendMessageInternal(a);null!=v&&v(a)};this.sendMessageInternal=
function(a){b.ctatdebug("sendMessageInternal ()");if(!0===loggingDisabled)b.ctatdebug("Warning: loggingDisabled==true");else if(1==g){var c=CTATConfiguration.get("Logging");if("ClientToService"!=c&&"ClientToLogServer"!=c)b.ctatdebug("Logging is turned off, as per: "+c);else{var d=CTATConfiguration.get("tutoring_service_communication");"ClientToService"!=c||"http"!=d&&"https"!=d||(c=CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),b.setLoggingURL(c),b.ctatdebug("Reconfigured the logging url to be: "+
c));b.ctatdebug("Pre encoded log message: "+a);0>a.indexOf("<log_session_start")&&(a=CTATLogMessageBuilder.commLogMessageBuilder.wrapForOLI('<?xml version="1.0" encoding="UTF-8"?><tutor_related_message_sequence version_number="4">'+a+"</tutor_related_message_sequence>"));b.ctatdebug("Encoded log message: "+a);CTATLMS.logEvent(a);CTATConfiguration.get("log_service_url")&&y.sendXMLNoBundle(a)}}else b.ctatdebug("Use internal: "+g)};this.startProblem=function(){b.ctatdebug("startProblem ()");b.initCheck();
b.logSessionStart();CTATLogMessageBuilder.commLogMessageBuilder||(CTATLogMessageBuilder.commLogMessageBuilder=new CTATLogMessageBuilder);b.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createContextMessage(!0))};this.logSessionStart=function(){b.ctatdebug("logSessionStart ()");b.initCheck();var a=CTATConfiguration.getRawFlashVars();void 0!=a.SessionLog&&("false"==a.SessionLog||"boolean"==typeof a.SessionLog&&!1===a.SessionLog?(b.ctatdebug("Turning SessionLog off ..."),e=!1):(b.ctatdebug("Turning SessionLog on ..."),
e=!0));!0===e&&(CTATLogMessageBuilder.commLogMessageBuilder||(CTATLogMessageBuilder.commLogMessageBuilder=new CTATLogMessageBuilder),this.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createLogSessionStart()))};this.logSemanticEvent=function(a,c,d,f,e,g,n){b.ctatdebug("logSemanticEvent ("+n+")");b.initCheck();A=c;var l=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(e,g);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tool_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(l)+" UTC");a=CTATLogMessageBuilder.commLogMessageBuilder.createSemanticEventToolMessage(c,a,d,f,!0,n);this.sendMessage(a)};this.logTutorResponse=function(a,c,d,f,e,g,n,l,u){b.ctatdebug("logTutorResponse ()");b.initCheck();A=c;var h=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(l,u);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tutor_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(h)+" UTC");b.ctatdebug("Formatting feedback ...");void 0!=g&&null!=g?g="<![CDATA["+CTATGlobals.languageManager.filterString(g)+"]]\x3e":(b.ctatdebug("No feedback provided, using empty string"),g="");b.ctatdebug("Creating tutor message ...");a=CTATLogMessageBuilder.commLogMessageBuilder.createTutorMessage(c,a,d,e,g,f,n,!0);this.sendMessage(a)};this.processMessage=function(a){b.ctatdebug("processMessage ()");b.ctatdebug("Response from log server: "+
a)};this.start=function(){b.ctatdebug("start ()");var a=b.generateSession();b.startProblem();return a};this.logInterfaceAttempt=function(a,c,d,f){b.ctatdebug("logInterfaceAttempt ()");f=CTATGuid.guid();a=new CTATSAI(a,c,d);a.setInput(d);A=a;this.logSemanticEvent(f,a,"ATTEMPT","");return f};this.logInterfaceAttemptSAI=function(a,c){b.ctatdebug("logInterfaceAttemptSAI ()");A=a;var d=CTATGuid.guid();this.logSemanticEvent(d,a,"ATTEMPT","");return d};this.logResponse=function(a,c,d,f,e,g,n,l){b.ctatdebug("logResponse ()");
c=new CTATSAI(c,d,f);c.setInput(f);f=new CTATActionEvaluationData("");f.setEvaluation(g);void 0==l?this.logTutorResponse(a,c,e,"",f,n):this.logTutorResponse(a,c,e,"",f,n,null,l.getCustomElementNames(),l.getCustomElementTypes())};this.logResponseSAI=function(a,c,d,f,e,g){b.ctatdebug("logResponse ()");var n=new CTATActionEvaluationData("");n.setEvaluation(f);void 0==g?this.logTutorResponse(a,c,d,"",n,e):this.logTutorResponse(a,c,d,"",n,e,null,g.getCustomElementNames(),g.getCustomElementTypes())};this.endSession=
...
"undefined"!==typeof module&&(module.exports=CTATArgument);var CTATStringUtil=function(){this.String2Boolean=function(a){switch(a){case "0":case "false":case "no":case "FALSE":case "NO":case "No":return!1}return!0};this.replaceString=function(a,b,e){return a.replace(b,e)}};"undefined"!==typeof module&&(module.exports=CTATStringUtil);var CTATSAI=function(a,b,e,g){CTATBase.call(this,"CTATSAI","sai");var d=new CTATStringUtil,c="undefined",f=[],h=[],m=[],l=[],q=null,p=this,q="xml"==CTATConfig.parserType?new CTATXML:new CTATJSON;this.getArguments=function(){return m};this.getArgument=function(a){if(0==m.length){var b=new CTATArgument;m.push(b)}return m[a]};this.getArgumentsTyped=function(){p.ctatdebug("getArgumentsTyped");var a,b=[];for(a=0;a<m.length;a++){var c=m[a];"Boolean"===c.getType()?(p.ctatdebug("Adding Boolean argument ("+
...
b);return b};this.addSelection=function(a,b){var c=new CTATArgument;c.setValue(a);void 0!=b&&null!=b&&c.setType(b);f.push(c)};this.addAction=function(a){h.push(a)};this.checkDefaultArgument=function(){p.ctatdebug("checkDefaultArgument ()");if(0===m.length){p.ctatdebug("Adding default argument ...");var a=new CTATArgument;m.push(a)}};this.setArgument=function(a,b){p.checkDefaultArgument();for(var c=m.length;c<=a;++c)m.push(new CTATArgument);c=m[a];c.setValue(b);return c};this.addArgument=function(a,
b,c){this.ctatdebug("addArgument ("+a+","+b+","+c+")");var d=new CTATArgument;d.setValue(a);d.setType(b);d.setFormat(c);m.push(d);return d};this.addExistingArgument=function(a){m.push(a);return a};this.setSAI=function(a,b,d,f,e){p.setSelection(Array.isArray(a)?0<a.length?a[0]:"":a);p.setAction(Array.isArray(b)?0<b.length?b[0]:"":b);p.setInput(Array.isArray(d)?0<d.length?d[0]:"":d);p.setType(f);c=e};this.setInput=function(a){p.ctatdebug("setInput("+a+")");p.checkDefaultArgument();p.getArgument(0).setValue(a)};
...
this.appendToSelectionArray=function(a,b){var c=new CTATArgument;c.setValue(String(a));void 0!=b&&null!=b&&c.setType(b);f.push(c)};this.setSelectionArray=function(a){f=[];for(var b=0;b<a.length;b++)p.appendToSelectionArray(a[b],"String")};this.getSelectionArray=function(){for(var a=[],b=0;b<f.length;b++){var c=f[b];"object"===typeof c?a.push(f[b].getValue()):a.push(c)}return a};this.appendToActionArray=function(a){null==a?h.push(""):h.push(String(a))};this.setActionArray=function(a){h=null==a?[]:
Array.isArray(a)?a.slice():[String(a)]};this.getActionArray=function(){return h};this.appendToInputArray=function(a){p.ctatdebug("appendToInputArray ("+a+")");null==a?p.addArgument("","String","text"):p.addArgument(a,"String","text")};this.setInputArray=function(a){m=[];if(null!=a)for(var b=0;b<a.length;b++)p.appendToInputArray(a[b])};this.getInputArray=function(){p.ctatdebug("getInputArray ("+m.length+")");l=[];for(var a=0;a<m.length;a++){var b=m[a];"object"===typeof b?(p.ctatdebug("Adding object value ("+
b.getValue()+") to temp input array"),l.push(b.getValue())):(p.ctatdebug("Adding string value ("+b+") to temp input array"),l.push(b))}return l};this.setPrompt=function(a){c=a};this.getPrompt=function(){return c};this.propagate=function(a){p.ctatdebug("propagate ()");a=a.getArguments();for(var b=0;b<a.length;b++){var c=a[b],d=m[b];if(null===c||null===d){p.ctatdebug("Internal error: argument lists do not align between received SAI and source SAI");break}d.setValue(c.getValue())}};this.fromString=function(a){a=
q.parse(a);p.fromXML(a)};this.fromXML=function(a){p.ctatdebug("fromXML ()");m=[];a=q.getElementChildren(a);for(var b,c=0;c<a.length;c++){var d=a[c];if("selection"==q.getElementName(d)||"Selection"==q.getElementName(d)){for(var f=q.getElementChildren(d),e=!1,g=0;g<f.length;g++)b=f[g],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>g?p.setSelectionArray(b):p.appendToSelectionArray(b),e=!0,p.setSelection(b));!1===e&&(b=q.getNodeTextValue(d),p.setSelectionArray(b),p.setSelection(b))}if("action"==
q.getElementName(d)||"Action"==q.getElementName(d)){f=q.getElementChildren(d);e=!1;for(g=0;g<f.length;g++)b=f[g],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>g?p.setActionArray(b):p.appendToActionArray(b),e=!0,p.setAction(b));!1===e&&(b=q.getNodeTextValue(d),p.setActionArray(b),p.setAction(b))}if("inputArray"==q.getElementName(d)||"value"==q.getElementName(d)||"Input"==q.getElementName(d)){b=q.getElementChildren(d);var l;m=[];f=new CTATHTMLManager;e=new CTATArgument;g=0;m.push(e);for(var h=
0;h<b.length;h++){var r=b[h];"value"==q.getElementName(r)&&(l=q.getElementChildren(r),null!==l?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+l.length),1===l.length?(l=f.htmlDecode(q.getNodeTextValue(r)),p.ctatdebug("Setting new value to: "+l),e.setValue(l)):(l=f.htmlDecode(q.getNodeTextValue(r)),p.ctatdebug("Setting new value to: "+l),e.setValue(l),e.setName(r.attributes.getNamedItem("name").value),e.setType(r.attributes.getNamedItem("type").value),e.setFormat(r.attributes.getNamedItem("format").value),
g++),1>h?p.setInputArray(l):p.appendToInputArray(l)):(r=f.htmlDecode(q.getNodeTextValue(r)),p.ctatdebug("Setting new value to: "+r),e.setValue(r),1>h?p.setInputArray(r):p.appendToInputArray(r)))}}if("prompt"==q.getElementName(d)||"Prompt"==q.getElementName(d))p.ctatdebug("Parsing prompt ..."),p.setPrompt(q.getNodeTextValue(d))}p.checkDefaultArgument()};this.appendFromElement=function u(a,b,c,d,f){p.ctatdebug("appendFromElement ()");d=String(q.getElementName(b)).toLowerCase();if(d==a||"value"==d)if(d=
q.getElementChildren(b),!Array.isArray(d)||1>d.length)0==f?c.push(q.getNodeTextValue(b)):p.appendToInputArray(q.getNodeTextValue(b));else for(b=0;b<d.length;++b)u(a,d[b],c,b,f)};this.setArrayFromElements=function(a){p.ctatdebug("setArrayFromElements ()");if(!a||!Array.isArray(a)||1>a.length)p.ctatdebug("can't get name: don't know whether selection, action or input");else{var b,c=String(q.getElementName(a[0])).toLowerCase();switch(c){case "selection":p.ctatdebug("Processing selection field ...");f=
[];for(b=0;b<a.length;++b)p.appendFromElement(c,a[b],f,b,!1);break;case "action":p.ctatdebug("Processing action field ...");h=[];for(b=0;b<a.length;++b)p.appendFromElement(c,a[b],h,b,!1);break;case "input":p.ctatdebug("Processing input field ...");m=[];for(b=0;b<a.length;++b)p.appendFromElement(c,a[b],m,b,!0);break;default:console.log('CTATSAI.setArrayFromElements(): unexpected element name "'+c+'"');return}p.ctatdebug("CTATSAI.setArrayFromElements() eltName "+c+", length "+b+", selectionArray "+
p.getSelectionArray()+", actionArray "+p.getActionArray()+", inputArray "+p.getInputArray())}};this.fromXMLInternal=function(a){p.ctatdebug("fromXMLInternal ()");new CTATXML;m=[];a=q.getElementChildren(a);for(var b,c=0;c<a.length;c++){var d=a[c];if("selection"==q.getElementName(d)||"Selection"==q.getElementName(d)){for(var f=q.getElementChildren(d),e=!1,g=0;g<f.length;g++)b=f[g],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>g?p.setSelectionArray(b):p.appendToSelectionArray(b),e=!0,p.setSelection(b));
!1===e&&(b=q.getNodeTextValue(d),p.setSelectionArray(b),p.setSelection(b))}if("action"==q.getElementName(d)||"Action"==q.getElementName(d)){f=d.childNodes;e=!1;for(g=0;g<f.length;g++)b=f[g],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>g?p.setActionArray(b):p.appendToActionArray(b),e=!0,p.setAction(b));!1===e&&(b=q.getNodeTextValue(d),p.setActionArray(b),p.setAction(b))}if("inputArray"==q.getElementName(d)||"Input"==q.getElementName(d)){b=d.childNodes;m=[];var f=new CTATHTMLManager,e=new CTATArgument,
g=0,l;m.push(e);for(var h=0;h<b.length;h++)if(l=b[h],"value"==q.getElementName(l)){var u=q.getElementChildren(l);null!==u?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+u.length),1===u.length?(l=f.htmlDecode(q.getNodeTextValue(l)),p.ctatdebug("Setting new value to: "+l),e.setValue(l)):(l=f.htmlDecode(q.getNodeTextValue(l)),p.ctatdebug("Setting new value to: "+l),e.setValue(l),e.setName(q.getElementAttr("name")),e.setType(q.getElementAttr("type")),e.setFormat(q.getElementAttr("format")),
g++)):(l=f.htmlDecode(q.getNodeTextValue(l)),p.ctatdebug("Setting new value to: "+l),e.setValue(l));1>h?p.setInputArray(l):p.appendToInputArray(l)}}if("prompt"==q.getElementName(d)||"Prompt"==q.getElementName(d))p.ctatdebug("Parsing prompt ..."),p.setPrompt(q.getNodeTextValue(d))}p.checkDefaultArgument()};this.toXMLString=function(a){p.ctatdebug("toXMLString ()");return a?p.toLSxmlString():p.toTSxmlString()};this.toLSxmlString=function(){p.ctatdebug("toLSxmlString ()");for(var a="",b=0;b<f.length;b++){var c=
f[b];"object"===typeof c?(a="String"!=c.getType()?a+('<selection type="'+c.getType()+'">'):a+"<selection>",a+=c.getValue()+"</selection>"):a+="<selection>"+c+"</selection>"}a+="<action>"+p.getAction();for(b=1;b<h.length;b++)a+="</action><action>"+h[b];a+="</action>";for(b=0;b<m.length;b++)c=m[b],a="object"===typeof c?"String"!=c.getType()?a+('<input type="'+c.getType()+'"><![CDATA['+c.getValue()+"]]\x3e</input>"):a+("<input><![CDATA["+c.getValue()+"]]\x3e</input>"):a+("<input><![CDATA["+c+"]]\x3e</input>");
return a};this.toTSxmlString=function(){p.ctatdebug("toTSxmlString ()");var a;a="<Selection><value>"+p.getSelection();for(var b=1;b<f.length;b++){var c=f[b];a="object"===typeof c?a+("</value><value>"+c.getValue()):a+("</value><value>"+c)}a+="</value></Selection><Action><value>"+p.getAction();for(b=1;b<h.length;b++)a+="</value><value>"+h[b];a+="</value></Action><Input>";if(1<m.length)for(b=0;b<m.length;b++)c=m[b],a+='<value fmt="text" name="'+c.getName()+'" type="'+c.getType()+'"><![CDATA['+c.getValue()+
"]]\x3e</value>";else a+="<value><![CDATA["+p.getInput()+"]]\x3e</value>";return a+"</Input>"};this.toSerializedString=function(){var a;a=""+("<selection>"+p.getSelection()+"</selection><action>"+p.getAction()+"</action><inputArray>");for(var b=0;b<m.length;b++){var c=m[b];a+='<value fmt="text" name="'+c.getName()+'" type="'+c.getType()+'">'+c.getValue()+"</value>"}return a+"</inputArray>"};this.clone=function(){p.ctatdebug("clone ()");for(var a=new CTATSAI(p.getSelection(),p.getAction(),p.getInput(),
...
var w=!1;if(Array.isArray(a)&&Array.isArray(b)&&(Array.isArray(e)||null==e)&&(p.setSelectionArray(a),p.setActionArray(b),p.setInputArray(e),w=!0,0<a.length&&0<b.length)){p.setSAI(a[0],b[0],null==e?null:e[0],"String",g);return}null!==a&&""!==a&&p.setSelection(a);null!==a&&(p.setSAI(a,b,e,"String",g),w||(p.setSelectionArray(Array.isArray(a)?a:[a]),p.setActionArray(Array.isArray(b)?b:[b]),p.setInputArray(Array.isArray(e)?e:[e]),w=!0))};CTATSAI.prototype=Object.create(CTATBase.prototype);
CTATSAI.prototype.constructor=CTATSAI;"undefined"!==typeof module&&(module.exports=CTATSAI);var CTATSkill=function(){CTATBase.call(this,"CTATSkill","skill");var a="",b="",e="",g="",d=0,c="",f=!1,h="",m="",l="",q="",p="";this.setSkillName=function(b){a=b};this.setDisplayName=function(a){b=a};this.setModelName=function(a){g=a};this.setCategory=function(a){e=a};this.setLevel=function(a){!0===isNaN(a)?ctatdebug("Error: attempting to set a level to NaN"):(d=a,this.setPKnown(String(d)))};this.setDescription=function(a){c=a};this.getSkillName=function(){return a};this.getDisplayName=function(){return b};
...
h=h?h.value:"",m=g.attributes.getNamedItem("category"),m=m?m.value:"",l=g.attributes.getNamedItem("pGuess"),l=l?l.value:"",q=g.attributes.getNamedItem("pLearn"),q=q?q.value:"",p=g.attributes.getNamedItem("pSlip"),p=p?p.value:"",g=(g=g.attributes.getNamedItem("history"))?g.value:"";this.addSkill(d,c,.95,f,h,m,l,q,p,g)}}}else this.ctatdebug("Error: list of skill xml elements is null");else a.ctatdebug("Error: aSkills is null")};this.getSkillSet=function(){return this.internalSkillSet};this.getSize=
function(){return this.internalSkillSet.length};this.addSkill=function(a,e,g,d,c,f,h,m,l,q){this.ctatdebug("addSkill() name = "+a+" level = "+e+" mastery = "+g+" aDescription = "+d+" adisplayName = "+c+" aCategory = "+f+" pguess= "+h+" plearn = "+m+" pslip = "+l+" history = "+q);a=this.setSkillLevel(a,e,g);this.ctatdebug("Configuring "+a.getDisplayName());d&&a.setDescription(d);c&&a.setDisplayName(c);f&&a.setCategory(f);(h||0===h)&&a.setPGuess(h);(m||0===m)&&a.setPLearn(m);(l||0===l)&&a.setPSlip(l);
...
g=d.getElementChildren(c))}this.ctatdebug("Message "+l+", with transaction id: "+q)}};this.parseSAI=function(){this.ctatdebug("parseSAI ()");var a="",c="",g="",q="",v=[],C=[],E=[];if("tool_message"==l){this.ctatdebug("Parsing s, a and i");a=d.getElementChildren(e);for(c=0;c<a.length;c++)if(g=a[c],"tool_message"==d.getElementName(g))for(g=d.getElementChildren(g),q=0;q<g.length;q++)v=g[q],"event_descriptor"==d.getElementName(v)&&(n=new CTATSAI,n.fromXMLInternal(v));h=!0}else{if(f){this.ctatdebug("isLogMessage ...");
for(var t=d.getElementChildren(e),G=0;G<t.length;G++){var z=t[G];if("event_descriptor"==d.getElementName(z))for(var z=d.getElementChildren(z),J=0;J<z.length;J++){var H=z[J];"selection"==d.getElementName(H)&&(a=d.getNodeTextValue(H),v.push(H));"action"==d.getElementName(H)&&(c=d.getNodeTextValue(H),C.push(H));"input"==d.getElementName(H)&&(g=d.getNodeTextValue(H),E.push(H));"prompt"==d.getElementName(H)&&(q=d.getNodeTextValue(H))}}}else for(this.ctatdebug("!isLogMessage ..."),t=d.getElementChildren(e),
G=0;G<t.length;G++)if(z=t[G],"properties"==d.getElementName(z))for(z=d.getElementChildren(z),J=0;J<z.length;J++){var H=z[J],K=d.getElementName(H);this.ctatdebug("Nodename: "+K);switch(K){case "URL":u=d.getNodeTextValue(H);break;case "Skills":m.parseByValue(H);break;case "SuccessMsg":p=a=d.getNodeTextValue(H);break;case "BuggyMsg":w=d.getNodeTextValue(H);break;case "Selection":a=d.getNodeTextValue(H);v.push(H);break;case "Action":c=d.getNodeTextValue(H);C.push(H);break;case "Input":g=d.getNodeTextValue(H);
E.push(H);break;case "prompt":q=d.getNodeTextValue(H);break;case "HighlightMsgText":r=d.getNodeTextValue(H);break;case "custom_fields":B=b(H)}}this.ctatdebug("SAI: "+a+","+c+","+g);""!==a&&null!==a?(n=new CTATSAI(a,c,g,q),n.setArrayFromElements(v),n.setArrayFromElements(C),n.setArrayFromElements(E),h=!0):(this.ctatdebug("No SAI found"),h=!1);this.ctatdebug("parseSAI () done, hassai: "+h+", ("+a+","+c+","+g+","+q+")")}};this.parseTransactionID=function(){this.ctatdebug("parseTransactionID()");if("tool_message"!=
...
f=0;f<c.length;f++){var g=c[f];"MessageType"==d.getElementName(g)&&(l=d.getNodeTextValue(g))}}this.ctatdebug("parseMessageType() -> "+l)};this.getMessageType=function(){return l};this.getTransactionID=function(){return q};this.getSAI=function(){return h?n:new CTATSAI};this.getSelection=function(){return h?n.getSelection():""};this.getAction=function(){return h?n.getAction():""};this.getInput=function(){return h?n.getInput():""};this.getSelectionArray=function(){return h?n.getSelectionArray():[]};
this.getActionArray=function(){return h?n.getActionArray():[]};this.getInputArray=function(){return h?n.getInputArray():[]};this.getXML=function(){return e};this.getXMLString=function(a){if(e.xml)return e.xml;if(XMLSerializer)return(new XMLSerializer).serializeToString(e);alert("ERROR: Extremely old browser");return""};this.getIndicator=function(){return"AssociatedRules"!=l?"":this.getProperty("Indicator")};this.getIndicatorSub=function(){return"AssociatedRules"!=l?"":this.getProperty("IndicatorSub")};
...
"message"==b&&this.processSingleMessage(a)};this.processMessageBundle=function(a){var b=c.getElementName(a);g.ctatdebug("processMessageBundle ("+b+")");a=c.getElementChildren(a);if(null===a)g.ctatdebug("Error parsing bundle");else for(ctatdebug("Processing "+a.length+" objects in bundle"),b=0;b<a.length;b++)this.parseElement(a[b])};this.processSingleMessage=function(b){g.ctatdebug("processSingleMessage ("+c.getElementName(b)+")");var l=new CTATMessage(b),h=l.getProperty("subtype"),h=!h||/tutor/i.test(h)?
"tutor":h;b=c.getElementChildren(b);g.ctatdebug("Generated CTATMessage, now doing regular processing ...");for(var m=0;m<b.length;m++){var w=b[m];if("properties"==c.getElementName(w)){g.ctatdebug("Parsing properties ...");for(var r=c.getElementChildren(w),u=0;u<r.length;u++){var n=r[u];if("MessageType"==c.getElementName(n)){n=c.getNodeTextValue(n);console.log("nodeValue="+n);g.ctatdebug("MessageType: "+n);"StateGraph"==n&&(ctatdebug("Setting inStartState to true"),CTATMessageHandler.inStartState=
!0,a.setGotProblemRestoreEnd(!1),this.processStateGraph(w),a.propagateShellEvent("StateGraph",l));"StartProblem"==n&&(g.ctatdebug("Setting inStartState to true"),CTATMessageHandler.inStartState=!0,a.setGotProblemRestoreEnd(!1),this.processStartProblem(r),a.propagateShellEvent("StartProblem",l));"InterfaceIdentification"==n&&(this.processInterfaceIdentification(r),a.propagateShellEvent("InterfaceIdentification",l));"InterfaceDescription"==n&&(this.processInterfaceDescription(r),a.propagateShellEvent("InterfaceDescription",
l));"GetAllInterfaceDescriptions"==n&&(a.getAllInterfaceDescriptions(),a.propagateShellEvent("GetAllInterfaceDescriptions",l));"SendWidgetLock"==n&&(g.ctatdebug("Found: SendWidgetLock"),!0===this.getInStartState()&&d.push(l),a.propagateShellEvent("SendWidgetLock",l));"CorrectAction"==n&&(console.log("CORRECT CORRECT CORRECT"),useDebuggingBasic=!0,g.ctatdebug("Found: CorrectAction"),!0===this.getInStartState()?d.push(l):e.processCorrectAction(l),a.propagateShellEvent("CorrectAction",l));"InCorrectAction"==
n&&(console.log("INCORRECT INCORRECT INCORRECT"),useDebuggingBasic=!0,g.ctatdebug("Found: InCorrectAction"),g.ctatdebug("KMD - debug"),useDebuggingBasic=!1,!0===CTATMessageHandler.inStartState?d.push(l):(g.ctatdebug("Handing incorrect message to messagehandler ..."),e.processInCorrectAction(l)),a.propagateShellEvent("InCorrectAction",l));"HighlightMsg"==n&&(g.ctatdebug("Found: HighlightMsg"),e.processHighlightMsg(l),a.propagateShellEvent("HighlightMsg",l));"UnHighlightMsg"==n&&(g.ctatdebug("Found: UnHighlightMsg"),
e.processUnHighlightMsg(l),a.propagateShellEvent("UnHighlightMsg",l));if("AssociatedRules"==n){g.ctatdebug("Found: AssociatedRules ("+r.length+")");for(var B="",v="",A=0;A<r.length;A++){var y=r[A];"TutorAdvice"==c.getElementName(y)&&(B=c.getNodeTextValue(y));"Actor"==c.getElementName(y)&&(h=c.getNodeTextValue(y));"Indicator"==c.getElementName(y)&&(v=c.getNodeTextValue(y));"StepID"==c.getElementName(y)&&c.getNodeTextValue(y);"LogAsResult"==c.getElementName(y)&&c.getNodeTextValue(y);"tool_selection"==
c.getElementName(y)&&c.getNodeTextValue(y);"Skills"==c.getElementName(y)&&(g.ctatdebug("Processing skills ..."),null===CTATSkillSet.skills&&(g.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(y))}e.processAssociatedRules(l,v,B);a.propagateShellEvent("AssociatedRules",l)}"BuggyMessage"==n&&(g.ctatdebug("Found: BuggyMessage"),e.processBuggyMessage(l),a.propagateShellEvent("BuggyMessage",l));"SuccessMessage"==
n&&(g.ctatdebug("Found: SuccessMessage"),e.processSuccessMessage(l),a.propagateShellEvent("SuccessMessage",l));-1!=n.indexOf("InterfaceAction")&&(g.ctatdebug("Found: InterfaceAction"),B=l.getSAI(),-1!=B.getAction().indexOf(":")?(g.ctatdebug("Processing and storing timed interface action : "+B.getAction()),v=parseInt(B.getAction().substring(B.getAction().indexOf(":")+1)),g.ctatdebug("Target time: "+v),B.setAction(B.getAction().substring(0,B.getAction().indexOf(":"))),g.ctatdebug("Timing ..."),setTimeout(e.processInterfaceAction,
v,l),setTimeout(a.propagateShellEvent,v,"InterfaceAction",l,"tutor")):(g.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(g.ctatdebug("inStartState==true => storing for later playback ..."),d.push(l)):(e.processInterfaceAction(l),a.propagateShellEvent("InterfaceAction",l,h))));-1!=n.indexOf("UntutoredAction")&&(g.ctatdebug("Found: UntutoredAction"),B=l.getSAI(),-1!=B.getAction().indexOf(":")?(g.ctatdebug("Processing and storing timed interface action : "+
B.getAction()),v=parseInt(B.getAction().substring(B.getAction().indexOf(":")+1)),g.ctatdebug("Target time: "+v),B.setAction(B.getAction().substring(0,B.getAction().indexOf(":"))),g.ctatdebug("Timing ..."),setTimeout(e.processUntutoredAction,v,l),setTimeout(a.propagateShellEvent,v,"UntutoredAction",l,"tutor")):(g.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(g.ctatdebug("inStartState==true => storing for later playback ..."),d.push(l)):(e.processUntutoredAction(l),
a.propagateShellEvent("UntutoredAction",l,h))));"InterfaceIdentification"==n&&(g.ctatdebug("Found: InterfaceIdentification"),a.propagateShellEvent("InterfaceIdentification",l));"AuthorModeChange"==n&&(g.ctatdebug("Found: AuthorModeChange"),e.globalReset(),a.propagateShellEvent("AuthorModeChange",l));"ResetAction"==n&&(g.ctatdebug("Found: ResetAction"),e.globalReset(),a.propagateShellEvent("ResetAction",l));if("ShowHintsMessage"==n){g.ctatdebug("Found: ShowHintsMessage");B=!1;v=[];for(A=0;A<r.length;A++)if(y=
r[A],"HintsMessage"==c.getElementName(y))for(var y=c.getElementChildren(y),F=0;F<y.length;F++){var D=y[F];"value"==c.getElementName(D)&&(v.push(c.getNodeTextValue(D)),B=!0)}!0===B?e.processHintResponse(l,v):g.ctatdebug("Error: incomplete hint message received");a.propagateShellEvent("ShowHintsMessage",l)}"ConfirmDone"==n&&(g.ctatdebug("Found: ConfirmDone"),e.processConfirmDone(l),a.propagateShellEvent("ConfirmDone",l));"VersionInfo"==n&&(g.ctatdebug("Found: VersionInfo"),e.processVersionInfo(r),a.propagateShellEvent("VersionInfo",
l));"TutoringServiceAlert"==n&&(g.ctatdebug("Found: TutoringServiceAlert"),e.processTutoringServiceAlert(r),a.propagateShellEvent("TutoringServiceAlert",l));"TutoringServiceError"==n&&(g.ctatdebug("Found: TutoringServiceError"),e.processTutoringServiceError(r),a.propagateShellEvent("TutoringServiceError",l));"ProblemSummaryResponse"==n&&(g.ctatdebug("Found: ProblemSummaryResponse"),e.processProblemSummaryResponse(l),a.propagateShellEvent("ProblemSummaryResponse",l));if("StartStateEnd"==n){g.ctatdebug("Found: StartStateEnd");
CTATShellTools.listComponents();null!==e?e.processStartState():this.ctatdebug("Error: no message handler object available to process start state");try{g.processStartStateActions()}catch(x){g.ctatdebug("Caught in the act: "+x.message)}CTATMessageHandler.inStartState=!1;a.propagateShellEvent("StartStateEnd",l)}"ProblemRestoreEnd"==n&&(g.ctatdebug("Found: ProblemRestoreEnd"),e.processProblemRestoreEnd(l),a.propagateShellEvent("ProblemRestoreEnd",l));"GetURL"==n&&(g.ctatdebug("Found: GetURL"),e.processGetURL(l),
a.propagateShellEvent("GetURL",l));if("SetPreferences"==n){e.forwardToTutor(l);return}"InterfaceReboot"==n&&(f++,ctatdebug("Found: InterfaceReboot #"+f+" -- href "+(location?location.href:"(no location)")),1<f&&!CTAT.ToolTutor.reboot("InterfaceReboot from CTATMessageHandler")&&(n="ws://"+CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),ctatdebug("closing connection w/ url: "+n),a.closeWSConnection(n,function(){var a=window.frameElement.getAttribute("id");"function"==
typeof CustomEvent&&(a=new CustomEvent("refreshIframe",{detail:a}),window.parent.document.dispatchEvent(a))},"interfaceReboot")));(n=/student[0-9]+/i.exec(h))&&n[0]==h&&e.forwardToTutor(l)}}}}};this.processStateGraph=function(a){g.ctatdebug("processStateGraph ()");if(void 0===a||null===a)g.ctatdebug("Error: state graph property list is undefined");else if(g.ctatdebug("Processing node: "+a.nodeName),null===c.getElementChildren(a))g.ctatdebug("Error: state graph property list is undefined");else{a=
c.getElementChildren(a);for(var b=0;b<a.length;b++){var d=a[b];g.ctatdebug("State graph attribute: "+c.getElementName(d));"caseInsensitive"==c.getElementName(d)&&(caseInsensitive="false"==c.getNodeTextValue(d)?!1:!0);"unordered"==c.getElementName(d)&&(unordered="false"==c.getNodeTextValue(d)?!1:!0);"lockWidget"==c.getElementName(d)&&(lockWidget="false"==c.getNodeTextValue(d)?!1:!0);"suppressStudentFeedback"==c.getElementName(d)&&("false"==c.getNodeTextValue(d)?CTATGlobals.suppressStudentFeedback=
!1:CTATGlobals.suppressStudentFeedback=!0);"highlightRightSelection"==c.getElementName(d)&&(highlightRightSelection="false"==c.getNodeTextValue(d)?!1:!0);"confirmDone"==c.getElementName(d)&&(g.ctatdebug("Confirm done: "+c.getNodeTextValue(d)),"true"==c.getNodeTextValue(d)?CTATGlobals.confirmDone=!0:CTATGlobals.confirmDone=!1);"Skills"==c.getElementName(d)&&(null===CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(d),e.updateSkillWindow())}}};this.processStartProblem=
function(a){g.ctatdebug("processStartProblem ()");e.processStartProblem()};this.processInterfaceIdentification=function(a){};this.processInterfaceDescription=function(a){g.ctatdebug("processInterfaceDescription ("+a.length+")");for(var b="Unknown",d="Unknown",f=null,e=0;e<a.length;e++){var h=a[e];g.ctatdebug("Inspecting element: "+c.getElementName(h));"WidgetType"==c.getElementName(h)&&(g.ctatdebug("Widget type: "+c.getNodeTextValue(h)),b=c.getNodeTextValue(h));"CommName"==c.getElementName(h)&&(g.ctatdebug("Instance name: "+
c.getNodeTextValue(h)),d=c.getNodeTextValue(h));if("serialized"==c.getElementName(h)){g.ctatdebug("Prepareing to de-serialize component ...");for(var m=c.getElementChildren(h),n=0;n<m.length;n++){var B=m[n];-1!=c.getElementName(B).indexOf("CTAT")&&(f=B)}}"interface"==c.getElementName(h)&&(g.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=h);"script"==c.getElementName(h)&&(g.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),
scriptElement=c.getNodeTextValue(h))}null!==f?this.deserializeComponent(b,d,f):g.ctatdebug("Error: unable to find CTAT serialization point of attachement");g.ctatdebug("processInterfaceDescription () done")};this.deserializeComponent=function(a,b,d){g.ctatdebug("deserializeComponent ("+a+","+b+")");if(!0===CTATGlobals.ignoreInterfaceDescriptions)g.ctatdebug("ignoreInterfaceDescriptions==true");else if(null===c.getElementAttr(d,"x"))g.ctatdebug("Warning: this component does not have x,y information. Probably an older component");
else{var f=c.getElementAttr(d,"x"),e=c.getElementAttr(d,"y"),l=c.getElementAttr(d,"width"),h=c.getElementAttr(d,"height"),n=c.getElementAttr(d,"tabIndex"),m=c.getElementAttr(d,"zIndex");null===n&&(n=-1);null===m&&(m=0);var q=new CTATComponentDescription;q.type=a;q.name=b;q.x=Math.floor(f);q.y=Math.floor(e);q.tabIndex=n;q.zIndex=m;q.width=Math.floor(l);q.height=Math.floor(h);CTATShellTools.registerComponentDescription(q);d=c.getElementChildren(d);for(f=0;f<d.length;f++){e=d[f];c.getElementName(e);
if("Parameters"==c.getElementName(e))for(this.ctatdebug("Processing component parameters ..."),l=c.getElementChildren(e)[0],l=c.getElementChildren(l),h=0;h<l.length;h++){var A=l[h];if("CTATComponentParameter"==c.getElementName(A)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var m=n=void 0,A=c.getElementChildren(A),y=0;y<A.length;y++){var F=A[y];"name"==c.getElementName(F)&&(this.ctatdebug("Found parameter name: "+c.getNodeTextValue(F)),n=c.getNodeTextValue(F));
"value"==c.getElementName(F)&&(this.ctatdebug("Found parameter value: "+c.getNodeTextValue(F)),m=c.getNodeTextValue(F).trim())}this.ctatdebug("Parameter name: "+n+", value: "+m);void 0!==n&&(q.params[n]=m,"group"==n&&(q.groupName=m))}}if("Styles"==c.getElementName(e))for(this.ctatdebug("Processing component styles ..."),e=c.getElementChildren(e)[0],e=c.getElementChildren(e),l=0;l<e.length;l++)if(m=e[l],"CTATStyleProperty"==c.getElementName(m)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");
n=h="";m=c.getElementChildren(m);for(A=0;A<m.length;A++)y=m[A],"name"==c.getElementName(y)&&(h=c.getNodeTextValue(y)),"value"==c.getElementName(y)&&(n=c.getNodeTextValue(y).trim());this.ctatdebug("Style (name: "+h+", value: "+n+")");""!==h&&(q.styles[h]=n)}}g.ctatdebug("deserializeComponent ("+a+","+b+") done")}};this.processStartStateActions=function(){g.ctatdebug("processStartStateActions ("+d.length+")");if(0===d.length)g.ctatdebug("No start state messages, bump");else if(0<CTATMessageHandler.startStateHandlers.length)for(var a=
0;a<CTATMessageHandler.startStateHandlers.length;a++)CTATMessageHandler.startStateHandlers[a].processStartStateActions(d);else{for(var a=b(),c=0;c<d.length;c++){var f=d[c];g.ctatdebug("Processing startstate message type: "+f.getMessageType());"InterfaceAction"==f.getMessageType()&&e.processInterfaceAction(f,a);"CorrectAction"==f.getMessageType()&&e.processCorrectAction(f);"InCorrectAction"==f.getMessageType()&&e.processInCorrectAction(f);this.sleep(1E3)}if(""!==CTATMessageHandler.scriptElement)try{eval(CTATMessageHandler.scriptElement)}catch(p){alert("Error executing script from BRD: "+
p.message)}}};this.sleep=function(a){g.ctatdebug("sleep ("+a+")")}};CTATMessageHandler.prototype=Object.create(CTATBase.prototype);CTATMessageHandler.prototype.constructor=CTATMessageHandler;CTATMessageHandler.startStateHandlers=[];CTATMessageHandler.inStartState=!1;CTATMessageHandler.scriptElement="";var CTATTransactionListener=function(a){function b(a){return a&&"function"==typeof a.getTransactionID?a.getTransactionID():null}function e(a){h.ctatdebug("formatTimeStamp ("+a+")");return sprintf("%04d-%02d-%02d %02d:%02d:%02d.%03d UTC",a.getUTCFullYear(),a.getUTCMonth()+1,a.getUTCDate(),a.getUTCHours(),a.getUTCMinutes(),a.getUTCSeconds(),a.getUTCMilliseconds())}function g(a,b){for(var c,d,f=1;;++f){var e=b+"_type"+f,g=b+"_name"+f;c=CTATConfiguration.get(e);d=CTATConfiguration.get(g);if(!c||!d)break;
...
[];h.ctatdebug("CTATTransactionListener.getPropertyAsArray("+b+") withValues "+c+", result "+d);return d}function f(a,b){for(var d=c(a,b),f="",e=0;e<d.length;++e)f+=d[e];h.ctatdebug("CTATTransactionListener.getProperty("+b+") valueElts "+d+", result "+f);return f}CTATBase.call(this,"CTATTransactionListener","");var h=this,m=null,l={},q=0,p=CTATConfig.parserType_is_XML()?new CTATXML:new CTATJSON;this.getMailer=function(){return m};this.onmessage=function(a){h.ctatdebug("CTATTransactionListener.onmessage("+
a.toString()+")");(a=a.data&&3<=a.data.length?new CTATSAI(a.data[0],a.data[1],a.data[2]):null)&&CTATCommShell.shell.processComponentAction(a,!1,!0,null,"ATTEMPT","Detector")};if(!m)a:{if("undefined"!=typeof TransactionMailerUsers&&"function"==typeof TransactionMailerUsers.create)try{m=m=TransactionMailerUsers.create("Assets",a,CTATConfiguration.get("process_detectors_url"),CTATConfiguration.get("authenticity_token"),CTATConfiguration.get("detectors"));break a}catch(w){console.trace("Error creating transaction mailer: "+
w);m=m=null;break a}m=void 0}this.isReady=function(){return null!=h.mailerProxy};this.toString=function(){return"transactions sent to ["+h.process_transactions_url+":]"};this.processCommShellEvent=function(a,r,u){console.trace("CTATTransactionListener.processCommShellEvent("+a+", "+r+", "+u+")");try{var n=null;switch(a){case "InterfaceAction":case "AssociatedRules":case "UntutoredAction":case "NextPressed":case "PreviousPressed":var w=r;r&&r.constructor!=CTATMessage&&(w=r.constructor!=Element?p.parse(w):
w,w=new CTATMessage(w));var v=w;h.ctatdebug("CTATTransactionListener.makeOrCompleteTransaction("+a+") pointer "+h+", problemInfo null, pointer.problemInfo "+(h?h.problemInfo:null));var A=w=null,y=!1;if(A=b(v)){var F,D;b:switch(a){case "UntutoredAction":D=!1;break b;case "InterfaceAction":D="tutor-performed"!=f(v,"subtype").toLowerCase();break b;default:D=!0}if(F=!(y=!D)){var x;D=A;var C=l[D];C?(delete l[D],--q,h.ctatdebug("CTATTransactionListener.removeIncompleteTransaction("+D+") count now "+q),
x=C):x=null;F=(w=x)&&(y=!0)}F||(w={meta:h.problemInfo.meta,context:h.problemInfo.context});switch(a){case "AssociatedRules":case "NextPressed":case "PreviousPressed":u=w;u.tutor_data&&console.log("Warning: CTATTransactionListener.addTutorInfo("+a+") tx has tutor_data with time "+u.tutor_data.tutor_event_time);u.tutor_data={};u.tutor_data.tutor_event_time=e(new Date);u.tutor_data.selection=f(v,"Selection");u.tutor_data.action=f(v,"Action");u.tutor_data.input=f(v,"Input");u.tutor_data.action_evaluation=
v.getIndicator();0<=u.tutor_data.action_evaluation.toLowerCase().indexOf("hint")&&(u.tutor_data.current_hint_number=f(v,"CurrentHintNumber"),u.tutor_data.total_hints_available=f(v,"TotalHintsAvailable"));u.tutor_data.tutor_advice=f(v,"TutorAdvice");var E=u.tutor_data;F=[];var t=CTAT.ToolTutor.tutor&&CTAT.ToolTutor.tutor.getProblemSummary()?CTAT.ToolTutor.tutor.getProblemSummary().getSkills():null,G=v.getSkillsObject().getSkillSet();for(x=0;x<G.length;++x){var z=G[x],J=CTATSkillSet.skills?CTATSkillSet.skills.getSkill(z.getSkillName()):
null;if(J){C={};C.name=J.getSkillName();C.category=J.getCategory();var H=null==C.category||""==C.category.trim()?C.name:C.name+" "+C.category,K=t?t.getSkill(H):null,I;K?(C.pKnown=isNaN(I=K.getPKnown())?"":I,C.pGuess=isNaN(I=K.getPGuess())?"":I,C.pSlip=isNaN(I=K.getPSlip())?"":I,C.pLearn=isNaN(I=K.getPLearn())?"":I,C.history=isNaN(I=K.getHistory())?"":I,C.opportunityCount=isNaN(I=K.getOpportunityCount())?"":I):(C.pKnown=isNaN(I=J.getPKnown())?"":I,C.pGuess=isNaN(I=J.getPGuess())?"":I,C.pSlip=isNaN(I=
J.getPSlip())?"":I,C.pLearn=isNaN(I=J.getPLearn())?"":I);h.ctatdebug("CTATTransactionListener.createSkills() ssSk "+J+", tracerSk "+K+", skElt "+C);F.push(C)}}E.skills=F;u.tutor_data.step_id=f(v,"StepID");u.tutor_data.rule_names=c(v,"Rules");var P=u.tutor_data,N=v.getCustomFields();h.ctatdebug("CTATTransactionListener.createCustomFields() result "+N);P.custom_fields=N;break;default:w.meta.date_time=e(new Date);E=w;if(!(E.transaction_id=b(v)))throw Error("Message has no transaction_id: eventType "+
a+", msg\n  "+v);E.semantic_event="UntutoredAction"==a?"UNTUTORED-ACTION":d(a,v)?"HINT-REQUEST-HINTS":"ATTEMPT-RESULT";E.actor=u?u:"student";E.tool_data&&console.log("Warning: CTATTransactionListener.addToolInfo("+a+") tx has tool_data with time "+E.tool_data.tool_event_time);E.tool_data={};E.tool_data.tool_event_time=e(new Date);E.tool_data.selection=f(v,"Selection");E.tool_data.action=f(v,"Action");E.tool_data.input=f(v,"Input")}var O;if(y)O=w;else{var E=A,t=w,L=l[E];L&&(console.log("Warning: CTATTransactionListener.storeIncompleteTransaction() found tx with ID "+
E,L),--q);l[E]=t;++q;h.ctatdebug("CTATTransactionListener.storeIncompleteTransaction("+E+") count now "+q);O=null}n=O}else n=null;break;case "StartProblem":h.ctatdebug("CTATTransactionListener.createContextMessage()");O={};var Q=new Date;h.ctatdebug("TX.makeMetaElement ()");L={};L.date_time=e(Q);L.session_id=CTATConfiguration.get("session_id");L.user_guid=CTATConfiguration.get("user_guid");O.meta=L;O.context={};w=O.context;L=null;CTATLogMessageBuilder&&CTATLogMessageBuilder.commLogMessageBuilder&&
(L=CTATLogMessageBuilder.commLogMessageBuilder.getContextName());L||(L=CTATLogMessageBuilder.contextGUID);if(!L)throw Error("Context message ID not yet defined");w.context_message_id=L;v=O.context;A=CTATConfiguration.get("class_name");v.class_name=A?A:"";A=CTATConfiguration.get("school_name");v.class_school=A?A:"";A=CTATConfiguration.get("period_name");v.class_period_name=A?A:"";A=CTATConfiguration.get("class_description");v.class_description=A?A:"";A=CTATConfiguration.get("instructor_name");v.class_instructor_name=
A?A:"";var y=O.context,M=CTATConfiguration.get("dataset_name");y.dataset_name=M?M:"";g(y,"dataset_level");prop=CTATConfiguration.get("problem_name");y.problem_name=prop?prop:"";prop=CTATConfiguration.get("problem_context");y.problem_context=prop?prop:"";prop=CTATConfiguration.get("problem_tutorflag");y.problem_tutorFlag=prop?prop:"";g(y,"study_condition");h.problemInfo=O;break;case "ProblemRestoreEnd":h.initializing=!1}n&&!h.initializing&&m.sendTransaction(n)}catch(R){console.log("Error in CTATTransactionListener.processCommShellEvent("+
a+"): "+R,R.stack)}};ctatdebug("**<end of CTATTransactionListener constructor, process_transactions_url "+a+", mailerProxy "+m)};Object.defineProperty(CTATTransactionListener,"scriptParam",{enumerable:!1,configurable:!1,writable:!1,value:"process_transactions_url"});Object.defineProperty(CTATTransactionListener,"valueDelimiter",{enumerable:!1,configurable:!1,writable:!1,value:/<\/?value>/});CTATTransactionListener.prototype=Object.create(CTATBase.prototype);
CTATTransactionListener.prototype.constructor=CTATTransactionListener;"undefined"!==typeof module&&(module.exports=CTATTransactionListener);
CTATTransactionListener.create=function(a){var b=null;if(!a&&("undefined"==typeof TransactionMailerUsers||"function"!=typeof TransactionMailerUsers.create))return null;try{if(b=new CTATTransactionListener(a),!b.getMailer())throw Error("Transaction listener postMessage() not defined.");}catch(e){console.trace("Error creating or connecting to transaction listener",e),b=null}return b};var CTATNameTranslator=function(){CTATBase.call(this,"CTATNameTranslator","translator");var a=!1,b=this;this.setPassthrough=function(b){a=CTATGlobalFunctions.toBoolean(b)};this.getPassthrough=function(){return a};this.manufactorJSON=function(a,g){b.ctatdebug("manufactorJSON ("+a+","+g+")");var d=a.split(":");if(1==d.length)return b.ctatdebug("No range in aRange, returning basic JSON ..."),"";var c=this.getA1Row(d[0]),f=this.getA1Col(d[0]),e=this.getA1Row(d[1]),m=this.getA1Col(d[1]);b.ctatdebug("Manufacturing json from: ["+
...
new CTATLogMessageBuilder;a=new CTATCommLibrary;a.setConnectionRefusedMessage("ERROR_CONN_TS");a.setSocketType(f.tutoring_service_communication+(f.collaborators?" websocket":""));a.assignHandler(this);b=new CTATCurriculumService(a);null==commLoggingLibrary&&(commLoggingLibrary=new CTATLoggingLibrary(!0));commLoggingLibrary.getLoggingCommLibrary().setFixedURL(flashVars.getRawFlashVars().log_service_url);flashVars.setTimeZone(null);new CTATHTMLManager;this.ctatdebug("CTATCommShell.init() FlashVar info: "+
f.info);if(null!=f.info)try{parent.javaScriptInfo&&parent.javaScriptInfo(decodeURIComponent(f.info))}catch(A){}else this.ctatdebug("There is no info flash var");console.log("Connecting to: "+l+f.remoteSocketURL+":"+f.remoteSocketPort);c=e.createSetPreferencesMessage(version);a.sendXMLURL(c,l+f.remoteSocketURL+":"+f.remoteSocketPort,!0);(l=CTATConfiguration.get("collaborators"))&&1<l.length&&(CTATScrim.scrim.scrimDown(),CTATScrim.scrim.scrimUp(CTATGlobals.languageManager.getString("AWAITING_OTHER_COLLABORATORS")));
d.addGlobalEventListener(CTATTransactionListener.create(f[CTATTransactionListener.scriptParam]))};this.forwardToTutor=function(b){a&&a.hasJavaScriptConnection()&&CTAT.ToolTutor.sendToTutor(b.getXMLString())};this.getLoggingLibrary=function(){return commLoggingLibrary};this.propagateShellEvent=function(a,b,c){ctatdebug("propagateShellEvent ("+a+", "+typeof b+")");for(var d=0;d<w.length;d++)w[d].processCommShellEvent(a,b,c)};this.reset=function(){d.ctatdebug("reset ()");CTATGlobals.interfaceElement=
null;commMessageHandler.reset()};this.getMessageHandler=function(){return this.commMessageHandler};this.addStartStateHandler=function(a){d.ctatdebug("addStartStateHandler ()");null==CTATMessageHandler.startStateHandlers&&(CTATMessageHandler.startStateHandlers=[]);CTATMessageHandler.startStateHandlers.push(a)};this.gradeComponent=function(a){this.ctatdebug("gradeComponent ("+a.getName()+","+a.getClassName()+")");var b=CTATShellTools.findComponentByClass("CTATDoneButton");null!=b&&b!=a?b.moveHintHighlight(!1,
null):d.ctatdebug("Info: no done button available to reset");d.clearFeedbackComponents();null!=nameTranslator?nameTranslator.translateFromCTAT(a.getName()):this.ctatdebug("Info: no name translator provided, using as-is");null==a?this.ctatdebug("Internal error, provided component is null"):(this.ctatdebug("Info: we have a valid component, grading ..."),"Do not tutor"==a.getTutorComponent()?d.processComponentAction(a.getSAI(),!1):(this.ctatdebug("Checking for back grading: "+a.getName()),"CTATTextArea"==
a.getClassName()||"CTATTextInput"==a.getClassName()||"CTATTextField"==a.getClassName()?(this.ctatdebug("Backgrading ..."),this.ctatdebug("Grading "+a.getClassName()+" with value: "+a.getValue()),!0===CTATGlobalFunctions.isBlank(a.getValue())?this.ctatdebug("Empty component, nothing to grade"):(a.updateSAI(),a=a.getSAI(),d.processComponentAction(a))):(a="CTATTableGoogle"==a.getClassName()?new CTATSAI(a.getCurrentSelection(),"UpdateTextArea",a.getCurrentValue()):a.getSAI(),d.processComponentAction(a))))};
this.processMessage=function(a){this.ctatdebug("processMessage ()");commMessageHandler.processMessage(a);this.ctatdebug("processMessage () done")};this.processStartProblem=function(){this.ctatdebug("processStartProblem ()");"google"==CTATConfig.external&&this.showFeedback("The tutor is starting, please wait ...");CTATLMS.initLMSConnection&&CTATLMS.initLMSConnection()};this.processStartState=function(){this.ctatdebug("processStartState ()");CTATMessageHandler.inStartState=!0;null!=g?(this.ctatdebug("Calling tutor.createInterface () ..."),
g.createInterface()):(this.ctatdebug("Error: no tutor object available, calling createInterface globally ..."),window.hasOwnProperty("createInterface")&&window.createInterface());this.ctatdebug("Logging start of problem ...");null!=commLoggingLibrary?commLoggingLibrary.startProblem():this.ctatdebug("Info: no logging library available!");d.propagateShellEvent("StartProblem",null);this.ctatdebug("End of start state, inspecting suppressStudentFeedback ...");if(!0===CTATGlobals.suppressStudentFeedback){this.ctatdebug("Hiding hint button ...");
var a=CTATShellTools.findComponentByClass("CTATHintButton");null!=a&&a.SetVisible(!1)}"google"==CTATConfig.external?(d.ctatdebug("Calling google app script hint request driver ..."),addCall(new RPCObject("resetOnEditQueue","dummy","dummy"))):this.ctatdebug("processStartState () done")};this.sendStartProblemMessage=function(){d.ctatdebug("sendStartProblemMessage()")};this.sendProblemSummaryRequest=function(b){d.ctatdebug("sendProblemSummaryRequest()");q=b;b=(new CTATTutoringServiceMessageBuilder).createProblemSummaryRequestMessage();
a.sendXML(b)};this.getAllInterfaceDescriptions=function(){d.ctatdebug("getAllInterfaceDescriptions ()");d.sendInterfaceDescriptionMessages()};this.sendInterfaceDescriptionMessages=function(){d.ctatdebug("sendInterfaceDescriptionMessages ()");for(var b=CTATShellTools.getAllComponents(),c='<?xml version="1.0" encoding="UTF-8"?><message><verb>NotePropertySet</verb><properties><MessageType>MessageBundle</MessageType><messages>',f=new CTATTutoringServiceMessageBuilder,e=0;e<b.length;e++){var g=b[e];d.ctatdebug("Getting component interface description message for: "+
g.getName());c+=f.createInterfaceDescriptionMessage(g);g.getConfigurationActions&&g.getConfigurationActions().forEach(function(a){c+=f.createInterfaceActionMessage(CTATGuid.guid(),a)})}c+="</messages></properties></message>";d.ctatdebug("Final bundle: "+c);a.sendXMLNoBundle(c)};this.processSerialization=function(){d.ctatdebug("processSerialization()");d.setText(this.label)};this.processComponentAction=function(b,c,f,e,g,l){d.ctatdebug("processComponentAction("+b.getName()+" -> "+b.getSelection()+
","+b.getAction()+","+b.getInput()+")");this.showFeedback("");f=CTATGuid.guid();null!=commLoggingLibrary?r&&(d.ctatdebug("We're not in the start state, logging the action ..."),"scrim"==b.getSelection()?ctatdebug("Not logging any scrim actions (for now)"):void 0!=g?commLoggingLibrary.logSemanticEvent(f,b,g,"","","",l):"hint"==b.getSelection()||"null.nextButton"==b.getSelection()||"null.previousButton"==b.getSelection()?commLoggingLibrary.logSemanticEvent(f,b,"HINT_REQUEST","","","",l):commLoggingLibrary.logSemanticEvent(f,
b,"ATTEMPT","","","",l)):this.ctatdebug("Info: no logging library available!");g=new CTATTutoringServiceMessageBuilder;!1!==c&&c!==CTAT.Component.Base.Tutorable.Options.TutorComponent.DO_NOT_TUTOR?(b=g.createInterfaceActionMessage(f,b),d.propagateShellEvent("InterfaceAction",b)):(b=g.createUntutoredActionMessage(f,b),d.propagateShellEvent("UntutoredAction",b));a.sendXML(b)};this.onEditSuccess=function(a){d.ctatdebug("onEditSuccess ("+a+")");null==nameTranslator?d.ctatdebug("Error: CTAT name translator not available"):
-1!=a.indexOf(":")?(d.ctatdebug("Bump"),d.showFeedback("You're asking for a hint for multiple cells, please select only a single cell.")):(a=nameTranslator.translateToCTAT(a),d.ctatdebug("Info A1 notiation mapped to (if needed): "+a),a=new CTATSAI("hint","ButtonPressed",a),d.processComponentAction(a),d.propagateShellEvent("REQUESTHINT",null),d.ctatdebug("onEditSuccess () done"))};this.onFailure=function(a){d.ctatdebug("onFailure ("+a.message+")")};this.onNOPEditSuccess=function(a){d.ctatdebug("onNOPEditSuccess ("+
a+")")};this.onNOPFailure=function(a){d.ctatdebug("onNOPFailure ("+a.message+")")};this.requestHint=function(){d.ctatdebug("requestHint(external -> "+CTATConfig.external+")");var a;if("none"==CTATConfig.external)d.ctatdebug("Calling built-in hint request driver ..."),CTATGlobals.Tab.previousFocus?(a=new CTATSAI("hint","ButtonPressed","hint request"),CTATGlobals.Tab.previousFocus.getSAI?(a.addSelection(CTATGlobals.Tab.previousFocus.getSAI().getSelection()),a.addAction("PreviousFocus")):d.ctatdebug("Current focus is not a CTAT component, can't ask for a hint yet")):
(d.ctatdebug("CTATGlobals.Tab.previousFocus===null"),a=new CTATSAI("hint","ButtonPressed","hint request")),this.processComponentAction(a),this.propagateShellEvent("RequestHint",null);else if(d.clearFeedbackComponents(),"google"==CTATConfig.external){d.ctatdebug("Calling google app script hint request driver ...");try{google.script.run.withSuccessHandler(d.onEditSuccess).withFailureHandler(d.onFailure).getSheetSelectedRange()}catch(n){d.ctatdebug("google.script.run: "+n.message)}}else d.ctatdebug("'external' has configuration that doesn't match anything: "+
CTATConfig.external)};this.processDone=function(){d.ctatdebug("processDone()");if(!0===CTATGlobals.confirmDone)CTATScrim.scrim.confirmScrimUp("Are you sure you are done?",this.processDoneContinue,this.processDoneCancel);else{var a=new CTATSAI("done","ButtonPressed","-1");d.processComponentAction(a)}};this.processDoneContinue=function(a){d.ctatdebug("processDoneContinue()");CTATScrim.scrim.scrimDown();a=new CTATSAI("done","ButtonPressed","-1");d.processComponentAction(a);d.propagateShellEvent("DonePressed",
null)};this.processDoneCancel=function(a){d.ctatdebug("processDoneCancel()");CTATScrim.scrim.scrimDown();a=CTATGuid.guid();var b=new CTATSAI("ConfirmDone","ButtonPressed","no");commLoggingLibrary.logSemanticEvent(a,b,"ATTEMPT","")};this.processGetURL=function(b){d.ctatdebug("processGetURL()");-1!=b.getURL().indexOf("http://")?a.retrieveFile(b.getURL().substring(7),d.processClientBRDLoad):a.retrieveFile(b.getURL(),d.processClientBRDLoad)};this.processClientBRDLoad=function(b){d.ctatdebug("processClientBRDLoad()");
var c=a.getURL();a.sendXML("<message><verb>NotePropertySet</verb><properties><MessageType>GetURLResponse</MessageType><URL><![CDATA[ "+c+" ]]\x3e</URL><content><![CDATA[ "+window.btoa(b)+" ]]\x3e</content></properties></message>")};this.processCorrectAction=function(a){d.ctatdebug("processCorrectAction()");a.setGradeResult("correct");d.clearFeedbackComponents();null!=p&&(ctatdebug("Calling custom grading processor ..."),p("CORRECT",a));var b=a.getSelection();if(h[b]&&null!=m)m("CORRECT",a),this.propagateShellEvent("CORRECT",
...
a));var b=a.getSelection();if(h[b]&&null!=m)m("INCORRECT",a);else{var c=CTATShellTools.findComponent(b);if(null!==c)for(b=0;b<c.length;b++)ctatdebug("Calling setIncorrect on component ("+c[b].getClassName()+")..."),c[b].setIncorrect&&c[b].setIncorrect(a);else d.ctatdebug("Error: component is null for selection "+b)}};this.processHighlightMsg=function(a){d.ctatdebug("processHighlightMsg()");var b=a.getSelection(),c=CTATShellTools.findComponent(b);if(null!=c)for(b=0;b<c.length;b++)c[b].setHintHighlight(!0,
a);else d.ctatdebug("Error: component is null for selection "+b);this.showFeedback(a.getHighlightMsg())};this.processUnHighlightMsg=function(a){d.ctatdebug("processUnHighlightMsg()");var b=a.getSelection(),c=CTATShellTools.findComponent(b);if(null!=c)for(b=0;b<c.length;b++)c[b].setHintHighlight(!1,null,a);else d.ctatdebug("Error: component is null for selection "+b)};this.processAssociatedRules=function(b,c,f){d.ctatdebug("processAssociatedRules()");if(0==commMessageHandler.getInStartState()){logHintSAI=
b.getSAI();var g=new CTATActionEvaluationData("");d.ctatdebug("Found tutor advice: "+f);"Hint"==c||"HintWindow"==c?(ctatdebug("Preparing log message to indicate a hint response","commShell"),g.setCurrentHintNumber(hintIndex+1),g.setTotalHintsAvailable(hints.length),g.setEvaluation("HINT"),c="HINT_MSG",hints[hintIndex]&&(f=hints[hintIndex])):("Correct"==b.getIndicator()?g.setEvaluation("CORRECT"):g.setEvaluation("INCORRECT"),c="RESULT");ctatdebug("Adding custom field names ...");var l=[],h=[];l.push("step_id");
h.push(b.getProperty("StepID"));var m=b.getCustomFields(),n;for(n in m)l.push(n),h.push(m[n]);n=b.getSkillsObject();d.updateSkillWindow(n);ctatdebug("Sending log message ...");null!=commLoggingLibrary?r&&commLoggingLibrary.logTutorResponse(b.getTransactionID(),logHintSAI,c,"",g,f,n,l,h):this.ctatdebug("Info: no logging library available!");"done"==logHintSAI.getSelection()&&"ButtonPressed"==logHintSAI.getAction()&&"Correct"==b.getIndicator()&&(b=e.createProblemSummaryRequestMessage(),a.sendXML(b))}else d.updateSkillWindow(null);
d.ctatdebug("processAssociatedRules() done")};this.processBuggyMessage=function(a){d.ctatdebug("processBuggyMessage()");this.showFeedback(a.getBuggyMsg())};this.processSuccessMessage=function(a){d.ctatdebug("processSuccessMessage()");this.showFeedback(a.getSuccessMessage())};this.processUntutoredAction=function(a,b){d.processInterfaceAction(a,b)};this.processInterfaceAction=function(a,b){d.ctatdebug('CTATCommShell.processInterfaceAction ("'+a.getMessageType()+'")');var c=a.getProperty("trigger"),
c=a.getProperty("subtype")||(c&&"data"==c.toLowerCase()?"tutor-performed":"");null!=commLoggingLibrary?r&&commLoggingLibrary.logSemanticEvent(a.getTransactionID(),a.getSAI(),"ATTEMPT",c):this.ctatdebug("Info: no logging library available!");if("root"==a.getSelection()||"_root"==a.getSelection()){d.ctatdebug("Info: selection is 'root', we'll call the function straight up ...");var c=a.getAction(),f=a.getInput();d.ctatdebug("Calling as: "+c+"("+f+")");try{window[c](f)}catch(D){d.ctatdebug("Internal error: unable to execute function: "+
D.message)}}else if(c=CTATShellTools.findComponent(a.getSelection()),null===c)d.ctatdebug("Internal error: unable to find pointer to component object");else if(0==c.length)d.ctatdebug("Error: no component found to call interface action on");else{f=c.length;d.ctatdebug("Call the action on the component(s) -> ("+f+")...");for(var e=0;e<f;e++){d.ctatdebug("About to call "+a.getAction()+" ("+a.getInput()+") on: "+a.getSelection());var g=c[e];g.executeSAI(a);d.ctatdebug("Method executed, continuing with post-processing ...");
if(1==commMessageHandler.getInStartState()){var l=a.getAction();l&&l.toLowerCase().startsWith("updatetext")&&g.setEnabled(!b)}}d.ctatdebug("processInterfaceAction() Done")}};this.processInterfaceIdentification=function(a){d.ctatdebug("processInterfaceIdentification()")};this.processAuthorModeChange=function(a){d.ctatdebug("processAuthorModeChange()")};this.processShowHintsMessage=function(a){d.ctatdebug("processShowHintsMessage()")};this.processConfirmDone=function(a){d.ctatdebug("processConfirmDone()")};
this.processVersionInfo=function(a){d.ctatdebug("processVersionInfo()")};this.processTutoringServiceAlert=function(a){d.ctatdebug("processTutoringServiceAlert()");for(var b="",c=0;c<a.length;c++){var e=a[c];"ErrorType"==f.getElementName(e)&&f.getNodeTextValue(e);"Details"==f.getElementName(e)&&(b=f.getNodeTextValue(e))}CTATScrim.scrim.scrimUp(b)};this.processTutoringServiceError=function(a){d.ctatdebug("processTutoringServiceError()");for(var b="",c="",e=0;e<a.length;e++){var g=a[e];"ErrorType"==
f.getElementName(g)&&(b=f.getNodeTextValue(g));"Details"==f.getElementName(g)&&(c=f.getNodeTextValue(g))}CTATScrim.scrim.scrimDown();CTATScrim.scrim.errorScrimUp(b+" - "+c)};this.processProblemSummaryResponse=function(a){d.ctatdebug("processProblemSummaryResponse()");CTATLMS.processProblemSummary&&CTATLMS.processProblemSummary(a.getXMLObject());CTATLMS.closeLMSConnection&&CTATLMS.closeLMSConnection();if(null!=q){var f=a.getXMLObject(),e=f.getElementsByTagName("ProblemSummary"),g=f.getElementsByTagName("cmi.core.lesson_status"),
l=f.getElementsByTagName("cmi.core.score.raw");a=f.getElementsByTagName("cmi.core.exit");f=f.getElementsByTagName("cmi.core.session_time");e=$("<div>").html(e[0].innerHTML).text();g="<cmi.core.lesson_status>"+$("<div>").html(g[0].innerHTML).text()+"</cmi.core.lesson_status>";l="<cmi.core.score.raw>"+$("<div>").html(l[0].innerHTML).text()+"</cmi.core.score.raw>";a="<cmi.core.exit>"+$("<div>").html(a[0].innerHTML).text()+"</cmi.core.exit>";f="<cmi.core.session_time>"+$("<div>").html(f[0].innerHTML).text()+
"</cmi.core.session_time>";q(e,"<scorm>"+g+l+a+f+"</scorm>");q=null}else f=new CTATXML,null!=c?c(f.xmlToString(a.getXMLObject())):b.sendSummary(a)};this.setGotProblemRestoreEnd=function(a){r=a};this.processProblemRestoreEnd=function(a){d.ctatdebug("processProblemRestoreEnd() scrimIsUp "+scrimIsUp);r=!0;CTATScrim.scrim.scrimDown()};this.clearFeedbackComponents=function(){d.ctatdebug("clearFeedbackComponents ()");CTATShellTools.showHints(null)};this.processHintResponse=function(a,b){d.ctatdebug("processHintResponse()");
unhighlightall();CTATShellTools.showHints(b);var c=a.getSAI();if(null!=c)if(c=c.getSelection(),null!=c)if(d.ctatdebug("Highlighting selection for hint: "+c),c=CTATShellTools.findComponent(c),null!=c)for(var f=0;f<c.length;f++)1==CTATCommShell.detailedFeedback&&c[f].setHintHighlight(!0,a);else d.ctatdebug("Unable to find component name in list: "+c);else d.ctatdebug("Error: no highlight selection present in SAI");else d.ctatdebug("Warning: no SAI found in highlight message");CTATCommShell.detailedFeedback=
!0;d.ctatdebug("processHintResponse() done")};this.showHighlightSelection=function(a,b){d.ctatdebug("showHighlightSelection ("+a+")");var c=CTATShellTools.findComponent(a);if(null!=c)for(var f=0;f<c.length;f++)1==CTATCommShell.detailedFeedback&&(0===f?c[f].moveHintHightlight&&c[f].moveHintHighlight(!0,b):c[f].setHintHighlight&&c[f].setHintHighlight(!0,b));else d.ctatdebug("Unable to find component name in list: "+c)};this.globalReset=function(){d.ctatdebug("globalReset ()");CTATMessageHandler.scriptElement=
""};this.nextProblem=function(b){d.ctatdebug("nextProblem ()");if(CTATGlobalFunctions.isBlank(b))d.ctatdebug("Message is blank, requesting next problem ..."),b=flashVars.getRawFlashVars().run_problem_url,a.send(b);else{d.ctatdebug("Message contains html data, writing ...");try{document.close()}catch(n){alert("Error closing document: "+n.message)}try{document.write(b)}catch(n){alert("Error writing document: "+n.message)}}};this.updateSkillWindow=function(a){d.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();
var b=CTATShellTools.findComponentByClass("CTATSkillWindow");null!==b?null!=a?b.updateSkillSet(a):b.drawComponent():d.ctatdebug("Info: no skill window available")};this.processComponentFocus=function(a){d.ctatdebug("processComponentFocus("+a.getName()+","+a.getClassName()+")");"CTATTextInput"==a.getClassName()||"CTATTextField"==a.getClassName()||"CTATTextArea"==a.getClassName()?(CTATGlobals.selectedTextInput=a,null!==mobileAPI&&!0===mobileAPI.getEnabled()&&mobileAPI.processTextFocus(a.getX(),a.getY(),
a.getWidth(),a.getHeight())):CTATGlobals.selectedTextInput=null;d.ctatdebug("processComponentFocus() done")};this.showFeedback=function(a){null!=a&&void 0!=a&&/\S/.test(a)&&" "!=a?(d.ctatdebug("showFeedback("+a+") -> l: "+a.length),CTATShellTools.showFeedback(a),null!=l&&l(a)):d.ctatdebug("showFeedback(): False alarm: empty message. This can happen when the commshell is trying to clear the hint window and there is no hint window.")};this.assignFeedbackHandler=function(a){d.ctatdebug("assignFeedbackHandler()");
l=a};this.gradeSAI=function(a,b,c){d.ctatdebug("gradeSAI()");h[a]=c;a=new CTATSAI(a,b,c);d.processComponentAction(a,!0,!0)};this.assignGradingHandler=function(a){d.ctatdebug("assignGradingHandler()");m=a};this.assignAnonymousGradingProcessor=function(a){p=a};this.assignDoneProcessor=function(a){c=a};this.addEventListener=function(a,b){};this.addGlobalEventListener=function(a){d.ctatdebug("addGlobalEventListener( "+a+")");a&&w.push(a)};this.closeWSConnection=function(b,c,d){(b=a.findWSConnection(b))?
b.close(d,c):console.warn("connection not found")}};CTATCommShell.prototype=Object.create(CTATBase.prototype);CTATCommShell.prototype.constructor=CTATCommShell;CTATCommShell.commShell=null;CTATCommShell.detailedFeedback=!0;function enableDetailedFeedback(a){CTATCommShell.detailedFeedback=a};var CTATComponentReference=function(a,b){var e=a,g=b;this.setElement=function(a){e=a};this.getElement=function(){return e};this.setDiv=function(a){g=a};this.getDiv=function(){return g}};CTATComponentReference.components={};CTATComponentReference.list=function(){for(var a in CTATComponentReference.components){var b=CTATComponentReference.components[a];ctatdebug("Component: "+b.getElement().getName()+", with div: "+b.getDiv().id)}};
CTATComponentReference.getComponentFromID=function(a){var b=CTATComponentReference.components;return b.hasOwnProperty(a)?(a=b[a],a.getElement()?a.getElement():null):null};CTATComponentReference.add=function(a,b){var e=new CTATComponentReference(a,b);return CTATComponentReference.components[e.getDiv().getAttribute("id")]=e};var CTATCompBase=function(a,b,e,g,d,c){CTATBase.call(this,a,b);var f=e||0,h=g||0,m=d||-2,l=c||-2,q=50,p=25,w=!1,r=!1,u="",n=!1,B=!0,v=null,A="",y=null;this.isTabIndexable=!0;var F=0,D=null,x=this,C=null,E="hidden",t=CTATGlobalFunctions.gensym.z_index(),G=CTATGlobalFunctions.gensym.div_id(),z=CTATGlobalFunctions.gensym.z_index(),J=CTATGlobalFunctions.gensym.div_id();this.setIsAbstractComponent=function(a){w=a};this.isAbstractComponent=function(){return w};this.setIsFeedbackComponent=function(a){r=
a};this.isFeedbackComponent=function(){return r};this.setTabIndex=function(a){!0===this.isTabIndexable?(y=a,0>y?(y=CTATGlobals.Tab.Tracker,CTATGlobals.Tab.Tracker++):CTATGlobals.Tab.Tracker=y):y=-1};this.getTabIndex=function(){return y||this.getComponent().getAttribute("tabindex")};this.setZIndex=function(a){x.ctatdebug("Setting z index to: "+a);F=a;null!==v&&(v.style.zIndex=a)};this.getZIndex=function(){return F};this.setDefaultWidth=function(a){q=a};this.getDefaultWidth=function(){return q};this.setDefaultHeight=
function(a){p=a};this.getDefaultHeight=function(){return p};this.processCommShellEvent=function(a,b){x.ctatdebug("processCommShellEvent ("+a+")")};this.makeDivWrapper=function(a){v=document.createElement("div");v.id=this.getName();v.setAttribute("onkeypress","return noenter(event)");v.setAttribute("data-ctat-component",this.getClassName());v.style.position="absolute";v.style.left=f+"px";v.style.top=h+"px";v.style.zIndex=t;v.style.width=x.getWidth()+"px";v.style.height=x.getHeight()+"px";$(v).data("CTATComponent",
this);a.appendChild(v)};this.setDivWrapper=function(a){v=a;v.setAttribute("data-ctat-component",this.getClassName())};var H=this.setClassName;this.setClassName=function(a){H(a);v&&v.setAttribute("data-ctat-component",this.getClassName())};this.wrapComponent=function(a){x.ctatdebug("wrapComponent ()");x.makeDivWrapper(a);x.ctatdebug("wrapComponent () done")};this.createCanvas=function(){x.ctatdebug("createCanvas ()");C=document.createElement("canvas");C.setAttribute("id",J);C.setAttribute("onkeypress",
"return noenter(event)");C.setAttribute("width",m+canvasCalibrate+"px");C.setAttribute("height",l+canvasCalibrate+"px");C.setAttribute("style","border: 1px "+this.borderColor+" solid; "+("hidden"==E?"visibility: hidden; ":"")+"z-index:"+z+";");v.firstChild?v.insertBefore(C,v.firstChild):v.appendChild(C);return C};this.redraw=function(){var a=v.style.display;v.style.display="none";v.style.display=a};this.setCanvasVisibility=function(a){E=a};this.getSubCanvasCtx=function(){if(C)return C.getContext("2d")};
this.getSubCanvas=function(){return C};this.getX=function(){return f};this.getY=function(){return h};this.getWidth=function(){if(0>=m){var a;D?a=window.getComputedStyle(D):v&&(a=window.getComputedStyle(v));if(a)return parseFloat(a.width)}return m};this.getHeight=function(){if(0>=l&&v){var a=window.getComputedStyle(v);return parseFloat(a.getPropertyValue("height"))}return l};this.getText=function(){return u};this.getEnabled=function(){return B};this.assignEnabled=function(a){B=a;v.setAttribute("data-ctat-enabled",
B)};this.setEnabled=function(a){x.ctatdebug("setEnabled ("+a+")");x.assignEnabled(a);D?D.disabled=!B:x.ctatdebug("Error: component pointer is null")};this.lock=this.setEnabled.bind(x,!1);this.unlock=this.setEnabled.bind(x,!0);this.getDivWrap=function(){return v};this.getComponent=function(){return D};this.component=null;Object.defineProperty(this,"component",{get:function(){return D}});this.getCanvasZIndex=function(){return z};this.getComponentGroup=function(){return A};this.setComponent=function(a){D=
a;this.setEnabled(this.getEnabled())};this.getTopDivZIndex=function(){return t};this.getTopDivID=function(){return G};this.setComponentGroup=function(a){A=a;D&&(D.name=a)};this.assignText=function(a){u=a};this.init=function(){x.ctatdebug("THIS IS THE BASE INIT METHOD")};this.initialize=function(){x.ctatdebug("initialize ()");x.configFromDescription();x.init();x.processSerialization();x.render();x.processTabOrder();x.ctatdebug("initialize () done")};this.getInitialized=function(){return n};this.setInitialized=
function(a){x.ctatdebug("setInitialized ("+a+")");n=a;!0!==n||v?x.ctatdebug("Not wrapping, initialized="+n+", divWrapper = "+v):(x.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."),(a=findPointOfAttachment(this.getName()))?(x.ctatdebug("Attaching component to existing MovieClip ..."),x.wrapComponent(a.getDivWrapper())):(x.ctatdebug("Attaching component to main div ..."),0<$("#"+ctatcontainer).length&&x.wrapComponent(getSafeElementById(ctatcontainer))));
x.getDivWrap().classList.add("CTATComponent");x.ctatdebug("setInitialized () done")};this.addSafeEventListener=function(a,b,c){x.ctatdebug("addSafeEventListener ("+a+")");x.ctatdebug("Adding event listener to: "+c);c?c.addEventListener(a,b):(D?(x.ctatdebug("Adding eventlistener to component instead of target"),D.addEventListener(a,b)):x.ctatdebug("Error: pointer to component is null, can't add event listener"),x.ctatdebug("addSafeEventListener () done"))};this.drawComponent=function(){};this.addComponentReference=
...
h=Number(c[1])}else h=0;f=isNaN(f)?0:f;h=isNaN(h)?0:h;v&&(v.style.left=f+"px",v.style.top=h+"px")};this.setSize=function(a,b){var c=Number(a),d=Number(b);(void 0===b||null===b||isNaN(d))&&0<=a.indexOf(",")&&(d=a.split(","),c=Number(d[0]),d=Number(d[1]));x.ctatdebug("setSize ("+c+","+d+")");isNaN(c)||x.setWidth(c);isNaN(d)||x.setHeight(d)};this.SetVisible=this.setVisible=function(a){a=CTATGlobalFunctions.toBoolean(a);E=!0===a?"block":"hidden";C&&C.setAttribute("style","border: 0px; position: absolute; "+
(a?"":"visibility:hidden; ")+"; left:"+f+"px; top:"+h+"px; z-index:"+z+";");v.style.visibility=!0===a?"unset":"hidden"};this.FadeIn=function(a){x.SetVisible(!0)};this.FadeOut=function(a){x.SetVisible(!1)};this.reset=function(){};this.setX=function(a){this.x=a;v.style.left=this.x+"px";!0===n&&this.render()};this.setY=function(a){this.y=a;v.style.top=this.y+"px";!0===n&&this.render()};this.setWidth=function(a){x.ctatdebug("setWidth ("+a+")");m=a;v?v.style.width=m+"px":x.ctatdebug("Internal error: no div wrapper available to set width")};
this.setHeight=function(a){x.ctatdebug("setHeight ("+a+")");l=a;v?v.style.height=l+"px":x.ctatdebug("Internal error: no div wrapper available to set height")};this.setText=function(a){u=a;return this};this.getValue=function(){return D?D.value:""};this.backgrade=!1;this.unHighlightAll=function(){$(".CTAT--hint").each(function(){for(var a=$(this),b=null;0<a.length&&null===b;)a.data("CTATComponent")?b=a.data("CTATComponent"):a=a.parent();b&&b.setHintHighlight&&b.setHintHighlight(!1,null)})};this.processOnFocus=
...
!1===CTATGlobals.suppressStudentFeedback&&l&&this.showCorrect(a);this.ctatdebug("setCorrect() post showCorrect");this.component&&(a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.correct,{detail:{sai:a,component:this},bubbles:!0,cancelable:!0}),this.getDivWrap().dispatchEvent(a))};this.setIncorrect=function(a){this.ctatdebug("setIncorrect()");this.setNotGraded();"CTATTableGoogle"!=this.getClassName()&&this.executeSAI(a);u=CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;!1===CTATGlobals.suppressStudentFeedback&&
...
{detail:{isHighlighted:c,component:this},bubbles:!0,cancelable:!0});this.getDivWrap().dispatchEvent(d)}c!==w&&(w=c,this.showHintHighlight(c,b))}};this.moveHintHighlight=function(a,b){this.ctatdebug("moveHintHighlight ("+a+")");CTATGlobals.Tab.previousFocus=CTATGlobals.Tab.Focus;CTATGlobals.Tab.Focus=p;p.component.focus?CTATGlobals.Tab.Focus.getComponent().focus():CTATGlobals.Tab.Focus.getDivWrap().focus();if(r){var c=CTATGlobalFunctions.toBoolean(a);if(this.component){var d=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight,
...
!1,!0):CTATCommShell.commShell.processComponentAction(this.getSAI(),h,m));this.ctatdebug("processAction() finished call to commShell.processComponentAction");this.component&&(c=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.action,{detail:{sai:this.getSAI(),component:this},bubbles:!0,cancelable:!0}),this.component.dispatchEvent(c))};this.addEventScreen=function(a){var b=document.createElement("div");b.style.position="absolute";b.style.top="0";b.style.left="0";b.style.bottom="0";b.style.right=
"0";a&&b.addEventListener("dblclick",function(){setTimeout(function(){var a=p.getDivWrap().getAttribute("data-ctat-enabled");p.setEnabled(!0);var b=p.getComponent();b.hasEditListeners||(b.addEventListener("blur",function(){p.setEnabled(!1);p.getDivWrap().setAttribute("data-ctat-enabled",a);p.getDivWrap().setAttribute("value",b.value)}),"CTATTextArea"===p.getClassName()&&b.addEventListener("keydown",function(a){13==(a.keyCode||a.charCode)&&(a.preventDefault(),this.value+="\n")}),b.hasEditListeners=
!0);b.focus()},410)});this.getDivWrap().appendChild(b)}};CTAT.Component.Base.Tutorable.Options={TutorComponent:{TUTOR:"Tutor",TUTOR_NO_FEEDBACK:"Tutor but no visual feedback",DO_NOT_TUTOR:"Do not tutor"},Status:{CORRECT:"CORRECT",INCORRECT:"INCORRECT",NOTGRADED:"NOTGRADED"}};CTAT.Component.Base.Tutorable.EventType={correct:"CTAT_CORRECT",incorrect:"CTAT_INCORRECT",highlight:"CTAT_HIGHLIGHT",ungrade:"CTAT_NOTGRADED",action:"CTAT_ACTION"};CTAT.Component.Base.Tutorable.prototype=Object.create(CTAT.Component.Base.SAIHandler.prototype);
...
""),b=b.replace(/[() ]/g,""));b=new CTAT.Math.Fraction(b);b.selected=c;0<b&&a.push(b);return b});return a};this.updateValue=function(){return h=this.getPieces().map(function(a){return A(a.getAttributeNS(null,"data-value"),CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected")))}).join("+")};var B=function(a,b){var c=CTATGlobalFunctions.toBoolean(b);CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected"));!0===c?(a.setAttributeNS(null,"data-selected",!0),$(a).css("fill",
...
"data-selected",c);a.setAttributeNS(null,"data-value",b.toString());a.dataValue=b;this.getEnabled()&&(a.style.cursor="pointer");a.addEventListener("click",this.clickHandler);r.push(a)};var v=this.setEnabled;this.setEnabled=function(a){v(a);r.forEach(function(b){b.style.cursor=a?"pointer":"default"})};this.clear=function(){r=[]};var A=function(a,b){var c=a.toString();!1===b&&(c="(0*"+c+")");return c};this.AddPiece=function(a,b){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var d=
h.split("+");d.push(A(c,b));u.setValue(d.join("+"))}}};this.AddToValue=function(a,b){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var d=h.split("+");d.push(A(c,b));h=d.join("+")}}return h};var y=-1,F=function(a){isNaN(a)&&this.get_denominator();a=Math.max(a,1);1<y&&(a=Math.min(a,y));return a}.bind(this);this.set_max_denominator=function(a){a=parseInt(a);isNaN(a)||(y=a)};this.set_denominator=function(a){u.setHintHighlight(!1);var b="string"===typeof a?parseInt(a):a;if(!isNaN(b)&&
(b=F(b),this.get_denominator()!=a)){var c=u.evaluate();u.clear();a=[];c.set_denominator(b);for(var d=new CTAT.Math.Fraction(1,b),f=Math.floor(c.numerator),e=b-f,g=0;g<f;g++)a.push(A(d,!0));b=new CTAT.Math.Fraction(c.numerator-f,b);b.equals(0)||(a.push(A(b,!0)),a.push(A(d.subtract(b),!1)),e--);for(b=0;b<e;b++)a.push(A(d,!1));this.setValue(a.join("+"));u.setActionInput("SetPieces",h);u.processAction();return h}};this.get_denominator=function(){return r.reduce(function(a,b,c,d){return Math.min(a,b.dataValue.denominator)},
Infinity)};this.change_denominator=function(a){return this.set_denominator(this.get_denominator()+Number(a))};this.set_number_pieces=function(a){u.setHintHighlight(!1);a="string"===typeof a?parseInt(a):a;if(!isNaN(a)){a=F(a);var b=u.numActive();u.clear();for(var c=[],d=new CTAT.Math.Fraction(1,a),f=0;f<a;f++)c.push(A(d,0<b)),b--;this.setValue(c.join("+"));u.setActionInput("SetPieces",h);u.processAction();return h}};this.change_number_pieces=function(a){this.set_number_pieces(r.length+a)};this.set_numerator=
function(a){return this.change_numerator(a-this.getSelectedPieces().length)};this.change_numerator=function(a){0!==a&&(0<a?r.every(function(b){!1===n(b)&&(B(b,!0),a--);return 0<a}):(r.reverse(),r.every(function(b){!0===n(b)&&(B(b,!1),a++);return 0>a}),r.reverse()))};this.SetPieces=function(a){u.setValue(a)};e=function(a){return(a=$(this.getDivWrap()).attr(a))?a.split(/\s*;\s*/).map(function(a){return a.trim()}):[]};a=e.bind(this,"data-ctat-ctrl-denominator");b=e.bind(this,"data-ctat-ctrl-partition");
e=e.bind(this,"data-ctat-ctrl-numerator");g=function(a,b){return 0<=a().indexOf(b)};var D=g.bind(null,a),x=g.bind(null,b),C=g.bind(null,e),E=function(a){var b=null;if(a instanceof CTAT.Component.Base.Tutorable)a!=this&&(b=a.getName());else if(a instanceof CTATSAI)a.getSelection()!=u.getName()&&(b=a.getSelection());else if(a instanceof String)a!=u.getName()&&(b=a);else if(a instanceof Element)a!=u.getComponent()&&(b=a.id);else return null;if(b){if(D(b))return t.bind(this,this.change_denominator,this.set_denominator);
if(C(b))return t.bind(this,this.change_numerator,this.set_numerator);if(x(b))return t.bind(this,this.change_number_pieces,this.set_number_pieces)}return null}.bind(this);a=CTAT.Component.Base.Tutorable.EventType;CTATConfiguration.get("previewMode")||document.addEventListener(a.action,function(a){var b=a.detail.sai;a=E(a.detail.component);b&&null!==a&&a(b)},!1);var t=function(a,b,c){var d=parseInt(c.getInput());if(!isNaN(d)){switch(c.getAction()){case "ButtonPressed":a.call(this,d);break;case "Update":case "UpdateTextField":case "UpdateTextArea":b.call(this,
...
CTATHintButton.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATHintButton.prototype.constructor=CTATHintButton;CTAT.ComponentRegistry.addComponentType("CTATHintButton",CTATHintButton);var CTATHintWindow=function(a,b,e,g,d){CTAT.Component.Base.Graphical.call(this,"CTATHintWindow","__undefined__",a,b,e,g,d);var c=this;c.isTabIndexable=!1;var f=CTATConfig.parserType_is_XML()?new CTATXML:new CTATJSON,h=new CTATTutorMessageBuilder,m=null,l=null,q=null,p=null,w=CTATGlobals.languageManager.getString("NEXT"),r=CTATGlobals.languageManager.getString("PREVIOUS"),u=null;this.data_ctat_handlers["next-content"]=function(a){u=a;q&&(q.innerHTML=a)};var n=null;this.data_ctat_handlers["previous-content"]=
function(a){n=a;l&&(l.innerHTML=a)};this.getCurrentHint=function(){return m.innerHTML};this.init=function(){c.ctatdebug("init ("+c.getName()+")");c.setInitialized(!0);c.setIsAbstractComponent(!0);p=this.getDivWrap();p.id||p.setAttribute("id",CTATGlobalFunctions.gensym.div_id());p.setAttribute("onkeypress","return noenter(event)");c.setComponent(p);c.addComponentReference(c,p);m=document.createElement("div");p.appendChild(m);m.classList.add("CTATHintWindow--hint-content");var a=document.createElement("div");
a.classList.add("CTATHintWindow--hint-button-area");p.appendChild(a);if(n)l=document.createElement("button"),l.classList.add("CTATHintWindow--previous"),l.innerHTML=n;else{l=document.createElement("button");l.classList.add("CTATHintWindow--previous");var b=document.createElement("span");b.classList.add("CTATHintWindow--button-icon");b.textContent="\u25c0";l.appendChild(b);r&&(b.style.cssFloat="left",l.appendChild(document.createTextNode(r)))}l.addEventListener("click",function(a){CTATShellTools.showPrevHint()},
!1);a.appendChild(l);u?(q=document.createElement("button"),q.classList.add("CTATHintWindow--next"),q.innerHTML=u):(q=document.createElement("button"),q.classList.add("CTATHintWindow--next"),b=document.createElement("span"),b.classList.add("CTATHintWindow--button-icon"),b.textContent="\u25b6",w&&(b.style.cssFloat="right",q.appendChild(document.createTextNode(w))),q.appendChild(b));q.addEventListener("click",function(a){CTATShellTools.showNextHint()},!1);a.appendChild(q);var d=function(a){this.disabled=
...
var q=1;Object.defineProperty(this,"Max_Points",{get:function(){return q},set:function(a){a=parseInt(a);isNaN(a)||(q=a)}});this.setMaxPoints=function(a){this.Max_Points=a};this.setParameterHandler("Max_Points",this.setMaxPoints);this.data_ctat_handlers["max-points"]=this.setMaxPoints;var p=7;this.setPointSize=function(a){p=Number(a);n&&(n.setAttributeNS(null,"r",p),$(this._point_group).find("circle").each(function(){$(this).attr("r",p)}))};this.setStyleHandler("PointSize",this.setPointSize);this.data_ctat_handlers["point-size"]=
...
[];b=document.createDocumentFragment();b.appendChild(h.generate());b.appendChild(m.generate());b.appendChild(l.generate());this._tick_mark_group.innerHTML="";this._tick_mark_group.appendChild(b);b=this._point_group.children;for(c=0;c<b.length;c++)a=b[c],d=this.X_Axis.getPosition(a.value),e=new DOMPoint(a.cx.baseVal.value,a.cy.baseVal.value),1<d.distance(e)&&(a.cx.baseVal.value=d.x,a.cy.baseVal.value=d.y)}}.bind(this),u=0,n=null,B=new DOMPoint(-30,-30),v=!1,A=function(a){B.x=a.clientX;B.y=a.clientY},
y=function(a){cancelAnimationFrame(u);n.style.visibility="hidden";v=!1},F=function(a){if(!0===this.getEnabled()&&0<q){this.setHintHighlight(!1);var b;w?(a=E(a.clientX,a.clientY),b=a.location,a=a.data):(a=x(a.clientX,a.clientY),b=this.X_Axis.getProjectedPoint(a),a=this.X_Axis.getAxisValue(a));var c=document.createElementNS(f,"circle");c.classList.add("CTATNumberLine--point");c.setAttributeNS(null,"cx",b.x);c.setAttributeNS(null,"cy",b.y);c.setAttributeNS(null,"r",p);c.value=a;if(this._point_group.children.length>=
...
this._axis_line_group=document.createElementNS(f,"g");this._axis_line_group.classList.add("CTATNumberLine--axis");this._tick_mark_group=document.createElementNS(f,"g");this._tick_mark_group.classList.add("CTATNumberLine--tickmark");this._point_group=document.createElementNS(f,"g");n=document.createElementNS(f,"circle");n.setAttributeNS(null,"r",p);n.classList.add("CTATNumberLine--cursor");n.setAttributeNS(null,"transform","translate(-30,-30)");this.component.appendChild(this._axis_line_group);this.component.appendChild(this._tick_mark_group);
this.component.appendChild(this._point_group);this.component.appendChild(n);this.X_Axis.svg_group=this._axis_line_group;r();this.addComponentReference(this,this.getDivWrap());this.component.addEventListener("mousemove",A);this.component.addEventListener("mouseleave",y);var a=this.getEnabled;this.component.addEventListener("mouseenter",function(){!0===a()&&0<q&&(v=!0,n.style.visibility=null,u=requestAnimationFrame(t))});this.component.addEventListener("click",F);this.component.addEventListener("focus",
...
b.setInput(c.attr("data-ctat-denominator")),a.push(b));return a};var D=-1<navigator.userAgent.toLowerCase().indexOf("firefox"),x=function(a,b){this.svgPoint=this.svgPoint?this.svgPoint:this.component.createSVGPoint();this.svgPoint.x=a;this.svgPoint.y=b;var c=this._axis_line_group.getScreenCTM().inverse();this.svgPoint=this.svgPoint.matrixTransform(c);c=new DOMPoint(this.svgPoint.x,this.svgPoint.y);if(D){var d=$(this.component),f=parseInt(d.css("borderLeftWidth"))+parseInt(d.css("paddingLeft"))+parseInt(d.css("marginLeft")),
d=parseInt(d.css("borderTopWidth"))+parseInt(d.css("paddingTop"))+parseInt(d.css("marginTop"));c.x-=f;c.y-=d}return c}.bind(this),C=function(a,b){return this.getProjectedPoint(x(a,b))}.bind(this.X_Axis),E=function(a,b){for(var c=C(a,b),d=null,f=Number.POSITIVE_INFINITY,e,g,l=0;l<this._tickmarks.length;l++)e=this._tickmarks[l],g=c.distance(e.location),g<f&&(d=e,f=g);return d}.bind(this),t=function(){if(v&&!0===this.getEnabled()){if(w){var a=E(B.x,B.y);n.setAttributeNS(null,"transform","translate"+
CTAT.Geom.Point.to2DString(a.location,!0))}else n.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(C(B.x,B.y),!0));u=requestAnimationFrame(t)}}.bind(this);this.render=function(){r()};this.calcXCoordinate=function(a){a=new c(a);var b=this.getWidth()-30,b=Math.abs(b-30),d=max.subtract(min);return 30+a.subtract(min).divide(d)/b};this.calcNum=function(a){var b=this.getWidth()-30,b=Math.abs(b-30);a=max.subtract(min).multiply((a-30)/b);return min.add(a)};var G=function(a,b){switch(b.getClassName()){case "CTATMessage":b=
...
d.classList.add("CTAT--incorrect")}break;case "set_minimum":S(Q()).forEach(c);break;case "set_maximum":S(L()).forEach(c);break;case "set_large_step":S(M()).forEach(c);break;case "set_small_step":S(R()).forEach(c);break;case "set_denominator":S(T()).forEach(c);break;default:console.log("Unhandled Action in",this.getName(),b)}};var z=this.setEnabled;this.setEnabled=function(a){z(a);n&&v&&(n.style.visibility=this.getEnabled()?null:"hidden")};this.set_minimum=function(a){this.Minimum=a;this.render()};
this.change_minimum=function(a){a=new c(a);0!==a.valueOf()&&(this.Minimum=this.Minimum.add(a),this.render())};var J=function(){this.setActionInput("set_minimum",this.Minimum)}.bind(this);this.set_maximum=function(a){this.Maximum=a;this.render()};this.change_maximum=function(a){a=new c(a);0!==a.valueOf()&&(this.Maximum=this.Maximum.add(a),this.render())};var H=function(){this.setActionInput("set_maximum",this.Maximum)}.bind(this);this.set_max_user_entries=function(a){this.setMaxPoints(parseInt(a))};
a=function(a,b){a.setStep(b);this.render()};this.set_large_step=a.bind(this,h);var K=function(){this.setActionInput("set_large_step",h.step.toString())}.bind(this);this.set_small_step=a.bind(this,m);var I=function(){this.setActionInput("set_small_step",m.step.toString())}.bind(this);this.set_denominator=function(a){0===parseInt(a)?l.setStep(0):l.setStep((new c(a)).reciprocal());this.render()};var P=function(){var a=0===l.step.valueOf()?0:l.step.reciprocal();this.setActionInput("set_denominator",a.toString())}.bind(this);
a=function(a,b){if(0!==(new c(b)).valueOf()){var d=a.step.add(b);0>d.valueOf()&&d.set(0,1);a.setStep(d);this.render()}};this.change_large_step=a.bind(this,h);this.change_small_step=a.bind(this,m);this.change_denominator=function(a){a=new c(a);0!==a.valueOf()&&(a=a.add(l.step.denominator),l.setStep(a.reciprocal()),this.render())};var N=void 0;this.set_precision=function(a){N=parseInt(a);this.render()};this.AddPoint=function(a,b){var d=new c(a),e=this.X_Axis.getPosition(d),g=document.createElementNS(f,
"circle");g.classList.add("CTATNumberLine--point");g.setAttributeNS(null,"cx",e.x);g.setAttributeNS(null,"cy",e.y);g.setAttributeNS(null,"r",p);g.value=d;[].slice.call(this._point_group.children).some(function(a){return d.equals(a.value)})||this._point_group.appendChild(g)};this.Points=function(a,b){this._point_group.innerHTML="";var c=a.split(";"),d;for(d in c)this.AddPoint(c[d],b)};var O=function(a,b,c,d){switch(d.getAction()){case "ButtonPressed":a.call(this,d.getInput());break;case "Update":case "UpdateTextField":case "UpdateTextArea":b.call(this,
...
this&&(b=a.getName());else if(a instanceof CTATSAI)a.getSelection()!=pointer.getName()&&(b=a.getSelection());else if(a instanceof String)a!=pointer.getName()&&(b=a);else if(a instanceof Element)a!=pointer.getComponent()&&(b=a.id);else return null;if(b){if(U(b))return O.bind(this,this.change_denominator,this.set_denominator,P);if(V(b))return O.bind(this,this.change_small_step,this.set_small_step,I);if(W(b))return O.bind(this,this.change_large_step,this.set_large_step,K);if(X(b))return O.bind(this,
this.change_minimum,this.set_minimum,J);if(Y(b))return O.bind(this,this.change_maximum,this.set_maximum,H)}return null}.bind(this);CTATConfiguration.get("previewMode")||document.addEventListener(CTAT.Component.Base.Tutorable.EventType.action,function(a){var b=a.detail.sai;a=Z(a.detail.component);b&&null!==a&&a(b)},!1);this.setMaxControllers=function(a){$(this.getDivWrap()).attr("data-ctat-ctrl-max",a)};this.setParameterHandler("MaxValueControllers",this.setMaxControllers);this.setMinControllers=function(a){$(this.getDivWrap()).attr("data-ctat-ctrl-min",
...
(this.getDivWrap().innerHTML="");this.getDivWrap().appendChild(c);this.component.addEventListener("focus",this.processFocus);var d=this;c.addEventListener("change",function(a){var b=Number(this.min);isNaN(b)&&(b=0);a=Number(this.value);if(isNaN(a))this.value=b;else if(""!==this.min&&a<b)this.value=b;else if(""!==this.max&&!isNaN(Number(this.max))&&a>Number(this.max))this.value=this.max;else{var c=Number(this.step);if(isNaN(c)||0>=c)c=1;b=(a-b)%c;0!==b&&(this.value=a-b)}d.updateSAI();d.processAction();
return!1});CTATConfiguration.get("previewMode")&&this.addEventScreen(!1)};this.getConfigurationActions=function(){var a=[],b,c=$(this.getDivWrap());c.attr("min")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_minimum"),b.setInput(c.attr("min")),a.push(b));c.attr("max")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_maximum"),b.setInput(c.attr("max")),a.push(b));c.attr("step")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_step"),b.setInput(c.attr("step")),
a.push(b));c.attr("value")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("Update"),b.setInput(c.attr("value")),a.push(b));return a}};CTATNumericStepper.prototype=Object.create(CTAT.Component.Base.Tutorable.prototype);CTATNumericStepper.prototype.constructor=CTATNumericStepper;CTAT.ComponentRegistry.addComponentType("CTATNumericStepper",CTATNumericStepper);var CTATPieChart=function(a,b,e,g,d){CTAT.Component.Base.UnitDisplay.call(this,"CTATPieChart","aPieChart",a,b,e,g,d);var c=3,f=3,h=this,m,l,q,p=null,w=CTATGlobals.NameSpace.svg;this.init=function(){this.initSVG();this.baseGroup=document.createElementNS(w,"g");this.getComponent().appendChild(this.baseGroup);this.getComponent().classList.add("CTATPieChart--container");m=document.createElementNS(w,"filter");m.id=this.genName("Shadow");l="#"+m.id;q="url("+l+")";m.setAttributeNS(null,"width","200%");m.setAttributeNS(null,
"height","200%");p=document.createElementNS(w,"feOffset");p.setAttributeNS(null,"in","SourceAlpha");p.setAttributeNS(null,"result","offOut");p.setAttributeNS(null,"dx",f);p.setAttributeNS(null,"dy",f);m.appendChild(p);var a=document.createElementNS(w,"feGaussianBlur");a.setAttributeNS(null,"in","offOut");a.setAttributeNS(null,"result","blurOut");a.setAttributeNS(null,"stdDeviation",4);m.appendChild(a);a=document.createElementNS(w,"feBlend");a.setAttributeNS(null,"in","SourceGraphic");a.setAttributeNS(null,
...
var m=2*Math.PI*a.valueOf();l=e.add(CTAT.Geom.Point.polar(d,m));b.reduce();var n=e.add(CTAT.Geom.Point.polar(d,2*Math.PI*b.valueOf()+m)),r=e.clone();if(0<c&&c<d){m=CTAT.Geom.Point.polar(c,m+Math.PI*b.valueOf());r=r.add(m);l=l.add(m);var u=function(a,b,c){return a.distance(b)<a.distance(c)?b:c};l=CTAT.Geom.Point.circle_intersection(r,l,e,d).reduce(u.bind(this,l));n=n.add(m);n=CTAT.Geom.Point.circle_intersection(r,n,e,d).reduce(u.bind(this,n))}m=CTAT.Geom.Point.to2DString;r="M "+m(r);u=new DOMPoint(d,
d);r+=" L "+m(l);r+=" A "+m(u)+" 0 "+(.5<b.valueOf()?1:0)+",1 "+m(n);f.setAttributeNS(null,"d",r+" Z");h.addPieceElem(f,b,b.selected)}return a.add(b)},new CTAT.Math.Fraction);this.baseGroup.innerHTML="";this.baseGroup.appendChild(g)}};this.getExplode=function(){return c};this.getDropShadowDistance=function(){return f};this.setExplode=function(a){a=Number(a);if(!isNaN(a)){var b=a!==c;c=a;b&&this.drawPieces()}return this};this.setStyleHandler("explode",this.setExplode);this.data_ctat_handlers.explode=
function(a){this.setExplode(a)};this.setDropShadowDistance=function(a){f=parseInt(a);f=isNaN(f)?0:f;p&&(p.setAttributeNS(null,"dx",f),p.setAttributeNS(null,"dy",f),0>=f&&this.baseGroup?this.baseGroup.removeAttributeNS(null,"filter"):this.baseGroup.hasAttributeNS(null,"filter")||this.baseGroup.setAttributeNS(null,"filter",q))};this.data_ctat_handlers["shadow-distance"]=function(a){this.setDropShadowDistance(a)}};CTATPieChart.prototype=Object.create(CTAT.Component.Base.UnitDisplay.prototype);
...
this.setFontColor=function(a){l=a;$(m).css("color",a)};this.getFontColor=function(){return l};this.resize=function(){var a=$(this.getDivWrap()).height();$(m).css("font-size",a-5+"px");$(this.getComponent()).css("height",a-10+"px");$(this.getComponent()).css("width",a-10+"px")};var q=this.setText;this.setText=function(a){q(a);null!==m&&(m.innerHTML=this.getText())};this.setStyleHandler("buttonLabel",this.setText);var p=this.setEnabled;this.setEnabled=function(a){p(a);null!==h&&(h.disabled=!this.getEnabled())};
...
function(){f.ctatdebug("processSerialization()")};this.postProcess=function(){f.ctatdebug("postProcess ()");for(var a in this.parameters){var b=this.parameters[a];f.ctatdebug("Checking style name: "+a);if("TargetMovieClip"==a)if(f.ctatdebug("Loading sub element: ["+b.trim()+"] ..."),b=findMovieClip(b.trim()),null!==b){if(f.ctatdebug("Found target movieclip, temporarily removing ..."),null!==b.getDivWrapper().parentNode){try{b.getDivWrapper().parentNode.removeChild(b.getDivWrapper())}catch(p){CTATScrim.scrim.errorScrimUp(p.message);
...
g.getLevel()+" ...");var w=document.createElement("div");w.classList.add("CTATSkillWindow--skill");var r=document.createElement("div");r.classList.add("CTATSkillWindow--bar");var u=document.createElement("div"),n=g.getLevel();n<d?u.classList.add("CTATSkillWindow--bar--nonmastered"):u.classList.add("CTATSkillWindow--bar--mastery");u.style.width=n>d?"100%":100*n+"%";r.appendChild(u);w.appendChild(r);b.appendChild(w);r=document.createElement("div");r.textContent=g.getDisplayName()||"no-name";r.classList.add("CTATSkillWindow--label");
...
CTAT.ComponentRegistry.addComponentType("CTATSubmitButton",CTATSubmitButton);var CTATTextBasedComponent=function(a,b,e,g,d,c,f){CTAT.Component.Base.Tutorable.call(this,a,b,e,g,d,c,f);var h=this,m="",l="#000000",q=16,p=!0,w=255,r=!0;this.setAction("UpdateTextField");this.backgrade=!0;this.setFontColor=function(a){l=a;$(h.getComponent()).css("color",a)};this.getFontColor=function(){return l};this.setFontSize=function(a){a.includes("px")||(a+="px");q=a;$(h.getComponent()).css("font-size",a)};this.getFontSize=function(){return q};this.assignText=function(a){m=a;this.setInput(a)};
this.UpdateTextArea=this.UpdateTextField=function(a){this.setText(a)};this.setTabOnEnter=function(a){p=CTATGlobalFunctions.toBoolean(a)};this.setStyleHandler("TabOnEnter",this.setTabOnEnter);this.data_ctat_handlers["tab-on-enter"]=this.setTabOnEnter;this.assignEditable=function(a){r=a};this.setMaxCharacters=function(a){w=a};this.setStyleHandler("MaxCharacters",this.setMaxCharacters);this.getText=function(){return m};this.getEditable=function(){return r};this.getTabOnEnter=function(){return p};this.getMaxCharacters=
...
var m=this.render;this.render=function(){m.call(this);this.sizeToDiv()};this.getConfigurationActions=function(){var a=[],b;$(f.getDivWrap()).attr("data-ctat-controls")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("showControls"),b.setInput($(f.getDivWrap()).attr("data-ctat-controls")),a.push(b));$(f.getDivWrap()).attr("data-ctat-autoplay")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("setAutoplay"),b.setInput($(f.getDivWrap()).attr("data-ctat-autoplay")),a.push(b));$(this.getDivWrap()).attr("src")&&
...
f.getTutorComponent(),!0,f,"VIDEO_ACTION","USER")}else f.ctatdebug("Error: commShell is null, can't send untutored tool message");else f.ctatdebug("Error: audio file not loaded yet, can't obtain duration")};this.PlayMedia=function(a){h.src=a};this.showControls=function(a){console.log("showControls( "+a+" )");a=CTATGlobalFunctions.toBoolean(a);$(f.getDivWrap()).attr("data-ctat-controls",a);h.controls=a};this.setAutoplay=function(a){console.log("setAutoplay( "+a+" )");a=CTATGlobalFunctions.toBoolean(a);
$(f.getDivWrap()).attr("data-ctat-autoplay",a);h.autoplay=a};this.setURL=function(a){$(this.getDivWrap()).attr("src",a);h.src=a};this.play=function(a){f.ctatdebug("play ()");var b="0";a&&(b="number"===typeof a?String(a):"string"===typeof a?a:"0");h.currentTime=b;h.play()};this.pause=function(a){f.ctatdebug("pause ()");h.pause();var b="0";a&&(b="number"===typeof a?String(a):"string"===typeof a?a:"0");h.currentTime=b};this.stop=function(){f.ctatdebug("stop ()");f.pause()}};CTATVideo.prototype=Object.create(CTAT.Component.Base.Tutorable.prototype);
...
function gradeAnonymousComponent(a,b,e){ctatdebug("gradeAnonymousComponent ()");a=new CTATSAI(a,b,e);CTATCommShell.commShell.processComponentAction(a)}function testTutor(a){ctatdebug("testTutor ()");window.onerror=function(a,e,g){var b=new CTATHTMLManager;ctatdebug(b.htmlEncode(a)+" in "+e+", line "+g)};null==CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet);(new CTATCommLibrary).send("http://augustus.pslc.cs.cmu.edu/crossdomain.xml")}
...
b=document.createElement("canvas"),b.id="main-canvas",b.innerHTML="Your browser does not support CTAT. Please update or use another browser.",ctatdebug("Setting canvas to: 0,0,"+g+" , "+d),getSafeElementById(ctatcontainer).appendChild(b)):(ctatdebug("Setting canvas to: 0 , 0, "+g+" , "+d),b.style.top="0",b.style.left="0");b.style.width=g+"px";b.style.height=d+"px";return b};(function(a){function b(){var a=arguments[0],c=b.cache;c[a]&&c.hasOwnProperty(a)||(c[a]=b.parse(a));return b.format.call(null,c[a],arguments)}function e(a){return Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var g=/[^s]/,d=/[def]/,c=/^[^\x25]+/,f=/^\x25{2}/,h=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/,m=/^([a-z_][a-z_\d]*)/i,l=/^\.([a-z_][a-z_\d]*)/i,q=/^\[(\d+)\]/,p=/^[\+\-]/;b.format=function(a,c){var f=1,h=a.length,l,m=[],r,q,u,w,C=!0,
E="";for(r=0;r<h;r++)if(l=e(a[r]),"string"===l)m[m.length]=a[r];else if("array"===l){u=a[r];if(u[2])for(l=c[f],q=0;q<u[2].length;q++){if(!l.hasOwnProperty(u[2][q]))throw Error(b("[sprintf] property '%s' does not exist",u[2][q]));l=l[u[2][q]]}else l=u[1]?c[u[1]]:c[f++];"function"==e(l)&&(l=l());if(g.test(u[8])&&"number"!=e(l)&&isNaN(l))throw new TypeError(b("[sprintf] expecting number but found %s",e(l)));d.test(u[8])&&(C=0<=l);switch(u[8]){case "b":l=l.toString(2);break;case "c":l=String.fromCharCode(l);
break;case "d":l=parseInt(l,10);break;case "e":l=u[7]?l.toExponential(u[7]):l.toExponential();break;case "f":l=u[7]?parseFloat(l).toFixed(u[7]):parseFloat(l);break;case "o":l=l.toString(8);break;case "s":l=(l=String(l))&&u[7]?l.substring(0,u[7]):l;break;case "u":l>>>=0;break;case "x":l=l.toString(16);break;case "X":l=l.toString(16).toUpperCase()}if(!C||d.test(u[8])&&u[3])E=C?"+":"-",l=l.toString().replace(p,"");q=u[4]?"0"==u[4]?"0":u[4].charAt(1):" ";w=u[6]-(E+l).length;w=u[6]?Array(w+1).join(q):
"";m[m.length]=u[5]?E+l+w:0==q?E+w+l:w+E+l}return m.join("")};b.cache={};b.parse=function(a){for(var b,d=[],e=0;a;){if(null!==(b=c.exec(a)))d[d.length]=b[0];else if(null!==(b=f.exec(a)))d[d.length]="%";else if(null!==(b=h.exec(a))){if(b[2]){var e=e|1,g=[],r=b[2],p;if(null!==(p=m.exec(r)))for(g[g.length]=p[1];""!==(r=r.substring(p[0].length));)if(null!==(p=l.exec(r)))g[g.length]=p[1];else if(null!==(p=q.exec(r)))g[g.length]=p[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");
...
a);break;case 26:this.$=new d.CTATConstantNode(Number(a))}},table:[{3:1,4:2,6:3,13:e,14:4,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{1:[3]},{5:[1,14]},{5:[2,8],7:[1,15],8:[1,16],9:[1,17],10:[1,18],11:[1,19],12:[1,20],13:m,15:l},b(q,[2,11],{22:9,19:25,16:p,18:w,20:r,21:u,24:d,25:c,27:f,28:h}),b(n,[2,17]),{13:e,15:g,17:28,19:8,22:9,24:d,25:c,27:f,28:h},{13:e,15:g,17:29,19:8,22:9,24:d,25:c,27:f,28:h},b(n,[2,20]),b(n,[2,23],{23:[1,30]}),{13:e,15:g,17:31,19:8,22:9,24:d,25:c,27:f,28:h},{6:32,13:e,14:4,15:g,
17:5,19:8,22:9,24:d,25:c,27:f,28:h},b(B,[2,25]),b(B,[2,26]),{1:[2,1]},{6:33,13:e,14:4,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{6:34,13:e,14:4,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{6:35,13:e,14:4,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{6:36,13:e,14:4,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{6:37,13:e,14:4,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{6:38,13:e,14:4,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{13:e,14:39,15:g,17:5,19:8,22:9,24:d,25:c,27:f,28:h},{13:e,14:40,15:g,17:5,19:8,22:9,24:d,
25:c,27:f,28:h},{13:e,15:g,17:41,19:8,22:9,24:d,25:c,27:f,28:h},{13:e,15:g,17:42,19:8,22:9,24:d,25:c,27:f,28:h},b(n,[2,14]),{13:e,15:g,17:43,19:8,22:9,24:d,25:c,27:f,28:h},{13:e,15:g,17:44,19:8,22:9,24:d,25:c,27:f,28:h},b(n,[2,18]),b(n,[2,19]),{13:e,15:g,17:45,19:8,22:9,24:d,25:c,27:f,28:h},b(n,[2,22]),{13:m,15:l,26:[1,46]},{5:[2,2],13:m,15:l},{5:[2,3],13:m,15:l},{5:[2,4],13:m,15:l},{5:[2,5],13:m,15:l},{5:[2,6],13:m,15:l},{5:[2,7],13:m,15:l},b(q,[2,9],{22:9,19:25,16:p,18:w,20:r,21:u,24:d,25:c,27:f,
28:h}),b(q,[2,10],{22:9,19:25,16:p,18:w,20:r,21:u,24:d,25:c,27:f,28:h}),b(n,[2,12]),b(n,[2,13]),b(n,[2,15]),b(n,[2,16]),b(n,[2,21]),b(B,[2,24])],defaultActions:{14:[2,1]},parseError:function(a,b){if(b.recoverable)this.trace(a);else{var c=function(a,b){this.message=a;this.hash=b};c.prototype=Error;throw new c(a,b);}},parse:function(a){var b=[0],c=[null],d=[],e=this.table,f="",g=0,l=0,h=0,m=d.slice.call(arguments,1),r=Object.create(this.lexer),n={},p;for(p in this.yy)Object.prototype.hasOwnProperty.call(this.yy,
p)&&(n[p]=this.yy[p]);r.setInput(a,n);n.lexer=r;n.parser=this;"undefined"==typeof r.yylloc&&(r.yylloc={});p=r.yylloc;d.push(p);var q=r.options&&r.options.ranges;this.parseError="function"===typeof n.parseError?n.parseError:Object.getPrototypeOf(this).parseError;for(var u,w,v,B,L={},Q,M;;){v=b[b.length-1];if(this.defaultActions[v])B=this.defaultActions[v];else{if(null===u||"undefined"==typeof u)u=r.lex()||1,"number"!==typeof u&&(u=this.symbols_[u]||u);B=e[v]&&e[v][u]}if("undefined"===typeof B||!B.length||
!B[0]){var R;M=[];for(Q in e[v])this.terminals_[Q]&&2<Q&&M.push("'"+this.terminals_[Q]+"'");R=r.showPosition?"Parse error on line "+(g+1)+":\n"+r.showPosition()+"\nExpecting "+M.join(", ")+", got '"+(this.terminals_[u]||u)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==u?"end of input":"'"+(this.terminals_[u]||u)+"'");this.parseError(R,{text:r.match,token:this.terminals_[u]||u,line:r.yylineno,loc:p,expected:M})}if(B[0]instanceof Array&&1<B.length)throw Error("Parse Error: multiple actions possible at state: "+
v+", token: "+u);switch(B[0]){case 1:b.push(u);c.push(r.yytext);d.push(r.yylloc);b.push(B[1]);u=null;w?(u=w,w=null):(l=r.yyleng,f=r.yytext,g=r.yylineno,p=r.yylloc,0<h&&h--);break;case 2:M=this.productions_[B[1]][1];L.$=c[c.length-M];L._$={first_line:d[d.length-(M||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(M||1)].first_column,last_column:d[d.length-1].last_column};q&&(L._$.range=[d[d.length-(M||1)].range[0],d[d.length-1].range[1]]);v=this.performAction.apply(L,[f,l,
g,n,B[1],c,d].concat(m));if("undefined"!==typeof v)return v;M&&(b=b.slice(0,-2*M),c=c.slice(0,-1*M),d=d.slice(0,-1*M));b.push(this.productions_[B[1]][0]);c.push(L.$);d.push(L._$);B=e[b[b.length-2]][b[b.length-1]];b.push(B);break;case 3:return!0}}}},e=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parser)this.yy.parser.parseError(a,b);else throw Error(a);},setInput:function(a,b){this.yy=b||this.yy||{};this._input=a;this._more=this._backtrack=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=
...
(function(){var a,b,e,g,d,c,f,h,m,l,q,p=[].slice;d=/^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;g=/^\d+(\.\d\d)?$/;c=RegExp("((\\d+)\\.?(\\d+)?|\\.(\\d+))([Ee]([+-]?\\d+))?","g");l=/^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;m=/^\s*\(\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\,\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\)\s*$/;h=/([bcdfghjklmnpqrstvwxz]|qu)y$/;f=/([bcdfghjklmnpqrstvwxz]o|[sc]h|s)$/;q=function(a,b){var c;null==b&&(b=!1);var d,e,f,g;f=null!=(c=a[4])?c:a[2]+(a[3]||
...
d.call(arguments,0):[];return a.apply(b,c)}}(CTATFormulaActions[b],CTATFormulaActions))}a.prototype.evaluate=function(a,f,l,q){var h,m,r,u,n,B,v,A,y,F,D,x;try{A="undefined"!==typeof window&&null!==window?window:global;h=function(){var a;a=[];for(u in A)a.push(u);return a}().concat(["selection","action","input"]);y=a.split(g);m=0;for(n=y.length;m<n;m++)for(v=y[m],D=null!=(F=v.match(b))?F:[],r=0,B=D.length;r<B;r++)u=D[r],0>c.call(e,u)&&0>c.call(h,u)&&0>c.call(this.keys,u)&&CTATFormulaFunctions.assign(u,
void 0);for(u in x=this.variableTable.getTable())A[u]=x[u];return function(a,b,c){c.prototype=a.prototype;c=new c;a=a.apply(c,b);return Object(a)===a?a:c}(Function,["selection","action","input"].concat(d.call(this.keys),["return "+a.trim()]),function(){}).apply(A,[f,l,q].concat(d.call(this.values)))}catch(C){return console.log(C),null}finally{for(u in A)null!=u&&0>c.call(h,u)&&(x[u]=A[u],delete A[u])}};a.prototype.interpolateSplitPattern=/<%=|%>/;a.prototype.interpolate=function(a,b,c,d){var e,f,
...
d,g);case CTATExpressionMatcher.LT_RELATION:case CTATExpressionMatcher.GT_RELATION:if(null==f||null==d)break;return h.compareNumberOrString(f,d,g);case CTATExpressionMatcher.LTE_RELATION:case CTATExpressionMatcher.GTE_RELATION:if(null==f)return null==d;if(null!=d)return h.compareNumberOrString(f,d,g)}}catch(u){}return!1}CTATSingleMatcher.call(this,a,b);var g=CTATExpressionMatcher.EQ_RELATION,d=b,c=null,f=!1,h=this;this.getLastInput=function(){h.ctatdebug("CTATExpressionMatcher.getLastInput() returns "+
...
a.toString()!==CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.BUGGY_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.HINT_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.UNTRACEABLE_ERROR.toString()&&a.toString()!==CTATExampleTracerLink.CLT_ERROR_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.GIVEN_ACTION.toString())throw new CTATExampleTracerException("invalid action type "+q);q=a};this.setBuggyMsg=function(a){u=a};this.setSuccessMsg=
function(a){r=a};this.setMinTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)l=1;else try{l=parseInt(a.trim()),isNaN(l)&&(l=1)}catch(y){l=1}};this.setMaxTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)m=l;else try{m=parseInt(a.trim()),isNaN(m)&&(m=1)}catch(y){m=l}};this.setUniqueID=function(a){g=a};this.addSkillName=function(a){v.ctatdebug("ETLink["+g+"].addSkillName("+a+")");if("unnamed"!==a){if(null===B||"undefined"===typeof B)B=[];-1<B.indexOf(a)||
...
w+", now "+a);w=a};this.setVisualData=function(a){n=a};this.getVisualData=function(){return n}};
...
function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation("+a+")");p=a};this.setStepID=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID("+a+")");w=a?a.toString():""};this.setReportableVariableTable=function(a){B=a.clone()};this.setSuccessOrBuggyMsg=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg("+a+")");v=a};this.setReportableHints=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints("+a+")");A=
Array.isArray(a)&&0<a.length?a:[]};this.getWantReportableHints=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning "+y);return y};this.setOutOfOrder=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder("+a+")");r=a};this.isOutOfOrder=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning "+r);return r};this.setEvaluatedInput=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput("+a+")");if(null===
n||"undefined"===typeof n)n=[];n.push(a)};this.addPreloadedLinkMatch=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch("+a+")");if(null===u||"undefined"===typeof u)u=[];u.push(a)};this.setInterpolatedSAI=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI("+a+")");a&&(F=a)};this.getInterpolatedSAI=function(){return F?F:x.getStudentSAI()};this.setInterpolatedHints=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints("+
a+")");null!==D&&"undefined"!==typeof D&&(D.length=0);null!==a&&"undefined"!==typeof a&&(D=a.slice(0));x.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints")};this.setWantReportableHints=function(a){x.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints("+a+")");y=a};this.getSuccessOrBuggyMsg=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning "+v);return v};this.getReportableHints=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning "+
A);return A};this.getReportableLink=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning "+q);return q};this.getReportableVariableTable=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning "+B);return B};this.getReportableInterpretation=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning "+p);return p};this.getStepID=function(){x.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning "+
w);return w};this.getTutorSelection=function(){return null===m||"undefined"===typeof m?null:m.getSelectionArray()};this.getTutorAction=function(){return null===m||"undefined"===typeof m?null:m.getActionArray()};this.getTutorInput=function(){return null!==n&&"undefined"!==typeof n?x.getEvaluatedInputArray():null!==m&&"undefined"!==typeof m?m.getInputArray():null};this.getEvaluatedInputArray=function(){return n};this.toString=function(){var a;a="["+x.getResult();null!==x.getStudentSAI()&&"undefined"!==
...
t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint result: "+d);b=t.matchForHint(d);Array.isArray(e)&&(t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint last if condition"),e.push(d));t.ctatdebug("CTATExampleTracerTracer --\x3e returning from doHint: "+b);return b};this.getBestInterpretation=function(){t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation");if(null===C||"undefined"===typeof C)t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"),
C=p(t.getInterpretationsInternal());t.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation "+(null===C||void 0===C));return C};this.getInterpretationsInternal=function(){t.ctatdebug("CTATExampleTracerTracer --\x3e in getInterpretationsInternal");return A};this.toString=function(){var a="TracerState\n";null===A?a+="(no interpretations)\n":A.forEach(function(b){a+=b.toString()+"\n"});return a};this.addInterfaceVariablesFromEvent=function(a){if(a){var b=a.getTutorSelection();a=a.getTutorInput();
t.addInterfaceVariables(b,a)}};this.addInterfaceVariables=function(a,c){t.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables("+a+", "+c+")");if(a&&c){var d=a.length;d>c.length&&(d=c.length);for(var e=0;e<d;e++)a[e]&&(b.put(a[e],CTATVariableTable.standardizeType(c[e])),b.put(CTATVariableTable.nameAsString(a[e]),CTATVariableTable.valueAsString(c[e])));t.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() startStateVT "+b);A&&A.forEach(function(b){if(b=b.getVariableTable()){for(var e=0;e<
d;e++)a[e]&&(b.put(a[e],CTATVariableTable.standardizeType(c[e])),b.put(CTATVariableTable.nameAsString(a[e]),CTATVariableTable.valueAsString(c[e])));t.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() interp.vt "+b)}})}};this.findCurrentState=function(){t.ctatdebug("Entering findCurrentState");var a=t.getBestInterpretation();return a&&a.getLastMatchedLink()&&a.getLastMatchedLink().isDone()?a.getLastMatchedLink().getNextNode():(a=n(!1,[a]))?a.getPrevNode():D?D.getStartNode():null}};
CTATExampleTracerTracer.prototype=Object.create(CTATBase.prototype);CTATExampleTracerTracer.prototype.constructor=CTATExampleTracerTracer;"undefined"!==typeof module&&(module.exports=CTATExampleTracerTracer);var CTATExampleTracerGraph=function(a,b,e){function g(a,b,d){z.ctatdebug("CTATExampleTracerGraph --\x3e in isOrderOK");if(z.relaxOrderConstraints()||b.isDone()&&z.exitOnIncorrectDone())return!0;for(var e=c(b),g=0;g<e.length;g++){var l=e[g];if(!0===t.isGroupOrdered(l))if(g!==e.length-1){if(!1===f(l,h(e[g+1],d),a,d))return!1}else if(!1===f(l,b,a,d))return!1}z.ctatdebug("CTATExampleTracerGraph --\x3e out of isOrderOK");return!0}function d(a,b,d){z.ctatdebug("CTATExampleTracerGraph --\x3e in isReenteringOK");
if(z.relaxOrderConstraints()||b.isDone()&&z.exitOnIncorrectDone())return!0;b=c(b);for(var e=!0,f=0;f<b.length;f++)if(!0===e&&!1===t.isGroupReenterable(b[f]))for(var e=!1,g=0;g<a.length;g++)if(!0===t.isLinkInGroup(b[f],a[g]))e=!0;else{if(!0===e)return!1}else if(!1===e)break;if(0!==a.length){var h=c(a[a.length-1]);z.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups null? "+(null===h));z.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups undefined? "+("undefined"===
typeof h));z.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups last traversedLink "+a[a.length-1].getUniqueID());z.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups length "+(h?h.length:null));b.forEach(function(a){a=h.indexOf(a);0<=a&&h.splice(a,1)});z.ctatdebug("CTATETGraph.isReentrableOK: exitedGroups.length after removing newLink's groups: "+h.length);for(k=h.length-1;0<=k;k--)t.isGroupReenterable(h[k])&&h.splice(k,1);z.ctatdebug("CTATETGraph --\x3e in isReentrableOK: exitedGroups after removing reenterables: "+
h.length);z.ctatdebug("CTATETGraph --\x3e in isReentrableOK: traversedLinks: "+a+", path: "+d);var l=!0;h.forEach(function(b){!1!==l&&d.forEach(function(c){!1!==l&&m(a,c)<c.getMinTraversals()&&!0===t.isLinkInGroup(b,c)&&(l=!1)})});if(!1===l)return!1}z.ctatdebug("CTATExampleTracerGraph --\x3e out of isReenteringOK");return!0}function c(a){z.ctatdebug("in findGroupsOfLink(link "+a+"): typeof(groupModel) "+typeof t);a=t.getGroupsContainingLink(a);z.ctatdebug("in findGroupsOfLink groupsSet.size "+a.size);
var b=[];a.forEach(function(a){z.ctatdebug("in findGroupsOfLink group element "+a.getName());b.push(a)});b.sort(function(a,b){return t.getGroupLinkCount(b)-t.getGroupLinkCount(a)});return b}function f(a,b,c,d){var e=-1,f=null,g=Number.MAX_VALUE,l=null;t.getGroupSubgroups(a).forEach(function(a){if(!1===t.isLinkInGroup(a,b)&&0!==t.getGroupLinkCount(a)){var n=h(a,d);null!==n&&"undefined"!==typeof n&&(n=n.getDepth(),n<b.getDepth()&&n>e&&(!1===q(a)||!0===p(a,c))&&(e=n,f=a),n>b.getDepth()&&n<g&&(!1===q(a)||
!0===p(a,c))&&(g=n,l=a))}});t.getUniqueLinks(a).forEach(function(a){if(!0===d.has(a)){var h=a.getDepth();h<b.getDepth()&&h>e&&(0<a.getMinTraversals()||-1<c.indexOf(a))&&(e=h,f=a);h>b.getDepth()&&h<g&&(0<a.getMinTraversals()||-1<c.indexOf(a))&&(g=h,l=a)}});if(null!==f&&"undefined"!==typeof f)if(f instanceof CTATExampleTracerLink){if(m(c,f)<f.getMinTraversals())return!1}else if(f instanceof CTATLinkGroup&&!1===w(f,c,d))return!1;return null!==l&&"undefined"!==typeof l&&(l instanceof CTATExampleTracerLink&&
-1<c.indexOf(l)||l instanceof CTATLinkGroup&&!0===p(l,c))?!1:!0}function h(a,b){var c=Number.MAX_VALUE,d=null;t.getGroupLinks(a).forEach(function(a){a.getDepth()<c&&!0===b.has(a)&&(c=a.getDepth(),d=a)});return d}function m(a,b){for(var c=0,d=0;d<a.length;d++)b===a[d]&&c++;z.ctatdebug("CTATETGraph.getTraversalCount("+b+"): "+c);return c}function l(a,b,c){var d=!1,e=!0,f=!1;(new CTATExampleTracerPath(b)).getSortedLinks().forEach(function(b){if(!1!==e&&!0!==f){if(!1===d)!0===t.isLinkInGroup(a,b)&&(d=
!0);else if(!1===t.isLinkInGroup(a,b)){f=!0;return}c.getTraversalCount(b)<b.getMaxTraversals()&&(e=!1)}});return!1===e?!1:!0}function q(a){var b=!0;t.getGroupLinks(a).forEach(function(a){!1!==b&&0!==a.getMinTraversals()&&(b=!1)});return!1===b?!1:!0}function p(a,b){for(var c=0;c<b.length;c++)if(!0===t.isLinkInGroup(a,b[c]))return!0;return!1}function w(a,b,c){var d=!0;t.getGroupLinks(a).forEach(function(a){!1!==d&&!0===c.has(a)&&m(b,a)<a.getMinTraversals()&&(d=!1)});return!1===d?!1:!0}function r(){for(var a=
0;a<v.length;a++)v[a].clearInLinks();var b=z.getStartNode();null!==b&&"undefined"!==typeof b&&null!==b.getOutLinks()&&"undefined"!==typeof b.getOutLinks()&&(a=0,b.getOutLinks().forEach(function(b){u(b,a++)}))}function u(a,b){ctatdebug("updateInLinkSubGraph("+a+", "+b+")");var c=z.getNode(a.getNextNode());if(null!==c&&"undefined"!==typeof c){c.addInLink(a);var d=0;c.getOutLinks().forEach(function(a){u(a,d++)})}}function n(a){var b=z.getNode(a.getPrevNode());if(null!==b&&"undefined"!==typeof b){var c=
-1;b.getInLinks().forEach(function(a){-1===a.getDepth()&&n(a);a.getDepth()>c&&(c=a.getDepth())});a.setDepth(c+1)}}CTATBase.call(this,"CTATExampleTracerGraph","visualdata");var B=null,v=null,A=null,y=null,F=null,D=null,x=new Set,C=new Set,E=null,t=null,G=CTATMsgType.SHOW_ALL_FEEDBACK,z=this;this.getFeedbackPolicy=function(){return G};this.setFeedbackPolicy=function(a){z.ctatdebug("Graph.setFeedbackPolicy("+a+") old policy "+G);G="false"===a?CTATMsgType.SHOW_ALL_FEEDBACK:"true"===a?CTATMsgType.HIDE_ALL_FEEDBACK:
a};this.hideButRequireSteps=function(){return G==CTATMsgType.HIDE_BUT_COMPLETE};this.hideAllFeedback=function(){return G==CTATMsgType.HIDE_ALL_FEEDBACK};this.relaxOrderConstraints=function(){return z.hideAllFeedback()||z.hideButRequireSteps()||G==CTATMsgType.DELAY_FEEDBACK};this.exitOnIncorrectDone=function(){switch(G){case CTATMsgType.HIDE_ALL_FEEDBACK:case CTATMsgType.HIDE_BUT_ENFORCE:return!0;default:return!1}};this.getDefaultBuggyMsg=function(){return t.getTopLevelGroup()?t.getTopLevelGroup().getDefaultBuggyMsg():
null};this.getLinks=function(){z.ctatdebug("CTATExampleTracerGraph --\x3e in getLinks");return A};this.addLink=function(a,b){z.ctatdebug("CTATExampleTracerGraph --\x3e in addLink");A.push(a);a.isDone()?C.add(a):C["delete"](a);null===b||"undefined"===typeof b?t.addLinkToGroup(t.getTopLevelGroup(),a):t.addLinkToGroup(b,a);z.ctatdebug("CTATExampleTracerGraph --\x3e out of addLink")};this.addNode=function(a){z.ctatdebug("CTATExampleTracerGraph --\x3e in addNode");v.push(a);y[a.getNodeID()]=a;z.ctatdebug("CTATExampleTracerGraph --\x3e out of addNode")};
...
z.ctatdebug("CTATExampleTracerGraph.getBestSubpath("+a+", "+b+", ["+(c?c.length:-1)+"]) pathsFrom "+d.size+", pathsFromTo "+e.size);return 1>e.size?null:CTATExampleTracerPath.getBestPath(e)};this.getStartNode=function(){z.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning "+F);return F};this.getLinkByID=function(a){z.ctatdebug("CTATExampleTracerGraph --\x3e in getLinkByID");for(var b=0;b<A.length;b++)if(A[b].getUniqueID()===a)return A[b];z.ctatdebug("CTATExampleTracerGraph --\x3e out of getLinkByID");
return null};this.setStartNode=function(a){z.ctatdebug("CTATExampleTracerGraph --\x3e in setStartNode("+a+")");F=a};this.getStudentStartsHereNode=function(){z.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns "+D);return D};this.setStudentStartsHereNode=function(a){z.ctatdebug("CTATExampleTracerGraph --\x3e in setStudentStartsHereNode("+a+")");D=a};this.getExampleTracer=function(){z.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning "+B);return B};this.forDebugging=
function(){z.ctatdebug("CTATExampleTracerGraph --\x3e in forDebugging");z.ctatdebug("Nodes in the graph -- ids");v.forEach(function(a){z.ctatdebug(a.getNodeID())});z.ctatdebug("Links in the graph -- ids, from, to");A.forEach(function(a){z.ctatdebug(a)})};this.getSmallestContainingGroup=function(a){return t.getLowestLevelGroupOfLink(a)};this.redoLinkDepths=function(){r();z.getLinks().forEach(function(a){a.setDepth(-1)});z.getLinks().forEach(function(a){-1===a.getDepth()&&n(a)})};this.getGroupModel=
function(){return t};this.setVisualData=function(a){z.ctatdebug("CTATExampleTracerGraph --\x3e in setVisualData");E=a};this.getVisualData=function(){z.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning "+E);return E};this.getDoneLinks=function(){return C};(function(a,b){z.ctatdebug("CTATExampleTracerGraph --\x3e in initGraph ("+a+" , "+b);A=[];v=[];y={};if(null===t||"undefined"===typeof t)t=new CTATDefaultGroupModel,z.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
t.clear();t.setDefaultReenterable(!b);t.setGroupOrdered(t.getTopLevelGroup(),a);t.setGroupName(t.getTopLevelGroup(),CTATExampleTracerGraph.TOP_LEVEL);B=new CTATExampleTracerTracer(z,e);z.ctatdebug("CTATExampleTracerGraph --\x3e out of initGraph")})(!a,b)};Object.defineProperty(CTATExampleTracerGraph,"TOP_LEVEL",{enumerable:!1,configurable:!1,writable:!1,value:"Top Level"});CTATExampleTracerGraph.prototype=Object.create(CTATBase.prototype);CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;
"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function a(a){ctatdebug("processEdge()");for(var d=new CTATExampleTracerLink(null,null,null),e=f.getElementChildren(a),h,l,m,p,r,w=a=-1,x=CTATMsgType.DEFAULT_ACTOR,C=!1,E=0;E<e.length;E++){"sourceID"===f.getElementName(e[E])&&(a=parseInt(f.getNodeTextValue(e[E])),d.setPrevNode(a));"destID"===f.getElementName(e[E])&&(w=parseInt(f.getNodeTextValue(e[E])),d.setNextNode(w));if("rule"===f.getElementName(e[E]))for(var t=f.getElementChildren(e[E]),G=0;G<t.length;G++)"text"===
f.getElementName(t[G])&&d.addSkillName(f.getNodeTextValue(t[G]).toString());if("actionLabel"===f.getElementName(e[E]))for(d.setIsPreferredLink("false"!=f.getElementAttr(e[E],"preferPathMark")),d.setMinTraversalsStr(f.getElementAttr(e[E],"minTraversals")),d.setMaxTraversalsStr(f.getElementAttr(e[E],"maxTraversals")),t=f.getElementChildren(e[E]),G=0;G<t.length;G++){"uniqueID"===f.getElementName(t[G])&&(r=f.getNodeTextValue(t[G]),d.setUniqueID(parseInt(f.getNodeTextValue(t[G]))));"message"===f.getElementName(t[G])&&
(p=new CTATMessage(t[G]));"actionType"===f.getElementName(t[G])&&d.setActionType(f.getNodeTextValue(t[G]));"buggyMessage"===f.getElementName(t[G])&&d.setBuggyMsg(f.getNodeTextValue(t[G]));"successMessage"===f.getElementName(t[G])&&d.setSuccessMsg(f.getNodeTextValue(t[G]));"hintMessage"===f.getElementName(t[G])&&d.addHint(f.getNodeTextValue(t[G]));if("matchers"===f.getElementName(t[G]))for(var z=f.getElementChildren(t[G]),J=0;J<z.length;J++)"Selection"===f.getElementName(z[J])&&(h=b(z[J],0)),"Action"===
f.getElementName(z[J])&&(l=b(z[J],1)),"Input"===f.getElementName(z[J])&&(m=b(z[J],2)),"Actor"===f.getElementName(z[J])&&(x=f.getNodeTextValue(z[J]),C=(C=f.getElementAttr(z[J],"linkTriggered"))&&"false"!=C.toLowerCase().trim()?!0:!1);if("matcher"===f.getElementName(t[G])){m=t[G];l=p;h=f.getElementAttr(m,"replacementFormula");var H=f.getElementChildren(m),K=z=void 0,I,P=void 0,J=CTATMsgType.DEFAULT_ACTOR;m=new CTATExactMatcher(CTATMatcher.SELECTION,null);x=new CTATExactMatcher(CTATMatcher.ACTION,null);
g.ctatdebug("processMatcher(): nChildren "+H.length+", saiMessage "+l);for(var N=0;N<H.length;N++)"matcherType"===f.getElementName(H[N])&&(I=f.getNodeTextValue(H[N]),"ExactMatcher"===I&&(K=CTATExactMatcher),"RegexMatcher"===I&&(K=CTATRegexMatcher),"AnyMatcher"===I&&(K=CTATAnyMatcher),"RangeMatcher"===I&&(K=CTATRangeMatcher),"WildcardMatcher"===I&&(K=CTATWildcardMatcher),"ExpressionMatcher"===I&&(K=CTATExpressionMatcher),g.ctatdebug("processMatcher(): child "+N+", eltText "+I+", matcher "+K)),"matcherParameter"===
f.getElementName(H[N])&&(I=f.getElementAttr(H[N],"name"),P=f.getNodeTextValue(H[N]),"selection"==I&&m.setParameter(P),"action"==I&&x.setParameter(P),"input"==I&&(z=z?z:new K(CTATMatcher.INPUT,null),z.setParameter(P)),"actor"==I&&(J=P),"minimum"==I&&(z=z?z:new K(CTATMatcher.INPUT,null),z.setParameter(P,"minimum")),"maximum"==I&&(z=z?z:new K(CTATMatcher.INPUT,null),z.setParameter(P,"maximum")),"InputExpression"==I&&(z=z?z:new K(CTATMatcher.INPUT,null),z.setParameter(H[N],I,f)),"relation"==I&&(z=z?z:
new K(CTATMatcher.INPUT,null),z.setParameter(H[N],I,f)),g.ctatdebug("processMatcher(): child "+N+", eltAttrName "+I+", inputMatcher "+z));z||(z=K?new K(CTATMatcher.INPUT,null):new CTATExactMatcher(CTATMatcher.INPUT,null),z.setParameter(P?P:""),"undefined"!=typeof l&&"function"==typeof l.getSAI&&(l=l.getSAI(),m.setSingle(l.getSelection()),x.setSingle(l.getAction()),z.setSingle(l.getInput())));z.setReplacementFormula(h);x=[[m],[x],[z],J];h=x[0];l=x[1];m=x[2];x=x[3]}}}c.getStartNode()&&w==c.getStartNode().getNodeID()&&
console.log("***WARNING*** edge "+r+" destination is graph startNode "+c.getStartNode());r=new CTATVectorMatcher(h,l,m,x);r.setDefaultSAI(p.getSAI());r.setCaseInsensitive(q);r.setLinkTriggered(C);d.setMatcher(r);ctatdebug("GraphParser.processEdge() "+a+"->"+w+", edge "+d);c.getNode(a).addOutLink(d);c.checkForDoneState(d);return d}function b(a,b){g.ctatdebug("processMatchers()");for(var c=f.getElementChildren(a),d=[],e=0;e<c.length;e++)if("matcher"===f.getElementName(c[e])){for(var h=null,l=f.getElementAttr(c[e],
"replacementFormula"),m=f.getElementChildren(c[e]),p=0;p<m.length;p++){if("matcherType"===f.getElementName(m[p]))switch(h=f.getNodeTextValue(m[p]),g.ctatdebug("CTATGraphParser.processMatchers() matcherType["+p+"] = "+h),h){case "ExactMatcher":h=new CTATExactMatcher(b,null);break;case "RegexMatcher":h=new CTATRegexMatcher(b,null);break;case "AnyMatcher":h=new CTATAnyMatcher(b,null);break;case "RangeMatcher":h=new CTATRangeMatcher(b,null);break;case "WildcardMatcher":h=new CTATWildcardMatcher(b,null);
break;case "ExpressionMatcher":h=new CTATExpressionMatcher(b,null);break;default:console.log("CTATGraphParser.processMatchers() unknown matcherType["+p+"] = "+h+"; using CTATExactMatcher"),h=new CTATExactMatcher(b,null)}if("matcherParameter"===f.getElementName(m[p])){var r=f.getElementAttr(m[p],"name");"single"===r?h.setParameter(f.getNodeTextValue(m[p])):"minimum"===r?h.setParameter(f.getNodeTextValue(m[p]),"minimum"):"maximum"===r?h.setParameter(f.getNodeTextValue(m[p]),"maximum"):h.setParameter(m[p],
r,f)}}h&&h.setReplacementFormula(l);d.push(h)}return d}function e(a,b){var c=new Set;if("group"!==f.getElementName(a))return c;var d=f.getElementAttr(a,"name");ctatdebug("readGroupFromXML group name: "+d);var g="true"===f.getElementAttr(a,"ordered"),h="true"===f.getElementAttr(a,"reenterable");ctatdebug("readGroupFromXML group isOrdered typeof: "+typeof g);ctatdebug("readGroupFromXML group isOrdered: "+g);for(var m=function(a){c.add(a)},p=f.getElementChildren(a),r=0;r<p.length;r++){if("link"===f.getElementName(p[r])){var q=
Number(f.getElementAttr(p[r],"id")),u=b[q];if(null!==u||void 0!==u)ctatdebug("Added link ID : "+q),c.add(u)}"group"===f.getElementName(p[r])&&(ctatdebug("encountered a subgroup"),e(p[r],b).forEach(m))}l.addGroup(d,g,c);l.setGroupReenterable(l.getGroupByName(d),h);return c}CTATBase.call(this,"CTATGraphParser","__undefined__");var g=this,d,c,f=new CTATXML,h=null,m=[];new XMLSerializer;var l,q=!0,p=!0,w=[];this.getLockWidget=function(){return p};this.parseGraph=function(b,g){ctatdebug("parseBRD()");
var n=0,r=f.getElementAttr(b,"startStateNodeName"),u="true"===f.getElementAttr(b,"unordered");q="false"!=String(f.getElementAttr(b,"caseInsensitive")).toLowerCase();p=f.getElementAttr(b,"lockWidget");var A=new CTATVariableTable;c=new CTATExampleTracerGraph(u,!1,A);var y=f.getElementChildren(b),A=f.getElementAttr(b,"suppressStudentFeedback");if(null===A||void 0===A)A=CTATMsgType.SHOW_ALL_FEEDBACK;c.setFeedbackPolicy(A);g.setFeedbackSuppressed(A);A=f.getElementAttr(b,"highlightRightSelection");g.setHighlightRightSelection("false"!=
A);var F=f.getElementAttr(b,"confirmDone");"true"!==F&&"false"!==F&&(F=c.getFeedbackPolicy()===CTATMsgType.HIDE_ALL_FEEDBACK?"true":"false");g.setHintPolicy(f.getElementAttr(b,"hintPolicy"));g.setOutOfOrderMessage(f.getElementAttr(b,"outOfOrderMessage"));for(var D=null,x=0;x<y.length;x++)switch(f.getElementName(y[x])){case "startNodeMessages":m=f.getElementChildren(y[x]);break;case "node":n++;var C;C=y[x];ctatdebug("processNode("+C+")");var E=f.getElementChildren(C),t=-1;C="";for(var G=0;G<E.length;G++)switch(f.getElementName(E[G])){case "uniqueID":t=
parseInt(f.getNodeTextValue(E[G]));break;case "text":C=f.getNodeTextValue(E[G])}E=new CTATExampleTracerNode(t,new Set);""!==C&&E.setNodeName(C);C=E;c.addNode(C);1==n&&(c.setStartNode(C),c.setStudentStartsHereNode(C));C.getNodeName()==r&&c.setStudentStartsHereNode(C);break;case "edge":c.addLink(a(y[x]));break;case "EdgesGroups":D=y[x];break;case "productionRule":var z=y[x];ctatdebug("processSkill()");for(var E=C="",G=t=null,z=f.getElementChildren(z),J=0;J<z.length;J++){var H=f.getElementName(z[J]);
"ruleName"==H&&(C=f.getNodeTextValue(z[J]),ctatdebug("ruleName="+C));"productionSet"==H&&(E=f.getNodeTextValue(z[J]),ctatdebug("productionSet="+E));"label"==H&&(t=f.getNodeTextValue(z[J]),ctatdebug("label="+t));"description"==H&&(G=f.getNodeTextValue(z[J]),ctatdebug("description="+G))}C&&(z=new CTATExampleTracerSkill(E,C,CTATExampleTracerSkill.DEFAULT_P_GUESS,CTATExampleTracerSkill.DEFAULT_P_KNOWN,CTATExampleTracerSkill.DEFAULT_P_SLIP,CTATExampleTracerSkill.DEFAULT_P_LEARN,CTATExampleTracerSkill.DEFAULT_HISTORY),
null!=t?z.setLabel(t):z.setLabel(C),null!=G?z.setDescription(G):z.setDescription(C+(E?" "+E:"")),w.push(z))}if(D){n=f.getElementAttr(D,"ordered");if(null===n||"undefined"==typeof isordered)n=!u;ctatdebug("parseGraph() value of isOrdered = "+n);ctatdebug("parseGraph() value of isUnordered = "+u);ctatdebug("parseGraph() typeof isOrdered: "+typeof n);ctatdebug("parseGraph()typeof isUnordered: "+typeof u);r=D;y=n;ctatdebug("processGroup()");l=c.getGroupModel();n=l.createIdToLinkMap();l.setGroupOrdered(l.getTopLevelGroup(),
y);ctatdebug("processGroup() name of group: "+l.getGroupName(l.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+l.isGroupOrdered(l.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+y);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof y);r=f.getElementChildren(r);for(y=0;y<r.length;y++)switch(f.getElementName(r[y])){case "group":e(r[y],n);break;case "outOfOrderMessage":l.getTopLevelGroup().setDefaultBuggyMsg(f.getNodeTextValue(r[y]))}}n=
g.getSkillBarVector(!1,!0);if(!n||1>n.length)ctatdebug("No existing skills. Add skills from BRD."),g.addGraphSkills(w),n=g.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(q,u,p,g.isSourceFlash()?c.exitOnIncorrectDone():g.isFeedbackSuppressed(),A,F,n);c.redoLinkDepths();d=c.getExampleTracer();d.resetTracer();c.forDebugging();ctatdebug("Graph loaded.");return{gr:c,tracer:d,ssm:m,sgMsg:h}}};CTATGraphParser.prototype=Object.create(CTATBase.prototype);
...
this.getStatus());return this.getStatus()}};CTATProblemStateStatus.prototype.toString=function(){return"{"+this.getStatus()+"}"};var CTATMessageTank=function(a,b){function e(a){p.ctatdebug("entering updateProblemSummary()");a&&f.forEach(function(b){if(b.msgType==CTATMsgType.ASSOCIATED_RULES){var d=b.evt;p.ctatdebug("entering updateProblemSummaryWithEvent("+d+")");if(d)if(c&&c.getOutputStatus().isComplete())a.setCompletionStatus(CTATMsgType.CompletionValue[1],!1),a.setShowCounts(!1);else{b=d.getResult();d.getHintRequest()&&(b=CTATExampleTracerLink.HINT_ACTION);var e=CTATMsgType.CompletionValue[0],f=b&&b==CTATExampleTracerLink.CORRECT_ACTION,
...
a.restartTimer();e=d.getActor();p.ctatdebug("updateProblemSummmary() actor "+e+", indicatorObj "+b);CTATMatcher.isTutorActor(e)||(d=d.getStepID(),CTATTutorMessageBuilder.isHint(b)?a.addHint(d):CTATTutorMessageBuilder.isCorrect(b)?null!==b&&"undefined"!==typeof b&&a.addCorrect(d):a.addError(d))}}})}function g(a){switch(p.suppressFeedback(a,c.getFeedbackPolicy())){case CTATMsgType.SHOW_ALL_FEEDBACK:return!1;case CTATMsgType.DELAY_FEEDBACK:a=a.msg;var b=CTATMsgType.getProperty(a,"Selection");p.ctatdebug("CTATMessageTank.addToDelayedFeedbackTank(\n  "+
...
h=null,m=null,l=new Set;l.add("SuccessMessage");l.add("BuggyMessage");l.add("HighlightMsg");l.add("NotDoneMessage");var q=b,p=this,w=/^([^:]+):([0-9]+)$/;this.toString=function(){p.ctatdebug("toString tank "+f);if(!f||1>f.length)return"MessageTank empty";var a="";f.forEach(function(b){a+=b.msgType+", "});return"MessageTank["+a.substr(0,a.length-2)+"]"};this.setTransaction_id=function(a){q=a};this.enqueueToolActionToStudent=function(a,b,d,e){p.ctatdebug("Entering enqueueToolActionToStudent("+a+", "+
...
e.setTransactionID(g);p.addToMessageTank(f,b,e,a);return g};this.addToMessageTank=function(a,b,c,d){p.ctatdebug("Entering addToMessageTank("+a+", "+b+", "+c+")");if(b){f||(f=[],h={},m={});var e={};e.msgType=a;e.msg=b;e.evt=c;e.sai=d;f.push(e);h[a]=h[a]?h[a]+1:1;a=c.getResult();c.getHintRequest()&&(a=CTATExampleTracerLink.HINT_ACTION);m[a]=m[a]?m[a]+1:1;p.ctatdebug("Exiting addToMessageTank() this "+p.toString())}};this.flushMessageTank=function(a,b){p.ctatdebug("Entering flushMessageTank("+a+", "+
b+")");if(f&&!(1>f.length)){e(a);p.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length "+f.length+", transaction_id "+q);for(var l=[],r=[],u=0;u<f.length;++u){var A=f[u];if(A.msg){var y=A.msgType,F=A.evt;p.ctatdebug("entering processInterfaceVariables() msgType "+y+", evt "+F);y&&(p.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+(c?c.getTracer():null)),y=y.toLowerCase(),0!==y.indexOf("correct")&&0!==y.indexOf("interfaceaction")||c.getTracer().addInterfaceVariablesFromEvent(F));
if(!(y=g(A)))if(y=A,F=r,CTATConfiguration.usingFlash()){var D=void 0,x=void 0;if(!(y&&y.sai&&(D=y.sai.getAction())&&(x=w.exec(D)))||3>x.length||1>=x[2])y=!1;else{var C=F.length-1,C=0>C?null:F[C];y.msg=y.msg.replace(D,x[1]);C&&C.timeout==x[2]?C.msgTuples.push(y):F.push({timeout:Number(x[2]),msgTuples:[y]});y=!0}}else y=!1;y||l.push(A.msg)}}p.ctatdebug("flushMessageTank(): msgBundle.length "+l.length+", delayedMsgsBundle.length "+r.length);for(u=0;u<r.length;++u)A=r[u],p.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+
A.timeout+", .msgTuples.length "+A.msgTuples.length),setTimeout(d,A.timeout,c,A.msgTuples);0<l.length&&(p.ctatdebug("Bottom of flushMessageTank(); to send bundle of length "+l.length+" via "+c),c.sendBundle(l)&&(p.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes "+m+", msgTypes "+h),(m[CTATExampleTracerLink.CORRECT_ACTION]||m[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION]||h.CorrectAction||h.InterfaceAction||h.UntutoredAction||c.isFeedbackSuppressed()&&h.AssociatedRules)&&c.isSendingSavedMsgsForRestore()&&
(CTATGlobalFunctions.isInstructorMode()?p.ctatdebug("We're in reviewer mode: we shouldn't save as we go"):c.getProblemStateSaver().saveAsYouGo(a))),p.ctatdebug("Exiting flushMessageTank() #CorrectAction "+h.CorrectAction+", #InterfaceAction "+h.InterfaceAction+", #UntutoredAction "+h.UntutoredAction));h=f=q=null}};this.flushDelayedFeedback=function(){p.ctatdebug("Entering flushDelayedFeedback()");var a=c.getDelayedFeedback(),b;for(b in a)a.hasOwnProperty(b)&&CTAT.ToolTutor.sendToInterface(a[b]);c.clearDelayedFeedback()};
...
"undefined"!==typeof module&&(module.exports=CTATStep);var CTATProblemSummary=function(a,b,e){CTATBase.call(this,"CTATProblemSummary","");if(null===a||"undefined"===typeof a||1>a.length)throw new CTATExampleTracerException("problemName null or empty");var g=!0,d=Number.MAX_VALUE,c=b,f=e,h=0,m=new Date,l={},q=0,p=0,w=0,r=0,u=0,n=0,B=0,v=CTATMsgType.CompletionValue[0],A=this;this.getCountOnlyLastResults=function(){return f};this.setCountOnlyLastResults=function(a){f=a};this.getTimeElapsed=function(){return h};this.getUniqueErrors=function(){if(!A.getCountOnlyLastResults())return B;
var a=0,b;for(b in l)l[b].getLastResult()==CTATStep.StepResult[1]&&a++;return a};this.getUniqueCorrect=function(){if(!A.getCountOnlyLastResults())return u;var a=0,b;for(b in l)l[b].getLastResult()==CTATStep.StepResult[3]&&a++;return a};this.getUniqueCorrectUnassisted=function(){return n};this.getHintsOnly=function(){var a=0,b;for(b in l)CTATStep.StepResult[2]==l[b].getResult()&&1>l[b].getNErrors()&&++a;return a};this.getErrorsOnly=function(){var a=0,b;for(b in l)CTATStep.StepResult[1]==l[b].getResult()&&
1>l[b].getNFirstHints()&&++a;return a};this.getUniqueSteps=function(){var a=0,b;for(b in l)a++;return a};this.getRequiredSteps=function(){return d==Number.MAX_VALUE?0:d};this.setRequiredSteps=function(a){d=a};this.getCorrect=function(){return q};this.toXML=function(b){var c,d="";c=""+(' ProblemName="'+a+'"');c+=' CompletionStatus="'+v+'"';g&&(c+=' Correct="'+q+'"',c+=' UniqueCorrect="'+A.getUniqueCorrect()+'"',c+=' UniqueCorrectUnassisted="'+n+'"',c+=' Hints="'+p+'"',c+=' UniqueHints="'+r+'"',c+=
' HintsOnly="'+A.getHintsOnly()+'"',c+=' Errors="'+w+'"',c+=' UniqueErrors="'+A.getUniqueErrors()+'"',c+=' ErrorsOnly="'+A.getErrorsOnly()+'"',c+=' UniqueSteps="'+A.getUniqueSteps()+'"',c+=' RequiredSteps="'+A.getRequiredSteps()+'"');c+=' TimeElapsed="'+h+'"';g&&(d=A.getSkills()?A.getSkills().toXML(b):"");return b?"&lt;ProblemSummary"+c+"&gt;"+d+"&lt;/ProblemSummary&gt;":"<ProblemSummary"+c+">"+d+"</ProblemSummary>"};this.getSkills=function(){return c};this.setSkills=function(a){c=a};this.stopTimer=
function(){var a=new Date;h+=a.getTime()-m.getTime();return a};this.restartTimer=function(){m=A.stopTimer();return h};this.addHint=function(a){A.ctatdebug("addHint("+a+")");var b=l[a];null!==b&&"undefined"!==typeof b?(1>b.getNFirstHints()&&++r,b.incrementFirstHints()):(b=new CTATStep(a,CTATStep.StepResult[2]),l[a]=b,r++);p++;b.setLastResult(CTATStep.StepResult[2]);A.ctatdebug("exiting addHint() hint count "+p+", trial "+b)};this.addError=function(a){A.ctatdebug("addError("+a+")");var b=l[a];null!==
b&&"undefined"!==typeof b?(1>b.getNCorrect()&&1>b.getNErrors()&&++B,b.incrementErrors()):(b=new CTATStep(a,CTATStep.StepResult[1]),l[a]=b,B++);w++;b.setLastResult(CTATStep.StepResult[1]);A.ctatdebug("exiting addError() error count "+w+", trial "+b)};this.addCorrect=function(a){var b=l[a];A.ctatdebug("entering addCorrect("+a+") trial "+b);b?(1>b.getNCorrect()&&1>b.getNErrors()&&(++u,1>b.getNFirstHints()&&n++),b.incrementNCorrect()):(A.ctatdebug("to call CTATStep("+a+", StepResult "+CTATStep.StepResult[3]),
b=new CTATStep(a,CTATStep.StepResult[3]),l[a]=b,u++,n++);q++;b.setLastResult(CTATStep.StepResult[3]);A.ctatdebug("exiting addCorrect() correct count "+q+", trial "+b)};this.setShowCounts=function(a){g=a};this.setCompletionStatus=function(a,b){A.ctatdebug("setCompletionStatus("+a+", "+b+")");if(CTATMsgType.CompletionValue[1]!=v||b)v=a};this.getCompletionStatus=function(){return v}};CTATProblemSummary.prototype=Object.create(CTATBase.prototype);CTATProblemSummary.prototype.constructor=CTATProblemSummary;
...
SCORMProblemSummary.SESSION_TIME);return b+e+g+a};CTATMsgType.prototype=Object.create(CTATBase.prototype);CTATMsgType.prototype.constructor=SCORMProblemSummary;"undefined"!==typeof module&&(module.exports=SCORMProblemSummary);var CTATExampleTracer=function(){function a(a,b){b?N|=1<<a:(N&=-65537>>16-a,e())}function b(){return"<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.INTERFACE_REBOOT+"</MessageType></properties></message>"}function e(){n.ctatdebug("workTheQueue() working "+N+", workQueue.length "+P.length+", restoreQueue.length "+I.length);if(0==N)for(;0!=(N=0<P.length|(0<I.length)<<1);){var a,b=!1;0<I.length?(a=I.shift(),b=!0):a=P.shift();if(!g(a,b)){n.ctatdebug("workTheQueue() suspending workQueue.length "+
P.length+", restoreQueue.length "+I.length);n.stopWorking(b?1:0);break}n.ctatdebug("workTheQueue() bottom workQueue.length "+P.length+", restoreQueue.length "+I.length)}}function g(a,b){n.lastMessageAsString=a;var e=n.lastMessageAsXML=(new CTATXML).parseXML(a),g=n.lastMessage=new CTATMessage(e),l=g.getMessageType();n.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType "+l+")");switch(l){case CTATMsgType.SET_PREFERENCES:return d(a,g,F,e),!1;case CTATMsgType.INTERFACE_IDENTIFICATION:return!0;
case CTATMsgType.UNTUTORED_ACTION:return b&&n.sendBundle([a]),c(a,g,F,e),!0;case CTATMsgType.INTERFACE_ACTION:return b&&n.sendBundle([a]),h(a,g,F,e),!0;case CTATMsgType.PROBLEM_SUMMARY_REQUEST:return setTimeout(function(a){a=n.getProblemSummary();n.ctatdebug("CTATExampleTracer.ProblemSummaryRequest getProblemSummary() "+n.getProblemSummary());var c="<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.PROBLEM_SUMMARY_RESPONSE+"</MessageType>",c=c+SCORMProblemSummary.getProblemSummaryElements(a),
c=c+("<ProblemSummary>"+a.toXML(!0)+"</ProblemSummary>"),c=c+"<end_of_transaction>true</end_of_transaction></properties></message>",d=[];d.push(c);n.sendBundle(d);K.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE,a.getCompletionStatus());n.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '"+c+"';");n.startWorking(b?1:0)},4E3),!1;case CTATMsgType.START_STATE_END:return K.transition(CTATMsgType.START_STATE_END),!0;case CTATMsgType.PROBLEM_RESTORE_END:return u(),!0;case CTATMsgType.GO_TO_STATE:return f(g);
default:return console.log("CTATExampleTracer.handleMessageFromInterface(restoring "+b+") "+(b?"sending":"unprocessed")+" message, type "+l+"\n  "+a),b&&n.sendBundle([a]),!0}}function d(a,b,c,d){n.ctatdebug("handleSetPreferences ()");O=!1;G=b.getProperty("problem_name");n.ctatdebug("SetPreferences.problem_name = "+G);a=c.getElementChildren(c.getElementChildren(d)[1]);for(b=0;b<a.length;b++)if(d=c.getElementName(a[b]),n.ctatdebug("SetPreferences eltName "+d),d)switch(d.toLowerCase()){case "source_id":z=
c.getNodeTextValue(a[b]);break;case "question_file":B=c.getNodeTextValue(a[b]);break;case "skills":n.ctatdebug(" parseSkills("+a[b]+")");d=[];for(var e=F.getElementChildren(a[b]),f=0;f<e.length;f++){var g=F.getElementName(e[f]);if(g&&"skill"==g.toLowerCase()){var h=F.getElementAttr(e[f],"name");if(h&&""!=h.trim()){var g=F.getElementAttr(e[f],"label"),l=F.getElementAttr(e[f],"pSlip"),m=F.getElementAttr(e[f],"description"),p=F.getElementAttr(e[f],"pKnown"),q=F.getElementAttr(e[f],"category"),r=F.getElementAttr(e[f],
"pLearn"),t=F.getElementAttr(e[f],"pGuess"),u=F.getElementAttr(e[f],"history"),h=new CTATExampleTracerSkill(q,h,t,p,l,r,u);h.setLabel(g);h.setDescription(m);d.push(h)}}}n.getProblemSummary().setSkills(new CTATSkills(d));break;case "problem_state_status":K.transition(CTATMsgType.SET_PREFERENCES,c.getNodeTextValue(a[b]));H||(H=new ProblemStateRestorer(n));n.ctatdebug("SetPreferences problemStateRestorer "+H);break;case "curriculum_service_url":CTATConfiguration.set("curriculum_service_url",c.getNodeTextValue(a[b]));
break;case "restore_problem_url":H||(H=new ProblemStateRestorer(n));n.ctatdebug("SetPreferences problemStateRestorer "+H);CTATConfiguration.set("restoreProblemUrl",c.getNodeTextValue(a[b]));break;case "session_id":L=c.getNodeTextValue(a[b]);break;case "authenticity_token":J.setAuthenticityToken(c.getNodeTextValue(a[b]))}n.ctatdebug("questionFile "+B+", outputStatus "+K+", problemStateRestorer "+H);a="undefined"!=typeof sessionStorage&&sessionStorage?sessionStorage.getItem("Go-To-State"):null;null!=
a&&(sessionStorage.removeItem("Go-To-State"),a=Number(a),!Number.isSafeInteger(a)||0>=a||(Q=a,K.transition(CTATMsgType.BEGIN_GO_TO_STATE,null)));n.ctatdebug("outputStatus "+K+", problemStateRestorer "+H);a=B;n.ctatdebug("retrieveBRD ("+a.indexOf("data:file/brd;base64,")+")");n.ctatdebug("Using network retrieval to obtain BRD ..."+a);R.retrieveXMLFile(a,c,n);H&&H.retrieveMessages(K)}function c(a,b,c,d){b=b.getTransactionID();n.ctatdebug("UntutoredAction ("+a+"), getTransactionID "+b);J.appendToProblemState(a,
n.getOutputStatus(),!1);if(!O)return!1;n.setVariablesFromSAI(d,c);return!0}function f(a){a=a.getProperty("nodeID");if(0>a||!sessionStorage||!sessionStorage.setItem)return!0;sessionStorage.setItem("Go-To-State",String(a));if(!CTAT.ToolTutor.reboot("Go-To-State "+a+" from CTATExampleTracer")){var c=[];c.push(b());n.ctatdebug("CTATET.handleGoToState() saved nodeID "+a+"; sending to interface\n"+c);n.sendBundle(c)}return!1}function h(a,b,c,d){n.ctatdebug("Interface action received.");c=b.getTransactionID();
if(!O)return!1;n.messageTank=new CTATMessageTank(n,c);n.ctatdebug("MessageTank "+n.messageTank);n.ctatdebug("InterfaceAction ("+a+"), getTransactionID "+c);var e=b.getSelectionArray().slice(0);d=b.getActionArray().slice(0);n.ctatdebug("selectionArray "+e+", message.getSelectionArray() "+b.getSelectionArray());if(e[0]&&"_tutor"==e[0].toLowerCase())return n.ctatdebug("handleInterfaceAction tutor cmd SAI "+b.getSAI()+";"),d[0]&&"function"===typeof n[d[0]]&&(c=b.getSAI().getInput(),n[d[0]](c)),!0;!e[0]||
"hint"!=e[0].toLowerCase()&&"help"!=e[0].toLowerCase()?(n.ctatdebug("calling doNewExampleTrace(null, "+b.getSAI()+") sai.selectionArray "+b.getSAI().getSelectionArray()+" msg.selectionArray "+b.getSelectionArray()),p(null,b.getSAI(),"student",!0,c,a)):(n.ctatdebug("handleInterfaceAction() hint request: hintPolicy "+x+", errorSAI "+D),x===CTATHintPolicyEnum.HINTS_UNBIASED?(1<e.length&&(e[1]=""),1<d.length&&(d[1]="")):x!==CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY&&(x===CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY?
D&&D.getSelection()?(e.splice(1,0,D.getSelection()),d.splice(1,0,"PreviousFocus")):(e[1]="",d[1]=""):x===CTATHintPolicyEnum.HINTS_BIASED_BY_ALL&&D&&D.getSelection()&&(e.splice(1,0,D.getSelection()),d[1]=CTATMsgType.PREVIOUS_FOCUS.toString())),n.startSkillTransaction(),a=[],d=v.doHint(e,d,b.getInputArray(),"student",a,!0),b=a[0],a=b.getReportableHints(),e=d?""+d.getUniqueID():"",b.setStepID(e),n.updateSkills(CTATExampleTracerSkill.HINT,d?d.getSkillNames():[],e),n.ctatdebug("Before building hint message: tutorSAI "+
b.getTutorSAI()+", hints "+a+", edge # "+e),d=(new CTATTutorMessageBuilder).createHintMessage(a,b.getTutorSAI(),e,c),n.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE,d,b,null),c=(new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(a,b.getTutorSAI(),w(CTATMsgType.DEFAULT_STUDENT_ACTOR),n.getSkillBarVector(!0),e,c),n.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,c,b,null),c=n.getProblemSummary(b.getReportableInterpretation()),n.messageTank.flushMessageTank(c,!0),
n.ctatdebug("handleInterfaceAction() sent hint result "+b),D=null);return!0}function m(a,b,c){var d={tutorAdvice:null,msg:null,msgType:null};if(a.getReportableLink())return d.tutorAdvice=a.getSuccessOrBuggyMsg(),d.tutorAdvice&&d.tutorAdvice.trim()?(d.msg=c.createBuggyMessage(a.getTransactionID(),d.tutorAdvice),d.msgType="BuggyMessage"):d.tutorAdvice=null,d;n.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()");if(a.isDoneStepFailed())return d.tutorAdvice=CTATMsgType.NOT_DONE_MSG,d.msg=
...
d;if(b=y.getDefaultBuggyMsg())return d.tutorAdvice=b,d.msg=c.createBuggyMessage(a.getTransactionID,d.tutorAdvice),d.msgType="BuggyMessage",n.ctatdebug("createBuggyMessage() default buggy msg: "+d),d;n.ctatdebug("createBuggyMessage() no buggy msg: "+d);return d}function l(a,b,c,d){n.ctatdebug("checkForTutorAction("+a+", "+b+", "+c+", "+d+")");var e=[];e[0]=q(y.getNode(a),!0);e[1]=q(y.getNode(b),!1);n.ctatdebug("checkForTutorAction() links[0] "+e[0]+", links[1] "+e[1]+";");a=0;if(e[0]===e[1])e[1]=null;
else if(null===e[0]||"undefined"===typeof e[0])a=1;b=null;n.messageTank||(n.messageTank=new CTATMessageTank(n,null));for(;a<e.length&&null!==e[a]&&"undefined"!==typeof e[a];++a)if(null==c||"undefined"==typeof c)b=p(e[a],e[a].getDefaultSAI(),e[a].getActor(),!0,null);else{b=e[a].getEvaluatedInput(c,d.getReportableVariableTable());var f=e[a].getDefaultSAI().clone();f.setInput(b);b=p(e[a],f,e[a].getActor(),!0,null)}n.ctatdebug("checkForTutorAction() returning "+b+";");return b}function q(a,b){if(null===
...
g.createAssociatedRulesMessageForAction(a.getResult(),e,w(c),b,n.getSkillBarVector(!0,c),p?p.getUniqueID():-1,f,h),a,e),n.ctatdebug("finishNewExampleTrace() successMsg "+h),h&&n.messageTank.addToMessageTank("SuccessMessage",g.createSuccessMessage(f,h),a,null),D=null,d&&(c=l(p?p.getNextNode():null,v.findCurrentState(!1,!1),n.lastMessage?n.lastMessage.getSAI():null,a))&&(a=c);else{n.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION,g.createInCorrectActionMessage(f,a.getInterpolatedSAI()),a,
null);n.ctatdebug("about to do silent traceForHint("+b+"), selectionArray "+b.getSelectionArray());var q=n.lastSilentHintResult=new CTATExampleTracerEvent(n,b,c);q.setHintRequest(!0);var r=v.traceForHint(q);n.ctatdebug("silent hint result: "+q+"; hintLink "+r);r||(r=v.getBestNextLink(!1,q),n.ctatdebug("getBestNextLink result: "+q+"; hintLink "+r));e=null;r&&((e=q.getTutorSAI())&&e.getSelection()&&a.setTutorSAI(e),h=""+r.getUniqueID(),a.setStepID(h));q=m(a,q,g);n.ctatdebug("createBuggyMessage() tutorAdvice: "+
q.tutorAdvice+";\n  msg "+q.msg);n.updateSkills(CTATExampleTracerSkill.INCORRECT,r?r.getSkillNames():[],h);n.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,g.createAssociatedRulesMessageForAction(a.getResult(),e&&e.getSelection()?e:b,w(c),b,n.getSkillBarVector(!0,c),h,f,q.tutorAdvice),a,null);q.msg&&n.messageTank.addToMessageTank(q.msgType,q.msg,a);D=b;d&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION==a.getResult()?(c=l(p?p.getNextNode():null,v.findCurrentState(!1,!1),n.lastMessage?n.lastMessage.getSAI():
null,a))&&(a=c):a.isDoneStepFailed()&&n.messageTank.flushDelayedFeedback()}n.lastResult=a;c=n.getProblemSummary(a.getReportableInterpretation());n.ctatdebug("finishNewExampleTrace() to flushMessageTank");n.messageTank.flushMessageTank(c,!0);n.ctatdebug("finishNewExampleTrace() sent result "+a.getResult()+", studentSAI "+b);return a}function u(){K.transition(CTATMsgType.PROBLEM_RESTORE_END);var a=n.getSkillBarVector(),b=[],c=new CTATTutorMessageBuilder;b.push(c.createMessage(CTATMsgType.PROBLEM_RESTORE_END,
a?{Skills:a}:null));n.sendBundle(b)}CTATBase.call(this,"CTATExampleTracer","tracer");var n=this,B=null,v,A,y,F=new CTATXML;new XMLSerializer;var D=null,x,C=!0,E=!1,t=null,G=null,z=null,J=new ProblemStateSaver(n);J.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());var H=null,K=new CTATProblemStateStatus,I=[],P=[],N=0,O=!1,L="",Q=-1,M=null;n.ctatdebug("CTATExampleTracer constructor outputStatus="+K);this.messageTank=this.lastSilentHintResult=this.lastResult=this.lastMessage=this.lastMessageAsXML=
this.lastMessageAsString=null;var R=new CTATCommLibrary;this.receiveFromInterface=function(a){n.ctatdebug("CTATExampleTracer.receiveFromInterface() \n  "+a);P.push(a);e()};this.setVariablesFromSAI=function(a,b){var c=CTATMsgType.getSAIArraysFromElement(a,b);n.getTracer()&&n.getTracer().addInterfaceVariables(c.selection,c.input)};this.traceLinks=function(a){for(var b=[],c=n.getTracer().getBestInterpretation(),d=0;d<a.length&&null!==a[d];++d)c.getTraversalCount(a[d])<a[d].getMinTraversals()&&(n.messageTank=
new CTATMessageTank(n,null),b.push(p(a[d],a[d].getDefaultSAI(),a[d].getActor(),!1,null)),n.ctatdebug("traceLinks["+d+"] result "+b[d]));return b};this.enqueueForRestore=function(a){n.ctatdebug("enqueueForRestore: got "+a.length+" message elements");I=I.concat(a);a=(new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null);I.push(a);n.startWorking(1)};this.startWorking=function(b){a(b,!1)};this.stopWorking=function(b){a(b,!0)};this.goToStartState=function(){var a=y.getStudentStartsHereNode()||
y.getStartNode();a?n.goToState(a.getNodeName()):console.trace("goToStartState() did not find start node")};this.goToState=function(a){a=(a=y.findNode(a))?a.getNodeID():-1;0<a&&n.receiveFromInterface("<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.GO_TO_STATE+"</MessageType><nodeID>"+a+"</nodeID></properties></message>")};this.processXML=function(a){n.ctatdebug("processXML ()");if(null!=a){n.ctatdebug("No of children"+F.getElementChildren(a).length);var c=new CTATGraphParser,
d=c.parseGraph(a,n);y=d.gr;v=d.tracer;a=d.ssm;d=d.sgMsg;n.ctatdebug("sendStartStateMessages() nMsgs "+a.length+", outputStatus "+K);for(var e=[],f=new XMLSerializer,g=null,h=0;h<a.length;h++)if("message"==F.getElementName(a[h])){var m=f.serializeToString(a[h]),p=CTATMsgType.getMessageType(m);CTATMsgType.UNTUTORED_ACTION!=p&&CTATMsgType.INTERFACE_ACTION!=p||n.setVariablesFromSAI(a[h],F);CTATMsgType.START_STATE_END==p?(g=e,y.getFeedbackPolicy()!=CTATMsgType.SHOW_ALL_FEEDBACK&&(p=new CTATSAI("hint",
"SetVisible","false"),p=(new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID",p),g.push(p)),g=m,e.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()),e.push((new CTATTutorMessageBuilder).createLockWidgetMsg(c.getLockWidget()))):e.push(m)}e.unshift(d);e.unshift(b());n.ctatdebug("sendStartStateMessages(): "+a.length+" elts, "+e.length+" strings, "+K);n.sendBundle(e);c=g;a:{a=[];d=y.getStartNode();e=CTATMsgType.START_STATE_END;f=d.getNodeID();
h=Q;Q=-1;m=null;h==f?K.transition(e,null):0<h&&(m=y.getNode(h));n.ctatdebug("CTATET.resetGoToState("+e+", null, "+f+") returns "+m);m&&K.transition(CTATMsgType.END_GO_TO_STATE,null);(e=m)||(e=y.getStudentStartsHereNode());if(null!==d&&null!==e&&d.getNodeID()!=e.getNodeID()){a=y.getBestSubpath(d,e);n.ctatdebug("advanceToStudentStartsHere() path "+a);if(!a)break a;a=a.getSortedLinks();a=n.traceLinks(a);n.ctatdebug("advanceToStudentStartsHere() results "+a)}e=d=null;0<a.length&&(e=a[a.length-1],a=e.getReportableLink(),
null!==a&&(d=a.getNextNode()));n.ctatdebug("advanceToStudentStartsHere() to check for TPA "+d+", "+e);l(d,v.findCurrentState(!1,!1),null,e)}a=[];c&&a.push(c);K.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));0<a.length&&n.sendBundle(a);O=!0}n.startWorking(0)};this.addGraphSkills=function(a){n.ctatdebug("adding graph skills: "+a.length);0<a.length&&(a=new CTATSkills(a),a.setExternallyDefined(!1),n.getProblemSummary().setSkills(a))};this.sendBundle=
function(a){n.ctatdebug("sending bundle #msgs = "+a.length+", outputStatus "+K);for(var b=0,c=0;c<a.length;c++){n.ctatdebug("Sending message #"+c);var d=a[c];0>=c&&(d='<?xml version="1.0" encoding="UTF-8"?>'+d);J.forwardToInterface(d,c>=a.length-1,K)&&++b}return 0<b};this.setHintPolicy=function(a){x=CTATHintPolicyEnum.lookup(a)};this.isHighlightRightSelection=function(){return C};this.setHighlightRightSelection=function(a){C=a};this.updateSkills=function(a,b,c){var d=[];n.ctatdebug("in updateSkills("+
b+") with step ID = "+c+", transaction result = "+a);var e=n.getProblemSummary().getSkills();if(null===e||"undefined"===typeof e)return d;b.forEach(function(b){b=e.updateSkill(a,b,c);null!==b&&"undefined"!==typeof b&&d.push(b)});return d};this.getSessionID=function(){return L};this.getProblemSummary=function(a){n.ctatdebug("Entering getProblemSummary() problemSummary "+t);if(null===t||"undefined"===typeof t){var b=n.getProblemName();t=null===b||"undefined"===typeof b||1>b.length?new CTATProblemSummary("NoProblemDefined",
null,n.isFeedbackSuppressed()):new CTATProblemSummary(b,null,n.isFeedbackSuppressed())}a&&t.setRequiredSteps(a.countStepsForScore(y));return t};this.getProblemName=function(){return G};this.getSourceID=function(){return z};this.isSourceFlash=function(){return"string"==typeof z&&z.match(/flash/i)};this.isFeedbackSuppressed=function(){return E};this.setFeedbackSuppressed=function(a){E="false"===a?!1:"true"===a?!0:a===CTATMsgType.SHOW_ALL_FEEDBACK?!1:a===CTATMsgType.HIDE_ALL_FEEDBACK?!0:a===CTATMsgType.HIDE_BUT_ENFORCE?
!0:a===CTATMsgType.HIDE_BUT_COMPLETE?!0:!1;n.ctatdebug("setFeedbackSuppressed("+a+"): "+E);t&&t.setCountOnlyLastResults(E)};this.getSkillBarVector=function(a,b){var c=n.getProblemSummary().getSkills();return null===c||"undefined"===typeof c?null:"Student"!=w(b)?null:"undefined"!=typeof a&&a?c.getSkillBarVector(!1,!1):c.getSkillBarVector(!0,!0)};this.startSkillTransaction=function(){var a=n.getProblemSummary().getSkills();a&&a.startTransaction()};this.getProblemStateSaver=function(){return J};this.isSendingSavedMsgsForRestore=
function(){return n.getOutputStatus().isSendingSavedMsgsForRestore()};this.getOutputStatus=function(){return K};this.setOutputStatus=function(a){var b=K.getStatus();n.ctatdebug("setOutputStatus() old "+b+", new "+a);CTATProblemStateStatus[a]?K.setStatus(CTATProblemStateStatus[a]):(console.error("CTATExampleTracer.setOutputStatus() unexpected argument "+a),K.setStatus(CTATProblemStateStatus.empty))};this.getFeedbackPolicy=function(){return y?y.getFeedbackPolicy():CTATMsgType.SHOW_ALL_FEEDBACK};this.getGraph=
function(){return y};this.getTracer=function(){return v};this.getOutOfOrderMessage=function(){return A?A:CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE};this.setOutOfOrderMessage=function(a){A=a};this.getDelayedFeedback=function(){null==M&&(M={});return M};this.clearDelayedFeedback=function(){M=null};this.getQuestionFile=function(a){if(!B||a)return B;a=B.split("/");return a[a.length-1]}};CTATExampleTracer.prototype=Object.create(CTATBase.prototype);CTATExampleTracer.prototype.constructor=CTATExampleTracer;
