...
n&&(a.getAllInterfaceDescriptions(),a.propagateShellEvent("GetAllInterfaceDescriptions",l));"SendWidgetLock"==n&&(g.ctatdebug("Found: SendWidgetLock"),!0===this.getInStartState()&&d.push(l),a.propagateShellEvent("SendWidgetLock",l));"CorrectAction"==n&&(console.log("CORRECT CORRECT CORRECT"),g.ctatdebug("Found: CorrectAction"),!0===this.getInStartState()?d.push(l):e.processCorrectAction(l),a.propagateShellEvent("CorrectAction",l));"InCorrectAction"==n&&(console.log("INCORRECT INCORRECT INCORRECT"),
g.ctatdebug("Found: InCorrectAction"),!0===CTATMessageHandler.inStartState?d.push(l):(g.ctatdebug("Handing incorrect message to messagehandler ..."),e.processInCorrectAction(l)),a.propagateShellEvent("InCorrectAction",l));"HighlightMsg"==n&&(g.ctatdebug("Found: HighlightMsg"),e.processHighlightMsg(l),a.propagateShellEvent("HighlightMsg",l));"UnHighlightMsg"==n&&(g.ctatdebug("Found: UnHighlightMsg"),e.processUnHighlightMsg(l),a.propagateShellEvent("UnHighlightMsg",l));if("AssociatedRules"==n){g.ctatdebug("Found: AssociatedRules ("+
r.length+")");for(var B="",v="",A=0;A<r.length;A++){var y=r[A];"TutorAdvice"==c.getElementName(y)&&(B=c.getNodeTextValue(y));"Actor"==c.getElementName(y)&&(h=c.getNodeTextValue(y));"Indicator"==c.getElementName(y)&&(v=c.getNodeTextValue(y));"StepID"==c.getElementName(y)&&c.getNodeTextValue(y);"LogAsResult"==c.getElementName(y)&&c.getNodeTextValue(y);"tool_selection"==c.getElementName(y)&&c.getNodeTextValue(y);"Skills"==c.getElementName(y)&&(g.ctatdebug("Processing skills ..."),null===CTATSkillSet.skills&&
(g.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(y))}e.processAssociatedRules(l,v,B);a.propagateShellEvent("AssociatedRules",l)}"BuggyMessage"==n&&(g.ctatdebug("Found: BuggyMessage"),e.processBuggyMessage(l),a.propagateShellEvent("BuggyMessage",l));"SuccessMessage"==n&&(g.ctatdebug("Found: SuccessMessage"),e.processSuccessMessage(l),a.propagateShellEvent("SuccessMessage",l));-1!=n.indexOf("InterfaceAction")&&
(g.ctatdebug("Found: InterfaceAction"),B=l.getSAI(),-1!=B.getAction().indexOf(":")?(g.ctatdebug("Processing and storing timed interface action : "+B.getAction()),v=parseInt(B.getAction().substring(B.getAction().indexOf(":")+1)),g.ctatdebug("Target time: "+v),B.setAction(B.getAction().substring(0,B.getAction().indexOf(":"))),g.ctatdebug("Timing ..."),setTimeout(e.processInterfaceAction,v,l),setTimeout(a.propagateShellEvent,v,"InterfaceAction",l,"tutor")):(g.ctatdebug("Processing regular (non-timed) interface action"),
