...
"tutor":h;b=c.getElementChildren(b);g.ctatdebug("Generated CTATMessage, now doing regular processing ...");for(var m=0;m<b.length;m++){var w=b[m];if("properties"==c.getElementName(w)){g.ctatdebug("Parsing properties ...");for(var r=c.getElementChildren(w),u=0;u<r.length;u++){var n=r[u];if("MessageType"==c.getElementName(n)){n=c.getNodeTextValue(n);g.ctatdebug("MessageType: "+n);"StateGraph"==n&&(ctatdebug("Setting inStartState to true"),CTATMessageHandler.inStartState=!0,a.setGotProblemRestoreEnd(!1),
this.processStateGraph(w),a.propagateShellEvent("StateGraph",l));"StartProblem"==n&&(g.ctatdebug("Setting inStartState to true"),CTATMessageHandler.inStartState=!0,a.setGotProblemRestoreEnd(!1),this.processStartProblem(r),a.propagateShellEvent("StartProblem",l));"InterfaceIdentification"==n&&(this.processInterfaceIdentification(r),a.propagateShellEvent("InterfaceIdentification",l));"InterfaceDescription"==n&&(this.processInterfaceDescription(r),a.propagateShellEvent("InterfaceDescription",l));"GetAllInterfaceDescriptions"==
n&&(a.getAllInterfaceDescriptions(),a.propagateShellEvent("GetAllInterfaceDescriptions",l));"SendWidgetLock"==n&&(g.ctatdebug("Found: SendWidgetLock"),!0===this.getInStartState()&&d.push(l),a.propagateShellEvent("SendWidgetLock",l));"CorrectAction"==n&&(console.log("CORRECT CORRECT CORRECT"),useDebuggingBasic=!0,g.ctatdebug("Found: CorrectAction"),!0===this.getInStartState()?d.push(l):e.processCorrectAction(l),a.propagateShellEvent("CorrectAction",l));"InCorrectAction"==n&&(console.log("INCORRECT INCORRECT INCORRECT"),
useDebuggingBasic=!0,g.ctatdebug("Found: InCorrectAction"),g.ctatdebug("KMD - debug"),!0===CTATMessageHandler.inStartState?d.push(l):(g.ctatdebug("Handing incorrect message to messagehandler ..."),e.processInCorrectAction(l)),a.propagateShellEvent("InCorrectAction",l));"HighlightMsg"==n&&(g.ctatdebug("Found: HighlightMsg"),e.processHighlightMsg(l),a.propagateShellEvent("HighlightMsg",l));"UnHighlightMsg"==n&&(g.ctatdebug("Found: UnHighlightMsg"),e.processUnHighlightMsg(l),a.propagateShellEvent("UnHighlightMsg",
l));if("AssociatedRules"==n){g.ctatdebug("Found: AssociatedRules ("+r.length+")");for(var B="",v="",A=0;A<r.length;A++){var y=r[A];"TutorAdvice"==c.getElementName(y)&&(B=c.getNodeTextValue(y));"Actor"==c.getElementName(y)&&(h=c.getNodeTextValue(y));"Indicator"==c.getElementName(y)&&(v=c.getNodeTextValue(y));"StepID"==c.getElementName(y)&&c.getNodeTextValue(y);"LogAsResult"==c.getElementName(y)&&c.getNodeTextValue(y);"tool_selection"==c.getElementName(y)&&c.getNodeTextValue(y);"Skills"==c.getElementName(y)&&
(g.ctatdebug("Processing skills ..."),null===CTATSkillSet.skills&&(g.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(y))}e.processAssociatedRules(l,v,B);a.propagateShellEvent("AssociatedRules",l)}"BuggyMessage"==n&&(g.ctatdebug("Found: BuggyMessage"),e.processBuggyMessage(l),a.propagateShellEvent("BuggyMessage",l));"SuccessMessage"==n&&(g.ctatdebug("Found: SuccessMessage"),e.processSuccessMessage(l),a.propagateShellEvent("SuccessMessage",
