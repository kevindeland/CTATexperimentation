...
l));"GetAllInterfaceDescriptions"==n&&(a.getAllInterfaceDescriptions(),a.propagateShellEvent("GetAllInterfaceDescriptions",l));"SendWidgetLock"==n&&(g.ctatdebug("Found: SendWidgetLock"),!0===this.getInStartState()&&d.push(l),a.propagateShellEvent("SendWidgetLock",l));"CorrectAction"==n&&(console.log("CORRECT CORRECT CORRECT"),g.ctatdebug("Found: CorrectAction"),!0===this.getInStartState()?d.push(l):e.processCorrectAction(l),a.propagateShellEvent("CorrectAction",l));"InCorrectAction"==n&&(console.log("INCORRECT INCORRECT INCORRECT"),
g.ctatdebug("Found: InCorrectAction"),g.ctatdebug("KMD - debug"),!0===CTATMessageHandler.inStartState?d.push(l):(g.ctatdebug("Handing incorrect message to messagehandler ..."),e.processInCorrectAction(l)),a.propagateShellEvent("InCorrectAction",l));"HighlightMsg"==n&&(g.ctatdebug("Found: HighlightMsg"),e.processHighlightMsg(l),a.propagateShellEvent("HighlightMsg",l));"UnHighlightMsg"==n&&(g.ctatdebug("Found: UnHighlightMsg"),e.processUnHighlightMsg(l),a.propagateShellEvent("UnHighlightMsg",l));if("AssociatedRules"==
n){g.ctatdebug("Found: AssociatedRules ("+r.length+")");for(var B="",v="",A=0;A<r.length;A++){var y=r[A];"TutorAdvice"==c.getElementName(y)&&(B=c.getNodeTextValue(y));"Actor"==c.getElementName(y)&&(h=c.getNodeTextValue(y));"Indicator"==c.getElementName(y)&&(v=c.getNodeTextValue(y));"StepID"==c.getElementName(y)&&c.getNodeTextValue(y);"LogAsResult"==c.getElementName(y)&&c.getNodeTextValue(y);"tool_selection"==c.getElementName(y)&&c.getNodeTextValue(y);"Skills"==c.getElementName(y)&&(g.ctatdebug("Processing skills ..."),
null===CTATSkillSet.skills&&(g.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(y))}e.processAssociatedRules(l,v,B);a.propagateShellEvent("AssociatedRules",l)}"BuggyMessage"==n&&(g.ctatdebug("Found: BuggyMessage"),e.processBuggyMessage(l),a.propagateShellEvent("BuggyMessage",l));"SuccessMessage"==n&&(g.ctatdebug("Found: SuccessMessage"),e.processSuccessMessage(l),a.propagateShellEvent("SuccessMessage",
l));-1!=n.indexOf("InterfaceAction")&&(g.ctatdebug("Found: InterfaceAction"),B=l.getSAI(),-1!=B.getAction().indexOf(":")?(g.ctatdebug("Processing and storing timed interface action : "+B.getAction()),v=parseInt(B.getAction().substring(B.getAction().indexOf(":")+1)),g.ctatdebug("Target time: "+v),B.setAction(B.getAction().substring(0,B.getAction().indexOf(":"))),g.ctatdebug("Timing ..."),setTimeout(e.processInterfaceAction,v,l),setTimeout(a.propagateShellEvent,v,"InterfaceAction",l,"tutor")):(g.ctatdebug("Processing regular (non-timed) interface action"),
!0===CTATMessageHandler.inStartState?(g.ctatdebug("inStartState==true => storing for later playback ..."),d.push(l)):(e.processInterfaceAction(l),a.propagateShellEvent("InterfaceAction",l,h))));-1!=n.indexOf("UntutoredAction")&&(g.ctatdebug("Found: UntutoredAction"),B=l.getSAI(),-1!=B.getAction().indexOf(":")?(g.ctatdebug("Processing and storing timed interface action : "+B.getAction()),v=parseInt(B.getAction().substring(B.getAction().indexOf(":")+1)),g.ctatdebug("Target time: "+v),B.setAction(B.getAction().substring(0,
B.getAction().indexOf(":"))),g.ctatdebug("Timing ..."),setTimeout(e.processUntutoredAction,v,l),setTimeout(a.propagateShellEvent,v,"UntutoredAction",l,"tutor")):(g.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(g.ctatdebug("inStartState==true => storing for later playback ..."),d.push(l)):(e.processUntutoredAction(l),a.propagateShellEvent("UntutoredAction",l,h))));"InterfaceIdentification"==n&&(g.ctatdebug("Found: InterfaceIdentification"),a.propagateShellEvent("InterfaceIdentification",
l));"AuthorModeChange"==n&&(g.ctatdebug("Found: AuthorModeChange"),e.globalReset(),a.propagateShellEvent("AuthorModeChange",l));"ResetAction"==n&&(g.ctatdebug("Found: ResetAction"),e.globalReset(),a.propagateShellEvent("ResetAction",l));if("ShowHintsMessage"==n){g.ctatdebug("Found: ShowHintsMessage");B=!1;v=[];for(A=0;A<r.length;A++)if(y=r[A],"HintsMessage"==c.getElementName(y))for(var y=c.getElementChildren(y),F=0;F<y.length;F++){var D=y[F];"value"==c.getElementName(D)&&(v.push(c.getNodeTextValue(D)),
B=!0)}!0===B?e.processHintResponse(l,v):g.ctatdebug("Error: incomplete hint message received");a.propagateShellEvent("ShowHintsMessage",l)}"ConfirmDone"==n&&(g.ctatdebug("Found: ConfirmDone"),e.processConfirmDone(l),a.propagateShellEvent("ConfirmDone",l));"VersionInfo"==n&&(g.ctatdebug("Found: VersionInfo"),e.processVersionInfo(r),a.propagateShellEvent("VersionInfo",l));"TutoringServiceAlert"==n&&(g.ctatdebug("Found: TutoringServiceAlert"),e.processTutoringServiceAlert(r),a.propagateShellEvent("TutoringServiceAlert",
l));"TutoringServiceError"==n&&(g.ctatdebug("Found: TutoringServiceError"),e.processTutoringServiceError(r),a.propagateShellEvent("TutoringServiceError",l));"ProblemSummaryResponse"==n&&(g.ctatdebug("Found: ProblemSummaryResponse"),e.processProblemSummaryResponse(l),a.propagateShellEvent("ProblemSummaryResponse",l));if("StartStateEnd"==n){g.ctatdebug("Found: StartStateEnd");CTATShellTools.listComponents();null!==e?e.processStartState():this.ctatdebug("Error: no message handler object available to process start state");
try{g.processStartStateActions()}catch(x){g.ctatdebug("Caught in the act: "+x.message)}CTATMessageHandler.inStartState=!1;a.propagateShellEvent("StartStateEnd",l)}"ProblemRestoreEnd"==n&&(g.ctatdebug("Found: ProblemRestoreEnd"),e.processProblemRestoreEnd(l),a.propagateShellEvent("ProblemRestoreEnd",l));"GetURL"==n&&(g.ctatdebug("Found: GetURL"),e.processGetURL(l),a.propagateShellEvent("GetURL",l));if("SetPreferences"==n){e.forwardToTutor(l);return}"InterfaceReboot"==n&&(f++,ctatdebug("Found: InterfaceReboot #"+
f+" -- href "+(location?location.href:"(no location)")),1<f&&!CTAT.ToolTutor.reboot("InterfaceReboot from CTATMessageHandler")&&(n="ws://"+CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),ctatdebug("closing connection w/ url: "+n),a.closeWSConnection(n,function(){var a=window.frameElement.getAttribute("id");"function"==typeof CustomEvent&&(a=new CustomEvent("refreshIframe",{detail:a}),window.parent.document.dispatchEvent(a))},"interfaceReboot")));(n=/student[0-9]+/i.exec(h))&&
n[0]==h&&e.forwardToTutor(l)}}}}};this.processStateGraph=function(a){g.ctatdebug("processStateGraph ()");if(void 0===a||null===a)g.ctatdebug("Error: state graph property list is undefined");else if(g.ctatdebug("Processing node: "+a.nodeName),null===c.getElementChildren(a))g.ctatdebug("Error: state graph property list is undefined");else{a=c.getElementChildren(a);for(var b=0;b<a.length;b++){var d=a[b];g.ctatdebug("State graph attribute: "+c.getElementName(d));"caseInsensitive"==c.getElementName(d)&&
(caseInsensitive="false"==c.getNodeTextValue(d)?!1:!0);"unordered"==c.getElementName(d)&&(unordered="false"==c.getNodeTextValue(d)?!1:!0);"lockWidget"==c.getElementName(d)&&(lockWidget="false"==c.getNodeTextValue(d)?!1:!0);"suppressStudentFeedback"==c.getElementName(d)&&("false"==c.getNodeTextValue(d)?CTATGlobals.suppressStudentFeedback=!1:CTATGlobals.suppressStudentFeedback=!0);"highlightRightSelection"==c.getElementName(d)&&(highlightRightSelection="false"==c.getNodeTextValue(d)?!1:!0);"confirmDone"==
c.getElementName(d)&&(g.ctatdebug("Confirm done: "+c.getNodeTextValue(d)),"true"==c.getNodeTextValue(d)?CTATGlobals.confirmDone=!0:CTATGlobals.confirmDone=!1);"Skills"==c.getElementName(d)&&(null===CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(d),e.updateSkillWindow())}}};this.processStartProblem=function(a){g.ctatdebug("processStartProblem ()");e.processStartProblem()};this.processInterfaceIdentification=function(a){};this.processInterfaceDescription=
function(a){g.ctatdebug("processInterfaceDescription ("+a.length+")");for(var b="Unknown",d="Unknown",f=null,e=0;e<a.length;e++){var h=a[e];g.ctatdebug("Inspecting element: "+c.getElementName(h));"WidgetType"==c.getElementName(h)&&(g.ctatdebug("Widget type: "+c.getNodeTextValue(h)),b=c.getNodeTextValue(h));"CommName"==c.getElementName(h)&&(g.ctatdebug("Instance name: "+c.getNodeTextValue(h)),d=c.getNodeTextValue(h));if("serialized"==c.getElementName(h)){g.ctatdebug("Prepareing to de-serialize component ...");
for(var m=c.getElementChildren(h),n=0;n<m.length;n++){var B=m[n];-1!=c.getElementName(B).indexOf("CTAT")&&(f=B)}}"interface"==c.getElementName(h)&&(g.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=h);"script"==c.getElementName(h)&&(g.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=c.getNodeTextValue(h))}null!==f?this.deserializeComponent(b,d,f):g.ctatdebug("Error: unable to find CTAT serialization point of attachement");
g.ctatdebug("processInterfaceDescription () done")};this.deserializeComponent=function(a,b,d){g.ctatdebug("deserializeComponent ("+a+","+b+")");if(!0===CTATGlobals.ignoreInterfaceDescriptions)g.ctatdebug("ignoreInterfaceDescriptions==true");else if(null===c.getElementAttr(d,"x"))g.ctatdebug("Warning: this component does not have x,y information. Probably an older component");else{var f=c.getElementAttr(d,"x"),e=c.getElementAttr(d,"y"),l=c.getElementAttr(d,"width"),h=c.getElementAttr(d,"height"),n=
c.getElementAttr(d,"tabIndex"),m=c.getElementAttr(d,"zIndex");null===n&&(n=-1);null===m&&(m=0);var q=new CTATComponentDescription;q.type=a;q.name=b;q.x=Math.floor(f);q.y=Math.floor(e);q.tabIndex=n;q.zIndex=m;q.width=Math.floor(l);q.height=Math.floor(h);CTATShellTools.registerComponentDescription(q);d=c.getElementChildren(d);for(f=0;f<d.length;f++){e=d[f];c.getElementName(e);if("Parameters"==c.getElementName(e))for(this.ctatdebug("Processing component parameters ..."),l=c.getElementChildren(e)[0],
l=c.getElementChildren(l),h=0;h<l.length;h++){var A=l[h];if("CTATComponentParameter"==c.getElementName(A)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var m=n=void 0,A=c.getElementChildren(A),y=0;y<A.length;y++){var F=A[y];"name"==c.getElementName(F)&&(this.ctatdebug("Found parameter name: "+c.getNodeTextValue(F)),n=c.getNodeTextValue(F));"value"==c.getElementName(F)&&(this.ctatdebug("Found parameter value: "+c.getNodeTextValue(F)),m=c.getNodeTextValue(F).trim())}this.ctatdebug("Parameter name: "+
n+", value: "+m);void 0!==n&&(q.params[n]=m,"group"==n&&(q.groupName=m))}}if("Styles"==c.getElementName(e))for(this.ctatdebug("Processing component styles ..."),e=c.getElementChildren(e)[0],e=c.getElementChildren(e),l=0;l<e.length;l++)if(m=e[l],"CTATStyleProperty"==c.getElementName(m)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");n=h="";m=c.getElementChildren(m);for(A=0;A<m.length;A++)y=m[A],"name"==c.getElementName(y)&&(h=c.getNodeTextValue(y)),"value"==c.getElementName(y)&&
(n=c.getNodeTextValue(y).trim());this.ctatdebug("Style (name: "+h+", value: "+n+")");""!==h&&(q.styles[h]=n)}}g.ctatdebug("deserializeComponent ("+a+","+b+") done")}};this.processStartStateActions=function(){g.ctatdebug("processStartStateActions ("+d.length+")");if(0===d.length)g.ctatdebug("No start state messages, bump");else if(0<CTATMessageHandler.startStateHandlers.length)for(var a=0;a<CTATMessageHandler.startStateHandlers.length;a++)CTATMessageHandler.startStateHandlers[a].processStartStateActions(d);
else{for(var a=b(),c=0;c<d.length;c++){var f=d[c];g.ctatdebug("Processing startstate message type: "+f.getMessageType());"InterfaceAction"==f.getMessageType()&&e.processInterfaceAction(f,a);"CorrectAction"==f.getMessageType()&&e.processCorrectAction(f);"InCorrectAction"==f.getMessageType()&&e.processInCorrectAction(f);this.sleep(1E3)}if(""!==CTATMessageHandler.scriptElement)try{eval(CTATMessageHandler.scriptElement)}catch(p){alert("Error executing script from BRD: "+p.message)}}};this.sleep=function(a){g.ctatdebug("sleep ("+
